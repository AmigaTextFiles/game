...
public:
	...
	void DrawText(SDL_Surface* pSurface, const char* text, char BaseColor = 128);
	...
	*/
	inline int getTextHeight() { return CharacterHeight; };
	...
	*/
	inline Uint32 getNumCharacters() { return NumCharacters; };
