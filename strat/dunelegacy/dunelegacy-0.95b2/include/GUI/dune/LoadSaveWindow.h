...
{
public:
	LoadSaveWindow(bool bSave, std::string caption, std::string directory, std::string extension);
	~LoadSaveWindow();
	...
	*/
	static LoadSaveWindow* Create(bool bSave, std::string caption, std::string directory, std::string extension) {
		LoadSaveWindow* dlg = new LoadSaveWindow(bSave, caption, directory, extension);
		dlg->pAllocated = true;
		return dlg;
	}
