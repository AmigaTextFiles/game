...
public:
	...
	*/
	virtual void Resize(Uint32 width, Uint32 height) {
		SetSurfaces(GUIStyle::GetInstance().CreateButtonSurface(width, height, Text, false, false),true,
					GUIStyle::GetInstance().CreateButtonSurface(width, height, Text, true, true),true,
					GUIStyle::GetInstance().CreateButtonSurface(width, height, Text, false, true),true);
