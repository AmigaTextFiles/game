...
#  define FNKDAT_PKGDATADIR "PRODIR:" PACKAGE
#endif
...
#  else
#     define FNKDAT_PKGLIBDIR "PROGDIR:" FNKDAT_GAMESUBDIR PACKAGE
#  endif /* __FreeBSD__ */
#endif /* FNKDAT_PKGLIBDIR */

#ifndef FNKDAT_SYSCONFDIR
#  define FNKDAT_SYSCONFDIR "PROGDIR:"
#endif
...
typedef HRESULT (*LPSHGETFOLDERPATH) (HWND,int,HANDLE,DWORD,LPTSTR);
/*
