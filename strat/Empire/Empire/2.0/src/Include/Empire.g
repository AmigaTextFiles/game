...
uint
    ...
    PASSWORD_LEN = 32,                  /* max length of password */
    ...
    NOBODY = COUNTRY_MAX,               /* automatic message */
...
*char
    ...
    CONNECT_MESSAGE_FILE = "empire.conMess",
    LOGIN_MESSAGE_FILE = "empire.logMess",
    LOGOUT_MESSAGE_FILE = "empire.hangMess",
    BULLETIN_FILE = "empire.bulletin",
    POWER_FILE = "empire.power";

int
    HURRICANE_FORCE = -9,               /* <= this does damage */
    MONSOON_FORCE = -8,                 /* <= this stops work */
    STORM_FORCE = -7;                   /* <= this slows work */
...
SectorType_t s_first = s_sanctuary, s_last = s_exchange;

[range(SectorType_t) + 1] char SECTOR_CHAR = "s-.^cudimghwtfr+*)!\#=bx";
...
type
    ...
    Country_t = struct {
        ...
        bool c_loggedOn;                /* logged on right now */
        enum {
    ...
    NewsType_t = enum {
        ...
        n_hurricane_dest,               /* actor destroyed by hurricane */
    },
