                        VOODOO CASTLE - SOLUTION

Typed by KING TUT.  Edited by PARASITE.


PART ONE
Ah, VooDoo Castle! Nothing like a little spooky stuff now and then! This
time around, you're trying to remove a nasty curse from Count Christo
(who
is a good Count, unlike Count Dracula, whom you polished off in the
previous
adventure).
...
clean off the idol, which is your source of light.
     ...
     Now go East to the chapel, then South, West, South, and East into
the
...
need the sword for). This will reveal a safe. You don't have the
combination
...
moving the kettle (when you come to it) along the way. When you get to
the
torture chamber, mix and then drink the chemicals.

     ZAP! You are now small enough to fit through the tiny doorway. Go
through the door, and pick up the saw. Look at the graves, and get the
four-
leaf clover. Return East, then go back to the chapel. From there, go East
to
the huge stone door with the sapphire set in it.

     Sapphire? Hmm, does that remind you of anything? Yep, sure does!
Wave
the ring, and the door disappears to be replaced by a tunnel with a
slippery
...
PART TWO
You now emerge into the Medium's room. She runs out when you enter, but
she
...
to
the tunnel. Get the knife, and go back to the chapel. Drop the knife
there,
then go on to the stairwell.

     Once at the stairwell, pick up the glass, then go East to the kettle
room. Since you moved the kettle before, you will notice there is now a
dark
...
you needed the glass to see it. The plaque itself glows in the dark.).
     ...
     Once you know the combination, drop the plaque and the glass. Now
get
...
(second number). Open the safe and get the antique hammer that's inside.
Now
...
stairwell. This time, go upstairs to the parlor, where the Ju-Ju statue
is.
...
laboratory. Remember to pick up the shield before you go in!
     ...
     In the lab, get the Ju-Ju bag, and make tracks for the tunnel with
the
chute. You can drop the shield along the way, since you won't be needing
it
any longer. Slide down the chute, then wave the bag. Voila! The little
crack
in the wall is now large enough for you to pass through.

     Go crack, and get the torn page. Now, open the bag, and get the
book.
Read both the book and the page, and make careful note of the ritual
needed
for freeing Count Cristo from the curse. Drop the book and the page, and
get
the stick. Go South back to the chute room, then enter the hole. Look
once
again into the crystal ball.

     So, here you are in the tunnel once more. Hang in there, you're
almost
...
freeing the Count. TA-DA! You have successfully finished the adventure!
