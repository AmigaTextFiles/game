...
ladder) go right and shoot piece of meat till it falls off, push it
...
safe to pass under spikes, get gold, jump on rocket platform, steer 
...
wheel, roll wheel to the left till in connects with the battering-
...
push table left into left room, jump on, hit lever on left, wait till
water rises, hit lever on right, wait till water drops, go right, get
gold, go up ladder, push table over edge, kill monster on the right.
Jump to the right and push crate onto table, jump left then go down
the ladder.  Shoot box and use the floating pieces of wood to get
across the water. Go right and now keep moving to avoid getting picked
by the crane, best technique to kill crane operator is to jump right,
shoot 3X, jump left, jump right, shoot 3X, etc till he dies.  You can
also drop below, close right trap door then go partially up the ladder,
jump off while shooting left til the crane operator is dead, then open
trap back up.  Go up ladder and to the right, kill leader, get artifact,
go right to get gold, go all the way to the left and get gold, go back
to ladder and go all the way down, shoot small door on left to close
hole, DON'T SHOOT THE GREEN GUY OR THE SMALL DOOR ON THE RIGHT, go up
ladder to crane controls, use crane to get barrel on top right of the
conveyor belt, get in, hit switch on right, push down to close yourself
in barrel, now wait as you get tossed down and pulled over to the second
opening, once to land, get out, go left.  Done
...
falls on left side of the seesaw, push seesaw left so the head is
...
slide, go al the way down the pit, then go right, keep killing the
two birds til one of them is holding a hammer, kill him, grab hammer,
go back up, arrange levers so 4 balls can be dropped on the level with
the 4 spikes, this will plug them up, now arrange the levers to have
...
and launch itself from the table ramp to another section.  Continue
...
fish in tank 1 into tank 3 (to grab a fish, emerse box into tank, and
as the fish passes through box, pull him up out of the water, to 
release fish, push button), then move round fish in tank 3 to tank 1,
...
instantly kill you, go down ladder, fall through pit, push the big
