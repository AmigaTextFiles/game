...
\  /   /        \      /       /  \  /   /       /   /       \           /
 \/   /__________\____/_______/____\/   /_______/   /_________\    _____/
  \  /                              \  /\  /    \  /           \  /
   \/  Baser Evil/Alliance Presents  \/  \/      \/             \/


               MEGATRAVELLER 2: QUEST FOR THE ANCIENTS - SOLVE



This sequel is more complex, bigger and easier to play than the first game in
the series. The totally icon-driven interface and combat system from
MegaTraveller 1 were completely redesigned, and there are 117 worlds with up
to nine cities each. Your party of five will see most of them as they try to
prevent a volcanic eruption that threatens to cover the planet Rhylanor with
toxic slime. You have 2,600 days before it explodes, time you'll spend
rocketing through the four subsectors of the Spinward Marches in search of
artifacts hidden in the ruins of the Ancients.
    Along the way you'll get plenty of chances to go on mini-quests and
engage in a wide number of activities that, while not necessary for solving
the game, are just plain fun. Space travel and space combat are easily
mastered, and color-coding streamlines character interaction in a novel way:
NPCs with information appear green on the overhead map, and turn white after
you've talked to them, which makes it easy to see when you've clearned an
area of NPCs with messages. A clever "PAL" feature eliminates a major
frustration of roleplaying. Turn it on, and whenever a character's skills or
tools are needed in a situation, he will automatically "volunteer" to use
them, so you don't have to move him into the lead position of the party as in
most RPGs. This one's recommended if you like lots of objects and weapons to
fool with and a variety of mini-quests.


General Tips
----------------------------------------------------------------------------

To find a gas giant for refueling, look for a dot on a circle containing the
city name on the maps. If you don't have a pass for the cities indicated, you
will have to get one; you also need 36 coynes to win the game. When entering
a starport through the Customs section, give most of your weapons to any Vagr
in your party, because they can get them through customs. You need both a
Scout and a Naval Officer to get you through some starports via the backdoor.


Skills
======
Use only those skills you will need and split them up among your group. Give
vaac to everyone; one character should get doctor, one pilot and one engineer
skill. Get laser skill for all, turret gunner for two and add energy weapons
skill later. One character should have a strong interrogation skill.
    Get full body armor and laser rifles for all, and a med kit for the
Doctor. Save after arriving in each town. After thirteen saves, copy them to
a disk and start all over. Times is a factor - save as much time as possible.


The Ancient Ship
================
You can get around faster by salvaging the Ancient ship, in the Ylaven gas
giant. But first get the antimatter fuel cores from the Ancient site on
Patinir to power the ship. Another thing to acquire soon in the locator.
