                 ...
                 FIXED BY -=T=H=e=-=s=K=e=L=e=T=o=N=-
...
In Hallway        --   --   (automatic)
                      ...
                      _                 __                _      _
                     (_)             __/ /               / )    (_)
             ____   _   ___    ____ /_  _/____    ______/ /_   _   ____
            / _  ) / ) / _ \  / _  ) / / / _  )  /  ___/ _  ) / ) / _  )
           / (/ (_/ (_/ // (_/ (/ (_/ (_/ (__(___) (  / // (_/ (_/ (/ (_
          / _____(___(_/ \__(___\__(___(___________/ (_/(___(___/ _____/
         / /                  _                        _   _   / /
        / /                  (_)                      (_) / ) / /
       (_/ ____   _______   _   ____   ____          _   / /_(_/_______
   Best   / _  ) / _  _  ) / ) / _  ) / _  )        / ) / _  ) / _  _  )
     Of  / (/ (_/ // // (_/ (_/ (/ (_/ (/ (_  AnD  / (_/ (/ (_/ // // (
        (___\__(_/(_/(___(___(__  __(___\__/      (___(______(_/(_/(___)
                             __/ /
    - 2 Nodes               / / /    SYSOP : -=T=H=e=-=s=K=e=L=e=T=o=N=-
    - Dream Team Hq        (___/-sk-
