...
Typed by THE SKAMAN.  Edited by PARASITE.
  ...
  Choose one of the characters and go down to the security room on the second
  ...
  the keys in the lift, you don't need them anymore ). Leave the lift and you
  will now be in the main control room, and here you will find three different
  ...
  to the balcony above the front entrance on level two, use the rope and your
  other character will climb up and onto the balcony away from danger.
  Get one of your characters to get the fuse, the rubber glove and a gun, and
  ...
  all the zombies in the cold store ( if you use the tape from the video shop
  ...
  Get everybody inside the helicopter and start it up with key (remember where
