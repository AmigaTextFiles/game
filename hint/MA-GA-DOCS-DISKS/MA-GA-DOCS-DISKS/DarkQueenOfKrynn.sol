...
¤
                           ...
                           Tips and Mini-Walkthru

          Fixed by Baser Evil - The Courts of Chaos - 501-336-9661

  Regards to the Best Rygar, Scooter, 2-Tuff, Munchie, Flex, Razor Blade 
...
The first thing you need to know about is the nasty bug in regard to
multi-class characters. Usually, when a character has enough points to
go up a level, his or her name shows pink on the screen. However, the bug
prevents this from happening with multi-class types. So the character is
accumulating points, but never seems trainable.
...
have enough points for the next level. This was more of a problem for
dual-class types, since my triple-class characters usually got the color
change. 
...
need arrows(or good bows, or both), the simplest thing to do is play the old
game of "Muggee". 
...
off what you want, and then dump them. This is about the only way you'll
get magic arrows in the game (there is a place where you can get some +4's,
but not many, and only once). 
...
you can't even pick up bracers from them (which makes me wonder how they
got that armor class of -1). Accumulating good equipment will be a slow
task.
...
(which I always thought of as Bozos) are the worst. I cringed whenever
these guys showed up in combat.
...
Action (if you have a dragonlance in the party, give the ring to whoever
has the lance).
...
Dark Queen of Krynn is copyrighted 1992 by SSI Inc.
