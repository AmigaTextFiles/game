...
Cashier's Room: Open wallet, operate $10 bill on cashier, get chips, exit
left
to blackjack room.
...
Train Station Entryway: Exit left to Lucky Dice Casino.
...
Secret Office: Open Desk, get letter to boss, drop cigar ring, exit secret
office.
