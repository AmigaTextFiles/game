                    MEAN STREETS SOLUTION 
                    --------------------- 
                 Compiled by: Lord Ironwolffe 
 
Unless you are really stuck.  I wouldn't recommend using the 
solve since the story of the game will be greatly hindered (and 
its a great story!).  I haven't included what the entire plot is 
so as not to ruin it.  So, use them when you need'em... 
 
SOLVING MEAN STREETS 
-------------------- 
