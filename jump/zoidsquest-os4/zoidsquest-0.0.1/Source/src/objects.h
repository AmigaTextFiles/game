...
class PropertyContainer{
  public:
    ...
    int  HasProperty(char *property); //Returns True if object has "property"
...
class BaseObject{
  ...
  protected:
    ...
    int CommonSolidHandler(struct CollisionInfo *collision_info);
    virtual void SolidHandler(struct CollisionInfo *collision_info);  //Very common handler, may as well be in base class
