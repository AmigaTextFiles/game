...
public:
	...
	bool room_change_request(void) {return m_requested_room;};
	void clear_change_request(void) {m_requested_room=false;};

	int get_requested_room_x(void) {return m_requested_room_x;};
	int get_requested_room_y(void) {return m_requested_room_y;};
	int get_requested_room_door(void) {return m_requested_room_door;};

	bool has_key(void) {return m_key;};
	void use_key(void) {m_key=false;};

	void set_rescued_goonies(int n) {m_goonies_rescued=n;};
	int get_rescued_goonies(void) {return m_goonies_rescued;};

	int get_energy(void) {return m_energy;};
	int get_experience(void) {return m_experience;};
	int get_score(void) {return m_score;};
	void inc_score(int score);
	
	int get_last_state(void) {return m_last_state;};
	Symbol *get_last_pick(void) {return m_last_pick;};
	Symbol *get_last_hit(void) {return m_last_hit;};
	Symbol *get_last_hit_by(void) {return m_last_hit_by;};
	Symbol *get_camefrom(void) {return m_camefrom;};
	...
	int get_bluebadbook_nghosts(void) {return m_bluebadbook_nghosts;};
	void set_bluebadbook_nghosts(int n) {m_bluebadbook_nghosts=n;};
...
protected:
	...
	// object variables:
	int m_yellowhelmet_status,m_yellowhelmet_timmer;
	int m_greycoat_status,m_greycoat_timmer;
	int m_yellowcoat_timmer;
	int m_hammer_status;
	int m_greenbook_status;
	int m_redbook_status;
	int m_lightbluebook_status;
	int m_bluebook_status,m_bluebook_timmer;
	int m_greencoat_timmer;
	int m_whitebook_status;
	int m_yellowshield_status,m_yellowshield_timmer;
	int m_lightbluecoat_timmer;
	int m_whiteshield_status,m_whiteshield_timmer;
	int m_lightbluehelmet_status,m_lightbluehelmet_timmer;
	int m_yellowbook_status,m_yellowbook_timmer;
	int m_purpleshield_status,m_purpleshield_timmer;
	int m_clock_timmer;
