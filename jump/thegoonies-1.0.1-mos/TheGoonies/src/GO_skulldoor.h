...
public:
	...
	int get_destination_x(void) {return m_destination_x;};
	int get_destination_y(void) {return m_destination_y;};
	int get_destination_door(void) {return m_destination_door;};
