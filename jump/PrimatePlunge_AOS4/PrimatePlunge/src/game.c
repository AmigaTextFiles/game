...
void loadGame( void )
{
    ...
    */
    ...
    /*
        Sounds
    */
    death = loadSound("MonkeyDeath2.ogg");
    jetpack = loadSound("JetPack.ogg");
    parachuteSnd = loadSound("Parachute.ogg");
    timeUp = loadSound("timeUp.ogg");
    congrats = loadSound("Congratulations.ogg");
    congratsEnding = loadSound("CongratsEnding.ogg");
    getStarRating = loadSound("GetJewel.ogg");
    interface = loadSound("InterfaceSelect.ogg");
    powerupBeanSnd = loadSound("PowerUpBean.ogg");
    powerupHealthSnd = loadSound("PowerUpHealth.ogg");
    powerupParachuteSnd = loadSound("PowerUpParachute.ogg");
    powerupJetpackSnd = loadSound("PowerUpJet.ogg");
    starRating = loadSound("StarRating.ogg");
    CreateSoundSet(&ah, 1);
        AddSoundToSet("MonkeyAh4.ogg", &ah);
    CreateSoundSet(&boing, 3);
        AddSoundToSet("Boing1.ogg", &boing);
        AddSoundToSet("Boing2.ogg", &boing);
        AddSoundToSet("Boing3.ogg", &boing);
    CreateSoundSet(&ouch, 3);
        AddSoundToSet("MonkeyBigHit1.ogg", &ouch);
        AddSoundToSet("MonkeyBigHit2.ogg", &ouch);
        AddSoundToSet("MonkeyBigHit3.ogg", &ouch);
    CreateSoundSet(&ouchSmall, 3);
        AddSoundToSet("MonkeySmallHit1.ogg", &ouchSmall);
        AddSoundToSet("MonkeySmallHit2.ogg", &ouchSmall);
        AddSoundToSet("MonkeySmallHit3.ogg", &ouchSmall);
    CreateSoundSet(&land, 2);
        AddSoundToSet("land1.ogg", &land);
        AddSoundToSet("land2.ogg", &land);
    
    /*
        Music
    */
    titleMusic=loadMusic("titleMusic.ogg");
    gameMusic=loadSound("gameMusic.ogg");
...
char* locateFile( char* filename, char* subdir )
{
	...
	if (subdir == NULL) {
		snprintf( fullPath, MAX_STRING_LEN, "%s%s", GAMEDATADIR, filename );
	} else {
