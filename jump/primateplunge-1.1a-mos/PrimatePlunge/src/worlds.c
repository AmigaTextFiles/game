...
/* Special sound file to play when Monkey lands on platform, if any */
currentWorld->platformRefs[nextPlatformRef]->snd = loadSound("BreakingRock.wav");
...
/* Special sound file to play when Monkey lands on platform, if any */
currentWorld->platformRefs[nextPlatformRef]->snd = loadSound("LandingOnSpikes.wav");
...
/* Special sound file to play when Monkey lands on platform, if any */
currentWorld->platformRefs[nextPlatformRef]->snd = loadSound("BreakingTree.wav");
...
/* Special sound file to play when Monkey lands on platform, if any */
currentWorld->platformRefs[nextPlatformRef]->snd = loadSound("Piranha.wav");
...
/* Special sound file to play when Monkey lands on platform, if any */
currentWorld->platformRefs[nextPlatformRef]->snd = loadSound("BurningMonkeyHands.wav");
...
/* Special sound file to play when Monkey lands on platform, if any */
currentWorld->platformRefs[nextPlatformRef]->snd = loadSound("BurningMonkeyHandsEvenMore.wav");
...
/* Special sound file to play when Monkey lands on platform, if any */
currentWorld->platformRefs[nextPlatformRef]->snd = loadSound("LandMetal.wav");
