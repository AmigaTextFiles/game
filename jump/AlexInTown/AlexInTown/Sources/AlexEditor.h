char version[]="$VER: Alex in Town Level Editor V1.2 (16.03.2003)";
...
struct IntuiText my_bods_text=
{
  ...
  "Are you sure?", /* IText, the text that will be printed. */
...
{
  2,       /* FrontPen, colour 0 (blue). */
  0,       /* BackPen, not used since JAM1. */
  JAM1,    /* DrawMode, do not change the background. */
  15,      /* LedtEdge, 15 pixels out. */
  33,      /* TopEdge, 5 lines down. */
  NULL,    /* ITextFont, default font. */
  "Send Levels to drHirudo@gmx.net", /* IText, the text . */
  NULL,    /* NextText, no more IntuiText structures link. */
};
...
struct IntuiText my_body_text2=
{
  ...
  JAM1,    /* DrawMode, do not change the background. */
  15,      /* LedtEdge, 15 pixels out. */
  19,      /* TopEdge, 5 lines down. */
  NULL,    /* ITextFont, default font. */
  "Copyright by drHirudo © 2003", /* IText, the text . */
...
struct IntuiText my_body_text=
{
  ...
  5,       /* TopEdge, 5 lines down. */
  NULL,    /* ITextFont, default font. */
  "Alex in Town Level Editor V1.2", /* IText, the text . */
...
struct Gadget gadget1=
{
  ...
  245,           /* LeftEdge, 245 pixels out. */
  220,          /* TopEdge, 220 lines down. */
  8,            /* Width,  8 pixels wide. */
  8,            /* Height, 8 pixels lines heigh. */
  GADGHNONE,   /* If you set the flag GADGHNONE the cursor will not be */
...
struct StringInfo my_string_info=
{
  ...
  my_undo_buffer,  /* UndoBuffer, pointer to a null-terminated string. */
                   /* (Remember my_buffer is equal to &my_buffer[0]) */
  0,               /* BufferPos, initial position of the cursor. */
  3,               /* MaxChars, 2 characters + null-sign ('\0'). */
  0,               /* DispPos, first character in the string should be */
                   /* first character in the display. */
...
struct NewWindow my_new_window=
{
  ...
  SMART_REFRESH|BACKDROP|BORDERLESS|ACTIVATE|RMBTRAP, /* Flags       Intuition should refresh the window. */ 
  &my_gadget,      /* FirstGadget. */
...
struct IntuiText my_fifth_text=
{
  2,          /* FrontPen, black. */
  0,          /* BackPen, not used since JAM1. */
  JAM1,       /* DrawMode, do not change the background. */
...
struct MenuItem my_fifth_item=
{
  ...
  (APTR) &my_fifth_text, /* ItemFill, pointer to the text. */
...
{
  &my_fifth_item,            /* NextItem, not linked anymore. */
  0,               /* LeftEdge, 0 pixels out. */
...
struct MenuItem my_third_item=
{
  ...
  NULL,            /* SelectFill, nothing since we complement the col. */
  'S',               /* Command, no command-key sequence. */
  NULL,            /* SubItem, no subitem list. */
  MENUNULL,        /* NextSelect, no items selected. */
};
...
struct MenuItem my_second_item=
{
  ...
  NULL,            /* SelectFill, nothing since we complement the col. */
  'O',               /* Command, no command-key sequence. */
  NULL,            /* SubItem, no subitem list. */
  MENUNULL,        /* NextSelect, no items selected. */
};
...
/*                                        */
/* Font name:               AlexTown.font */
/* Struct name:                  AlexTown */
/* Height:                              8 */
/* Characters:                   32 - 158 */
/******************************************/
