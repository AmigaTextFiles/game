...
Surface* Surface::CaptureScreen()
{
  ...
  if (use_gl)
  {
    ...
    temp = SDL_CreateRGBSurface(SDL_SWSURFACE, screen->w, screen->h, 24, 0x000000FF, 0x0000FF00, 0x00FF0000, 0);
#else
    temp = SDL_CreateRGBSurface(SDL_SWSURFACE, screen->w, screen->h, 24, 0x00FF0000, 0x0000FF00, 0x000000FF, 0);
#endif
    if (temp == NULL)
