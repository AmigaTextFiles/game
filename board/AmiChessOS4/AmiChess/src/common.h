...
#define POST    0x1000
#define PONDER  0x2000
#define HARD    0x4000

#define AUTOPLAY 0x10000
#define SUPERVISOR 0x20000
#define REVERSEBOARD 0x40000
...
MUIM_Chess_Side,
MUIM_Chess_Board,
MUIM_Chess_BoardSmall,
MUIM_Chess_BoardMedium,
MUIM_Chess_BoardLarge,
MUIM_Chess_Pieces,
MUIM_Chess_HideMoves,
...
struct MUIP_Chess_HideMoves {unsigned long MethodID; int hide; };
...
struct MUIP_Chess_UseHash {unsigned long MethodID; int usehash; };
...
extern Object * STDARGS VARARGS68K DoSuperNew(struct IClass *, Object *, ...);
