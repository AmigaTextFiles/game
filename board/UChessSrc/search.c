...

{
  ...
  int __aligned max_time;
#endif
  short bestwidth = 0;
#if defined NULLMOVE || defined DEEPNULL
  short int __aligned PVsave;
  short int __aligned PVarisave;
  unsigned short __aligned verydeep=0xffff;
#endif
#ifdef DEBUG
  int xxxtmp;
  int tracetmp;
#endif
  short __aligned extdb= 0;
  short __aligned threat= 0;      /* tom@izf.tno.nl */
  short __aligned threat2= 0;     /* tom@izf.tno.nl */
  short __aligned do_pvs;
