...
#define VERSTAG "\0$VER: Sudoku 1.0 (06.12.2005)"
...
SudokuCell::draw() {
  ...
  fl_font(FL_HELVETICA_BOLD, h() / 2); //5);
...
#ifdef __amigaos4__
  menubar_ = new Fl_Menu_Bar(0, 0, 3 * GROUP_SIZE, 25);
#else
...
#ifdef __amigaos4__
    help_dialog_->load("PROGDIR:help.html");
#else
    help_dialog_->value(
    "<HTML>\n"
    "<HEAD>\n"
