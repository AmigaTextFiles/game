...
#ifdef __MORPHOS__
#define VERSTRING "UChess v2.89(PPC)"
#define AVSTR "$VER: UChess 2.89 [PPC] (29.07.94)"
...
extern struct IntuiMessage globalmessage;
extern char HintString[80];
extern char MateString[40];
...
#else
#define MoveMem128(a,b)	CopyMem(a, b, 128)
#define ClearMem(a,b)	memset(a, 0, b)
#endif
#endif
...
#ifdef ttblsz
     extern struct hashentry ttable[2][vttblsz + MAXrehash];
#endif
