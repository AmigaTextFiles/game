...
static inline int ScoreKPK (short side, short winner, short loser, short king1, short king2, short sq);
...
short Mknight[2][64];
short Mbishop[2][64];
static short Mking[2][64];
static short Kfield[2][64];
static short c1, c2, *atk1, *atk2, *PC1, *PC2;
static short atak[2][64];
short emtl[2];
