...
struct EmulLibEntry MUIBoardGate = {TRAP_LIB, 0, (void(*)(void))Dispatcher};

void INIT_6_MUI_Board_Class(void)
{
if(!(MUI_Board_Class=MUI_CreateCustomClass(0,MUIC_Group,0,sizeof(struct Data),(APTR)&MUIBoardGate))) exit(20);
}
