...
TCPConnection *TCPConnection::_connect(const char *hostName, int port, const char **errString, bool *stop, bool join) {
...
TCPConnection *TCPConnection::_accept(int port, const char **errString, bool *stop) {
