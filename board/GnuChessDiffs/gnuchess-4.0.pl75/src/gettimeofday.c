...
#define __autoinit
#define __autoexit
asm ("  .text;  .stabs \"___CTOR_LIST__\",22,0,0,__STIInitGetTimeOfDay");
asm ("  .text;  .stabs \"___DTOR_LIST__\",22,0,0,__STDTermGetTimeOfDay");
#elif defined(_DCC)
...
STATIC __autoinit LONG _STIInitGetTimeOfDay(VOID)
...
STATIC __autoexit VOID _STDTermGetTimeOfDay(VOID)
