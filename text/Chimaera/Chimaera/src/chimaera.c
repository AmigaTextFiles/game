             ...
             switch (apoint) /*---- Execute the next command -----------------------*/
               {
                ...
                case 15 : destroy(monstpoint); break;             /* destroy something    */
       ...
       if (!flags[NIGHT]) /*---- Day, the player can see everywhere ----*/
       ...
       else  /*---- Night, can only see if the lamp is lit -------------*/
         {
          ...
          if (!flags[DARK]) /*---- Night but not dark ------------------*/
            ...
            {
             if (ways[DOWN])                /* destroy the player */
               {
...
void dead(void)   /* The player has been destroyed, offer reincarnation    */
...
/*----------------------------------------------------------------------*/
void destroy(int objpoint)          /* destroy something                      */
   {
