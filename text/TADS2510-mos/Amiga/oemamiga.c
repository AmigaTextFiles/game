 ...
 */
char G_tads_oem_app_name[] = "MorphOS TADS";
 ...
 */
char G_tads_oem_dbg_name[] = "MorphOS TADS Debugger";
 ...
 */
char G_tads_oem_author[] = "MorphOS TADS by Jan-Erik Karlsson <trgswe@spray.se>.\n";
