...
int init_dispatch()
{
  ...
  gidispatch_set_object_registry(glulxe_classtable_register, 
    glulxe_classtable_unregister); /* AMIGA */
  gidispatch_set_retained_registry(glulxe_retained_register, 
    glulxe_retained_unregister); /* AMIGA */
  ...
  gidispatch_set_autorestore_registry(glulxe_array_locate, /* AMIGA */
    glulxe_array_restore); /* AMIGA */
