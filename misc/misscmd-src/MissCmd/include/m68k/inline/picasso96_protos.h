...
struct BitMap * __p96AllocBitMap(__reg("a6") struct Library *, __reg("d0") ULONG SizeX, __reg("d1") ULONG SizeY, __reg("d2") ULONG Depth, __reg("d3") ULONG Flags, __reg("a0") struct BitMap * a0arg, __reg("d7") RGBFTYPE RGBFormat)="\tjsr\t-30(a6)";
