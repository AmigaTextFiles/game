...
USHORT voittosummat[8][8]=  /* 1. luku = panos ja 2. luku = voitto */
                            {
...
BYTE *SekaTextit[]= { "** PARHAIMMAT MENEVÄT LISTALLE ! **",
...
UBYTE kortit[75] = {0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
