...
#ifdef __amigaos4__
static const char __attribute__((used)) stack[] = "\0$STACK:81920";
static const char __attribute__((used)) extver[] = "\0$EXTVER: uqm 0.7.0r3 (22.10.2020) AmigaOS port by salass00";
#endif
