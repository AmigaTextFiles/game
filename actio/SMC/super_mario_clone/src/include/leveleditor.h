/***************************************************************************
     leveleditor.cpp  -  header for the corresponding cpp file
...
#define MENU_YOSHI_WORLD 13
#define MENU_GROUND_GHOST_1 14
...
public:
	 ...
	 */
	void Add_Item_Object( string path, cSprite *nSprite_type, string nName = "" );
...
private:
	...
	SDL_Surface *arrow_left, *arrow_right;
};

/* *** *** *** *** *** *** *** *** *** *** *** *** *** *** *** *** *** */

// ### The Leveleditor functions ###
