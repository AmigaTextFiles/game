...
copyright:	dc.b    "nibbly:nibbly/copyright.exe $"
adresse4:	dc.b	0,0,0,0,0,0,0,0
		dc.b	0
		even
mytitel:	dc.b    "nibbly:nibbly/titel.exe $"
adresse:	dc.b	0,0,0,0,0,0,0,0
		dc.b	0
		even
endpart:	dc.b    "nibbly:nibbly/endpart.exe JT"
        	even
...
file1:		dc.b    "run <nil: >nil: nibbly:nibbly/ingame.exe $"
adresse2:	dc.b	0,0,0,0,0,0,0,0
		dc.b	0
        	even

file2:		dc.b    "run <nil: >nil: nibbly:nibbly/map.exe $"
