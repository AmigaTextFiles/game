...
public:
	...
	void draw(int x,int y,int sx,int sy,UBYTE *screen,int screen_x,int screen_y,int pitch)
	{
		m_src->draw_sprite(m_x,m_y,m_dx,m_dy,x-m_xoffs,y-m_yoffs,sx,sy,screen,screen_x,screen_y,pitch);
	}; /* draw */ 

	void draw(int x,int y,UBYTE *screen,int screen_x,int screen_y,int pitch)
	{
		m_src->draw_sprite(m_x,m_y,m_dx,m_dy,x-m_xoffs,y-m_yoffs,m_dx,m_dy,screen,screen_x,screen_y,pitch);
	}; /* draw */ 

	void draw_cut(int x,int y,int sx,int sy,UBYTE *screen,int screen_x,int screen_y,int pitch,int cut)
	{
		m_src->draw_sprite_cut(m_x,m_y,m_dx,m_dy,x-m_xoffs,y-m_yoffs,sx,sy,screen,screen_x,screen_y,pitch,cut);
	}; /* draw */ 

	void drawmask(UBYTE type,int x,int y,int sx,int sy,UBYTE *screen,int screen_x,int screen_y,int pitch)
	{
		m_src->draw_sprite_mask(type,m_x,m_y,m_dx,m_dy,x-m_xoffs,y-m_yoffs,sx,sy,screen,screen_x,screen_y,pitch);
	}; /* drawmask */ 

	void drawmask(UBYTE type,int x,int y,UBYTE *screen,int screen_x,int screen_y,int pitch)
	{
