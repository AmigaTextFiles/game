...
void Bitmap::draw(int x,int y,int sx,int sy,UBYTE *screen,int screen_x,int screen_y,int pitch)
{
	int i,j;
	int xt,yt;
	int y_error,x_error;
...
void Bitmap::draw_sprite(int x1,int y1,int spx,int spy,int x,int y,int sx,int sy,UBYTE *screen,int screen_x,int screen_y,int pitch)
{
	int i,j;
	int xt,yt;
	int y_error,x_error;
...
void Bitmap::draw_sprite_cut(int x1,int y1,int spx,int spy,int x,int y,int sx,int sy,UBYTE *screen,int screen_x,int screen_y,int pitch,int cut)
{
	int i,j;
	int xt,yt;
	int y_error,x_error;
...
void Bitmap::draw_sprite_mask(UBYTE type,int x1,int y1,int spx,int spy,int x,int y,int sx,int sy,UBYTE *screen,int screen_x,int screen_y,int pitch)
{
	int i,j;
	int xt,yt;
	int y_error,x_error;
...
int Bitmap::coltest(int x1,int y1,int spx,int spy,int x,int y,int sx,int sy,UBYTE *screen,int screen_x,int screen_y,int pitch)
{
	int i,j;
	int xt,yt;
	int y_error,x_error;
