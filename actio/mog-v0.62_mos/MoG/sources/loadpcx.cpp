...
void PCX_IMAGE::draw(int x,int y,int sx,int sy,UBYTE *screen,int screen_x,int screen_y,int pitch)
{
	int i,j;
	int xt,yt;
	int y_error,x_error;
...
void PCX_IMAGE::draw_sprite(int x1,int y1,int spx,int spy,int x,int y,int sx,int sy,UBYTE *screen,int screen_x,int screen_y,int pitch)
{
	int i,j;
	int xt,yt;
	int y_error,x_error;
