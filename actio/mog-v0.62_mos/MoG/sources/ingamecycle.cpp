...
//	if (fp2==0) fp2=fopen("out.txt","w");
//	fprintf(fp2,"pers_x: %.3i -> %.3i pers_y: %.3i -> %.3i state: %.2i pos: %.2i ",pers_x,next_x,pers_y,next_y,pers_state,pers_pos);
