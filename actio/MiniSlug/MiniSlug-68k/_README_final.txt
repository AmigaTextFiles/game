...
Port Amiga 68k by Arczi Artur Jarosik

> Port Notes:

 32bit mode is slower and has bad colors. Play in 16bit instead.
 
> News:
 
 Now original soundtrack included + more original sounds 
 Faster FPU version with reduced frame wait time
...
minislug.exe       - The game, exe.
minislug_cfg.exe   - Configuration tool.
