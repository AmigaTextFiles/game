			...
			case SDL_JOYBUTTONDOWN:
				{
					...
					if (event.jbutton.button == GP2X_BUTTON_UP)
						gKeyUp = 1;
					if (event.jbutton.button == GP2X_BUTTON_UPRIGHT)
					{
						gKeyRight = 1;
						gKeyUp = 1;
					}
					if (event.jbutton.button == GP2X_BUTTON_RIGHT)
						gKeyRight = 1;
					if (event.jbutton.button == GP2X_BUTTON_DOWNRIGHT)
					{
						gKeyRight = 1;
						gKeyDown = 1;
					}
					if (event.jbutton.button == GP2X_BUTTON_DOWN)
						gKeyDown = 1;
					if (event.jbutton.button == GP2X_BUTTON_DOWNLEFT)
					{
						gKeyLeft = 1;
						gKeyDown = 1;
					}
			...
			case SDL_JOYBUTTONUP:
				{
					...
					else if (event.jbutton.button == GP2X_BUTTON_SELECT)
						return 0;
					else if (event.jbutton.button == GP2X_BUTTON_START)
					{
