...
#else
#if (SYSTEM == SYS_MORPHOS)
// just returning the result of fopen() which should be either a pointer to a file or NULL
// function dcl_fileexists() does the same to check whether the file exists anyway, so
// callig it would be redundant
  char n[200];
