...
long sceLibcTime(long *tm);
int sceLibcGettimeofday(struct sce_timeval *__p, struct sce_timezone *__z);

void *sceKernelAllocPartitionMemory(size_t size);
int sceKernelFreePartitionMemory(void *p);
...
int sceIoDread(int fd, struct sce_dirent *de); 
void sceIoDclose(int fd); 


void sceAudio_0();//
void sceAudio_1();//
int sceAudio_2(int, int, int, void *);//
int sceAudio_3(int, int samplecount, int);//init buffer? returns handle, minus if error
void sceAudio_4(int handle);//free buffer?
void sceAudio_5();//
int sceAudio_6(int, int);//
void sceAudio_7();//
void sceAudio_8();//
...
typedef int (*pg_threadfunc_t)(int args, char *argp);
