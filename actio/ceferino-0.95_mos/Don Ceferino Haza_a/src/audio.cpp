...
{
	char nombres[][200]= {\
		{SRC_DIR "/sonidos/tiro.wav"},\
		{SRC_DIR "/sonidos/mata.wav"},\
		{SRC_DIR "/sonidos/pierde.wav"},\
		{SRC_DIR "/sonidos/tecla1.wav"},\
		{SRC_DIR "/sonidos/tecla2.wav"},\
		{SRC_DIR "/sonidos/tic.wav"},\
		{SRC_DIR "/sonidos/gancho.wav"},\
		{SRC_DIR "/sonidos/toc.wav"},\
		{SRC_DIR "/sonidos/romper.wav"},\
		{SRC_DIR "/sonidos/alarma.wav"},\
		{SRC_DIR "/sonidos/item.wav"},\
		{SRC_DIR "/sonidos/boom.wav"}};
	int i;
...
{
	char nombres[][200] = {\
		{SRC_DIR "/musicas/menu.xm"},\
		{SRC_DIR "/musicas/menu.xm"}}; // temp
	int i;
