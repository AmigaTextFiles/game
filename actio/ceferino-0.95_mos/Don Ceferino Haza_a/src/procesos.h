...
class procesos
{
	public:
		...
		void crear_mensaje(class grafico *letras, char *cadena);
		void crear_mensaje_rapido(class grafico *letras, char *cadena);
	...
	private:
		...
		template <class S> void imprimir_lista(SDL_Surface *screen, SDL_Rect *modif, int *lim, S *lista);
