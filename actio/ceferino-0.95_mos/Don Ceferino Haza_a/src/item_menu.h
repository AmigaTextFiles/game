...
/*!
 * \brief Opcion para seleccionar desde el menú
 */
class item_menu
{
	public:
		void iniciar(grafico *_ima_letras, int _x_inicial, int _y_inicial, int _x_destino, int _y_destino, char *cadena);
