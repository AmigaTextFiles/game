 ...
 */
void procesos :: crear_mensaje(class grafico *letras, char *cadena)
{
	struct nodo <class fuente> *pnuevo;
	int i;
	int x;

	x = 320 - ((strlen(cadena)/2)*33);
	...
	for (i=0; cadena[i] != '\0'; i++)
	{
		if (cadena[i] != ' ')
		{
			...
			pnuevo->obj = new fuente;
			pnuevo->obj->iniciar(letras, x+i*33, 240, cadena[i], 1);
 ...
 * \param cadena mensaje a imprimir
 */
void procesos :: crear_mensaje_rapido(class grafico *letras, char *cadena)
{
	struct nodo <class fuente> *pnuevo;
	int i;
	int x;
	...
	for (i=0; cadena[i] != '\0'; i++)
	{
		if (cadena[i] != ' ')
		{
			pnuevo = new struct nodo <class fuente>;
			pnuevo->obj = new fuente;
			pnuevo->obj->iniciar(letras, x+i*33, 200, cadena[i], 0);
