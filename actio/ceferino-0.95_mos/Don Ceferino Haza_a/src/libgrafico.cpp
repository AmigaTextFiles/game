...
int libgrafico :: cargar_imagenes(void)
{
	...
	printf(".");
	fflush(stdout);
	ima_item->iniciar("items.png", 1, 11, 16, 32, modo_video);
	...
	printf(".");
	fflush(stdout);
	ima_menu_oscuro->iniciar("menu_oscuro.jpg", 1, 1, 0, 0, modo_video);
