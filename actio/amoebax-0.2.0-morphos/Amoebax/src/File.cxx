...
#if !defined (IS_WIN32_HOST) && !defined (IS_GP2X_HOST) && !defined (IS_OSX_HOST) && !defined (IS_MOS_HOST)
#include "binreloc.h"
...
#elif defined (IS_MOS_HOST)
static const char *k_DataDirectory = DATADIR;
#else // !IS_WIN32_HOST && !IS_GP2X_HOST && !IS_OSX_HOST && !IS_MOS_HOST
