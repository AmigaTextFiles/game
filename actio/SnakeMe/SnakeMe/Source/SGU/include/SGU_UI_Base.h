...
public:
	...
	~CUIObject() { }
	bool DefaultSendMessage(int message,int p1,int p2,SDL_Surface *si);
	virtual bool SendMessage(int message,int p1,int p2,SDL_Surface *si)=0;
...
public:
	...
	bool SendMessage(int message,int p1,int p2,SDL_Surface *si);
public:
	SGU_Sprite *font;
	char *caption;
	SGU_RegionSaver topregion;
