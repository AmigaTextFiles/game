...
bool CUILightButton::SendMessage(int message,int p1,int p2,SDL_Surface *si)
{
	switch (message)
	{
	case UIEV_DRAW:
...
// Process messages
bool CUIObject::DefaultSendMessage(int message,int p1,int p2,SDL_Surface *si)
{
	switch (message)
	{
	case UIEV_DRAW:
...
bool CUISlideBar::SendMessage(int message,int p1,int p2,SDL_Surface *si)
{
switch (message)
	{
	// Note : to do
...
bool CUIGenericList::SendMessage(int message,int p1,int p2,SDL_Surface *si)
{
	switch (message)
	{
	case UIEV_DRAW:
...
bool CUIBoolChooser::SendMessage(int message,int p1,int p2,SDL_Surface *si)
{
	switch (message)
	{
	case UIEV_DRAW:
...
bool CUIIntChooser::SendMessage(int message,int p1,int p2,SDL_Surface *si)
{
	switch (message)
	{
	case UIEV_DRAW:
