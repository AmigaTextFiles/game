...
bool CUIGenericHorzIntBar::SendMessage(int message,int p1,int p2,SDL_Surface *si)
{
	switch (message)
	{
	case UIEV_KEYDOWN:
...
bool CUIGenericVertIntBar::SendMessage(int message,int p1,int p2,SDL_Surface *si)
{
	switch (message)
	{
	case UIEV_KEYDOWN:
