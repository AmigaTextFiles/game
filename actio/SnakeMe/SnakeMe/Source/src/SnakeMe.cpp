...
void AdvancedSetupUpdateText(void)
{
	...
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.deflng);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+1]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.inclng);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+2]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.nbmeal);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+3]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.mealchangetime*5);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+4]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.nbbonus);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+5]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.bonuschangetime*5);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+6]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.maxpoint);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+7]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.ptgetmeal);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+8]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.ptgethit);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+9]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.ptgetsnake);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+10]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.ptloosecrash);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+11]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
	sprintf(ctemp,"%d",AdvancedOptions.ptloosehit);
	((CUITextEdit *)(AdvancedSetup->objects[ASTEXTBASE+12]))->SendMessage(INTERNEV_SETTEXT,(int)(void *)ctemp,0,ScrInfo);
}
	...
	case MAINMENU:
		{
			if (DrawState==FIRSTDRAW)
			{
				...
				SGU_DisplayTextCenter(ScrInfo,littlefont,0,458,640,"SnakeMe Version 1.0");
