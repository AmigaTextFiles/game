...
typedef struct _AShip {
  ...
  BOOL     s_drawn[MY_BUFFERS];            /* For double-buffering...       */
  ...
  BOOL     f_drawn[MY_BUFFERS];            /* Double buffering..aagh.       */ 
  ...
  BOOL     sh_drawn[MY_BUFFERS];           /* For double-buffering...       */
