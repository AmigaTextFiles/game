#define DECIMALVERSION "1.4"
#define INTEGERVERSION "1.40"
#define VERSION        "\0$VER: Koules " INTEGERVERSION " (14.3.2021)" // d.m.yyyy format
#define RELEASEDATE    "14-03-21" // dd-mm-yy format. Year *must* be only 2 digits!
#define VERSIONTEXT    "VERSION 1.4 RELEASE " DECIMALVERSION ": 14 MAR 2021"
#define COPYRIGHT      "© 2006-2021 James Jacobs of Amigan Software"
...
#ifdef WIN32
    #define DEFAULTBKGRND 2 // plasma
#endif
#ifdef AMIGA
    #define DEFAULTBKGRND 0 // solid
#endif
#define STARDENSITY     256 // lower numbers mean denser stars
