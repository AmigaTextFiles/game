...
Release history:
* 2006.Feb.27 - Updated so that it can still build "sdl" and "emtest" versions
  (on i386 Debian Testing, gcc 4.0.3, SDL 1.2.9)
* 2002.Apr.22 - 2002.Apr.27 - Initial release(s)
