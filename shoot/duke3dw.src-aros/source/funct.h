...
// Added text for version
// modified waitforeverybody(int x)
// Extended getfilenames
//
...
extern void waitforeverybody(int x);                                 // wxdm
...
extern int getfilenames(char *path, char kind[], short pmode);       // wxgf
...
extern int gametextsm(int x,int y,char *t,char s,short pal);         // wxvr
