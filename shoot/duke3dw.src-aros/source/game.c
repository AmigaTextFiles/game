...
//-------------------------------------------------------------------------
// Added Changed stuff
// Added Version number d3wver
// Added new screen sizes (Statusbar)
// Added DN BLUKEY / REDKEY / YELKEY cheats
// Added duke3dw.def file
// Added duke3dw.grp
// Added duke3dw.log
// Added DnwGrp for checking
// Added Maphacks.zip
// Added Revision with Version
// Added ThisMapname in PAUSE - June 2007
// Added Duke3d_hrp.zip
// 3.5
// Added addsearchpath("Autoload")
// Added removed if(!*c) break;
// Added changed maphacks.grp to maphacks.zip
// Added Commandline:   CLine
// 3.52
// Added Eduke HRP commands in Builds defs.c
// Added addsearchpath("Games")
// Added Menuscreen
// Changed Menu setup colors        menus.c
// Fixed menu jump to main when in settings
// 3.53
// Added extra key/armor boxes in small hud
// Added Duke3d_hrp_update.zip
// 3.54
// Added only 'maps' folders for user maps
// 3.55
// Added back if(!*c) break;
// Added checksearchpath for -g -x -h -map
// Added auto _hrp.zip for above
// Added several more cheatcodes
// Added XN or DN in front of cheat
// 3.56
// Added fix to DNGUN#
// 4.0.0
// Updated with latest Build  Rev 331
// Updated with latest Duke3d Rev 216
// Added Weapon icons in small hud
// Renamed menues.c to menus.c
// Added More Video Options menu
// Fixed Screen sizes
// Updated build eduke defs.c
// Added max/min/off crosshair
// Added Menuscreen
// Added hack to multivoc and winlayer for vista
// 4.0.1
// Fixed multiplay
// Added Fire Orange menu text color
// 4.0.2.0
// Search for duke3d_lrp.zip
// Added new cheat messages
// Fixed skin freezes on monsters (defs.c)
// Added several more defs.c to fix log errors
// 4.0.2.2
// Added Spacebar + Open for restart level in player.c
// 4.0.2.3
// Added RandomMusic - menus.c - premap.c
// 4.0.2.4
// Added if dead with Spacebar
// 4.0.2.5
// Added MapMusic - premap.c - duke3d.h - menus.c
// 4.0.2.6
// Fixed long search path
// Added addsearchpath("Maps")
// Added "game_dir" to commandline
// Added change all '\' to '/' in searchpath - cache1d.c
// 4.0.3.0 - Mar 2009
// Added actual weapon switch when empty
// 4.0.3.1 - Mar 2009
// Added autosave when added health/shield - F5
// Fixed music not working in premap.c
// 4.0.3.2 - Mar 2009
// Added MusicDir for user random music
// Added delay for autosaving
// Added autosave also saves now
// 4.0.3.3 - Mar 2009
// Added changed game10.sav to gamex.asv for playduke
// Added Autosave manual option
// 4.0.3.4 - Mar 2009
// Gave Autosave file a title
// include windows for delete gamex.asv at bonus
// 4.0.3.5 - Mar 2009
// Fixed broken TC def files not working (Platoon)
// Added -music path/file.mid to commandline
// 4.0.3.6 - April 2009
// Added map display for saved map
// Added small icon for saved games
// 4.0.4 - April 2009
// Changed version format as to swp
// 4.0.5 - April 2009
// Fixed GetRandom routine
// Added deminishing cheats for fly/medic/swim
// Added old autosave on loads on F3 menu
// 4.0.6 - May 2009
// Removed addsearchpath("Maps")
// Added back original full path search
// Replaced duke3ddef with userdef
// 4.1.0.1 - June 2009
// Added gamep.h
// Modified for MinGW/Msys
// Added addsearchpath(maps) if -map detected
// 4.1.0.2 - June 2009
// Added frontend Menu
// 4.1.0.3 - June 2009
// Public Release
...
// 4.1.0.5
// Changed myname to playernamearg and added ipaddressarg
// Changed ThisMapname to boardmapname for display only
// Major changes to Multiplay startup routines
// Added enlarged fps display
// Added TC_addon.zip for tc extensions
// Added no USER MAP display if bGrp
// 4.1.0.7
// Added VerifyConfiles
// Dumped all ties with JFAUD
// Added extra stuff to start menu
// Added additional Detect shareware
// Added FakePlayer options to menu
// Added start weapon in fakemulti is shotgun
// Fixed Skill sounds - premap.c
// Added Botnames  (manual enter in cfg file)
// Added new mini hud
// Removed 2 huds and reset screen nums back to original
// Updated Duke3dw.grp with new weapon icons at 5892-5900
// Added slightly darker gamma for lcd's in winlayer.c
// Added bFake
// 4.1.0.8
// Fixed overhead map display
// Cased startmenu listings
// Fixed addon.grp midis not playing
// 4.1.1.1 - July 2009
// Fixed - in foldername bypassing startmenu in startwin.game.c
// Fixed CRT not working in startwin.game.c
// 4.1.1.2 - July 2009
// Added sbak for baking screensize
// Changed menu text
// 4.1.3.1 - July 2009
// Fixed null botnames
// Added search for RTS file in checkforextras
// Changed texcache folder to wcache
// Added MenuBypass for batchfile or playduke
// Added MapName for initprintf only
// Added widescreen texture option
// Added MenuBypass = 0 if Quit to Title
// Added switched SDK to DX80
// Added Quit to Start menu option
// Added Bot starts with pistol in fakeplayer
// 4.1.3.2
// Fixed crash from eduke gameE_00.sav
// Added Shift-F12 selectes another random music if MusicDir=1
// Added new multiplayer code
// Removed game exit for sound error
// Added Escape key exit
// Added multiplayer logo start
// Added F5 for Multiplayer menu
// Added clients cannot pause game
// Added Map selection to Multiplay
// Added Addon selection to Multiplay
// Added Addon selection to Fakeplayer
// Fixed -v -l not working in multiplay
// Added Playername to multimenu
// Added Player color ud.color to multimenu
// Added multiplayer scoreboard F1 case 1234:
// Added F1/F5 options to fakeplayer
// 4.1.3.3
// Removed mrp detection
// Reset bHost for peer2peer
// Added goto multi menu if more than 2 players (out of sync)
// Fixed lowres errors when checking highres/
// Fixed nick addons '_2' in multimenu
// 4.1.4
// Added new jaudiolib
// Added .ogg and .wav files to search
// Added MusicDir = 1 if Music folder present
// Added Select Music menu
// Remove revision from title
// 4.1.5 - Nov 2009
// Updated to latest jaudiolib
// Changed music menu selection like swp (pgup/pgdn) in menus.c
// Added weaponhide
// Moved weapon icons to video options
// Fixed weapon icons sizes
// Adjusted inventory icons to status size
// Added delete = stop music in select music menu
// Adjusted minibar inv and icon positions
// 4.1.6 - Dec 2009 - 4.3.3
// Increased default skill from 2 to 3
// Added check for windows 7 - is_vista = 2
// Added Commandline Help to start menu
// Changed comlinehelp()
// Added NoHrp commandline and startmenu
// Added getdeffile
// Restricted start menu files to: 200 music, 200 map, 50 game.
// Fixed MapMusicPath
// Fixed internal mapname display when switching maps
// Fixed music volume at start
// Added iDef to getdeffile for default def files only
// Added disable default Hrps if nam.grp
// Added svgame for each .grp addon
// Added dolower(char *cpath)
// Added maps played in start menu
// Added addon and maps saved games
// Added minimum mixrate = 16000
// Added addon and maps saved games
// Added last played addon and map go to top of list
// Added hide batch cmd
// Added tab help information
// 4.2.0 - Feb 2010
// Added new look start menu
// Removed MusicShutdown if > 1 players
// Added by proasm etc
// Move -nohrp to commandlinecheck
// 4.2.1 - Feb 2010
// Fixed LCD/CRT not seperating in gameres
// Fixed classic mode in win7
// Added video mode settings when fullscreen on/off
// Added vsync
// Added load autosaved game  -asv
// Added DeleteAutoSave deleting correct file paths
// Increased CLine to 256
// Playduke 7 compatible
// gcc 4.4/5 fix from eduke
// Added -by detection for bypass press(x) and start menu
// 4.2.2 - March 2011
// Fixed - loading a autosavedgame from batch file or playduke
//
...
#define HEAD   "Duke Nukem 3D Unregistered Shareware"

#define HEAD2P "Duke Nukem 3D - Atomic Edition"
#define HEAD2S "Duke Nukem 3D Full Version"
#define HEAD2  "Duke Nukem 3D"

#define HEADA  "Duke Nukem 3D AUSSIE Unregistered Shareware"
#define HEAD2A "Duke Nukem 3D AUSSIE Full Version"
...
{
	if (ud.screen_size == 4)
 	    return scale(x<<16,ud.statusbarscale,100);
...
int gametext(int x,int y,char *t,char s,short dabits)
{
    ...
    while(*t)
    {
        ...
        rotatesprite(x<<16,y<<16,65536L,0,ac,s,p,dabits,0,0,xdim-1,ydim-1);
...
int minitext(int x,int y,char *t,char p,short sb)
{
    ...
    while(*t)
    {
		...
		if (cmode)
		    rotatesprite(sbarx(x),sbary(y),sbarsc(65536L),0,ac,0,p,sb,0,0,xdim-1,ydim-1);
		else
    ...
    while ((packbufleng = getpacket(&other,packbuf)) > 0)
    {
        switch(packbuf[0])
        {
            case 126: // LOAD GAME
                ...
                break;
            case 0:  //[0] (receive master sync buffer) - MASTER TO SLAVE
                j = 1;
                ...
                break;
            case 1:  //[1] (receive slave sync buffer) - SLAVE TO MASTER
                j = 2;
                k = packbuf[1];
            ...
            case 5: // NEW GAME
                ...
                break;
            case 6: // VERSION - INITIAL STARTUP
				//slaves in M/S mode only send to master
				//Master re-transmits message to all others
				if ((!networkmode) && (myconnectindex == connecthead))
					for(i=connectpoint2[connecthead];i>=0;i=connectpoint2[i])
				...
				ps[other].palookup = packbuf[i++];

                p_color[other] = sprite[ps[other].i].pal = ps[other].palookup;

                if (!bHost)
                {
                    ud.m_coop = ud.coop = packbuf[i++];
                    if (ud.m_coop == 1)
                    {
                        ud.m_monsters_off = 0;
            ...
            case 32:  // USER MAP
                ...
                if (boardfilename[0] != 0)
                {
                    ...
                    addsearchpath("maps");
                    addsearchpath("mapsdm");
                    ud.m_level_number = 7;
                    ud.m_volume_number = 0;
                    initprintf("Receiving Mapname: %s\n",boardfilename);
                    checkforextras(boardfilename);
                }
                else
                if (!bHost)
                {
            ...
            case 48: // LEVEL INFO
                ...
                i = 2;
                ud.m_level_number = ud.level_number = packbuf[i++];
                ud.m_volume_number = ud.volume_number = packbuf[i++];
                ud.m_player_skill = ud.player_skill = packbuf[i++];
                ud.m_monsters_off = ud.monsters_off = packbuf[i++];
                ud.m_marker = ud.marker = packbuf[i++];
                ud.m_ffire = ud.ffire = packbuf[i++];
                ud.warp_on = packbuf[i++];

                break;

            case 64: // PLAYER INFO  name/color
				//slaves in M/S mode only send to master
				//Master re-transmits message to all others
				if ((!networkmode) && (myconnectindex == connecthead))
					for(i=connectpoint2[connecthead];i>=0;i=connectpoint2[i])
				...
				other = packbuf[1];
                ps[other].palookup = sprite[ps[other].i].pal = p_color[other] = packbuf[2];
            ...
            case 250:    // PLAYER READY - wait for everybody
...
//    short who;
    ...
    if (networkmode == 1)
    {
        packbuf[0] = 17;       // SERVER BROADCAST
        if ((movefifoend[myconnectindex]-1) == 0)
             packbuf[0] = 16;  // PACKET BROADCAST
        j = 1;
...
void digitalnumber(long x,long y,long n,char s,char cs)
{
    ...
    {
        p = DIGITALNUM+*(b+k)-'0';
        rotatesprite(sbarx(c+j),sbary(y),sbarsc(sz),0,p,s,0,cs,0,0,xdim-1,ydim-1);
        j += tilesizx[p]+h;
    }
}
...
void displayinventory(struct player_struct *p)
{
    ...
    while( j <= 9 )
    {
        if( n&(1<<j) )
        {
            ...
            {
                case   1:
                rotatesprite(xoff<<16,y<<16,iz,0,FIRSTAID_ICON,0,0,2+16,windowx1,windowy1,windowx2,windowy2);break;
                case   2:
                rotatesprite((xoff+1)<<16,y<<16,iz,0,STEROIDS_ICON,0,0,2+16,windowx1,windowy1,windowx2,windowy2);break;
                case   4:
                rotatesprite((xoff+2)<<16,(y-1)<<16,iz,0,HOLODUKE_ICON,0,0,2+16,windowx1,windowy1,windowx2,windowy2);break;
                case   8:
                rotatesprite(xoff<<16,y<<16,iz,0,JETPACK_ICON,0,0,2+16,windowx1,windowy1,windowx2,windowy2);break;
                case  16:
                rotatesprite(xoff<<16,y<<16,iz,0,HEAT_ICON,0,0,2+16,windowx1,windowy1,windowx2,windowy2);break;
                case  32:
                rotatesprite(xoff<<16,(y-1)<<16,iz,0,AIRTANK_ICON,0,0,2+16,windowx1,windowy1,windowx2,windowy2);break;
                case 64:
                rotatesprite(xoff<<16,y<<16,iz,0,BOOT_ICON,0,0,2+16,windowx1,windowy1,windowx2,windowy2);break;
            }

            xoff += 22;

            if (p->inven_icon == j+1)
                rotatesprite((xoff-2-x4)<<16,(y+19-y4)<<16,iz,1024,ARROW,-32,0,2+16,windowx1,windowy1,windowx2,windowy2);
        }
...
void displayfragbar(void)
{
    ...
    if (current_menu == 203 || current_menu == 230)
        return;
...
void coolgaugetext(short snum)
{
     ...
     if ((ps[myconnectindex].gm&MODE_MENU) == MODE_MENU && current_menu != 203 && current_menu != 230 && current_menu != 500 && current_menu != 501)
     {
         if (ud.screen_size != 0)
         {
             if (current_menu != 1234)
             {
                 ud.screen_size = 0;
                 vscrn();
             }
     ...
     {
		 if (p->got_access && ud.multimode < 2)
		 {
             short x1=11, y1=198;

             if (p->got_access&4)
                 rotatesprite(sbarx(x1),sbary(y1-27),sbarsc(12000L),0,60,0,23,10+16+128,0,0,xdim-1,ydim-1);  // yel
			 if (p->got_access&2)
			     rotatesprite(sbarx(x1),sbary(y1-24),sbarsc(12000L),0,60,0,21,10+16+128,0,0,xdim-1,ydim-1);  // red
			 if (p->got_access&1)
			     rotatesprite(sbarx(x1),sbary(y1-21),sbarsc(12000L),0,60,0,0,10+16+128,0,0,xdim-1,ydim-1);   // blue
		  }

          UpdateMiniBarWeapons(p, p->curr_weapon);

		  rotatesprite(sbarx(6),sbary(200-17),sbarsc(68000L),0,2460,20,12,10+16,0,0,xdim-1,ydim-1); // medkit

		  if (sprite[p->i].pal == 1 && p->last_extra < 2)
			  digitalnumber(15,200-14,1,-16,10+16);
		  else
		      digitalnumber(15,200-14,p->last_extra,-16,10+16);

         rotatesprite(sbarx(33),sbary(200-16),sbarsc(29000L),0,54,15,16,10+16,0,0,xdim-1,ydim-1); // armor box wxkk
         digitalnumber(39,200-14,p->shield_amount,-16,10+16+128);

          switch(p->curr_weapon)
          {
              case PISTOL_WEAPON:      ammopic = 40; x = 48; y = 16; iscale = 13500; break;
              case SHOTGUN_WEAPON:     ammopic = 49; x = 42; y = 16; iscale = 24000; break;
              case CHAINGUN_WEAPON:    ammopic = 41; x = 38; y = 19; iscale = 24000; break;
              case RPG_WEAPON:         ammopic = 44; x = 41; y = 15; iscale = 15000; break;

              case HANDBOMB_WEAPON:    ammopic = 47; x = 41; y = 14; iscale = 16500; break;
              case HANDREMOTE_WEAPON:  ammopic = 47; x = 41; y = 14; iscale = 16500; break;

              case SHRINKER_WEAPON:    ammopic = 46; x = 40; y = 14; iscale = 30000; break;
              case GROW_WEAPON:        ammopic = 45; x = 42; y = 16; iscale = 26000; break;

              case DEVISTATOR_WEAPON:  ammopic = 42; x = 41; y = 15; iscale = 26000; break;
              case TRIPBOMB_WEAPON:    ammopic = 27; x = 44; y = 12; iscale = 26000; break;
              case FREEZE_WEAPON:      ammopic = 38; x = 43; y = 14; iscale = 26000; break;

              case KNEE_WEAPON:      ammopic = 2452; x = 45; y = 17; iscale = 30000; break;
          }

	      rotatesprite(sbarx(x+16),sbary(200-y),sbarsc(iscale),0,ammopic,15,16,10+16,0,0,xdim-1,ydim-1); // ammo

		  if (p->curr_weapon == HANDREMOTE_WEAPON)
		      i = HANDBOMB_WEAPON;
		  else
		      i = p->curr_weapon;
		  digitalnumber(66,200-14,p->ammo_amount[i],-16,10+16);
		  ...
		  if (p->inven_icon)
		  {
				switch(p->inven_icon)
                {
					 case 1: i = FIRSTAID_ICON; x = 5;  y = 13; break;
					 case 2: i = STEROIDS_ICON; x = 9;  y = 13; break;
					 case 3: i = HOLODUKE_ICON; x = 11; y = 15; break;
					 case 4: i = JETPACK_ICON;  x = 7;  y = 14; break;
					 case 5: i = HEAT_ICON;     x = 5;  y = 13; break;
					 case 6: i = AIRTANK_ICON;  x = 3;  y = 15; break;
					 case 7: i = BOOT_ICON;     x = 3;  y = 14; break;
					 default: i = -1;
				}
				if (i >= 0)
				    rotatesprite(sbarx(236-o+x),sbary(200-y),sbarsc(42000L),0,i,0,0,10+16+permbit,0,0,xdim-1,ydim-1);

				smalltext(296-30-o,192,"%",6,10+16+permbit + 256);
				...
				switch(p->inven_icon)
				{
					 ...
					 case 3: i = ((p->holoduke_amount+15)/24);
					         j = p->holoduke_on;
					         if (j == 0)
					             j = 1;
					         break;
				...
				invennum(288-30-o,200-5,(char)i,0,10+permbit);
				if (j > 0)
				    smalltext(292-32-o,185,"ON",10,10+16+permbit + 256);
				else
				if ((unsigned long)j != 0x80000000)
				    smalltext(288-30-o,185,"OFF",2,10+16+permbit + 256);
				if (p->inven_icon >= 6)
				    smalltext(288-34-o,185,"AUTO",2,10+16+permbit + 256);
		  }
		  return;
	 }
...
#define SBY (200-tilesizy[BOTTOMSTATUSBAR])
	 ...
	 else
	 {
		  if (u&16384)
		  {
				...
				if (p->got_access&4) rotatesprite(sbarx(276),sbary(SBY+16),sbarsc(65536L),0,ACCESS_ICON,0,23,10+16+128,0,0,xdim-1,ydim-1);
				if (p->got_access&2) rotatesprite(sbarx(289),sbary(SBY+16),sbarsc(65536L),0,ACCESS_ICON,0,21,10+16+128,0,0,xdim-1,ydim-1);
				if (p->got_access&1) rotatesprite(sbarx(282),sbary(SBY+23),sbarsc(65536L),0,ACCESS_ICON,0,0,10+16+128,0,0,xdim-1,ydim-1);
		  }
	 }
	 if (u&(4+8+16+32+64+128+256+512+65536L))
	     weapon_amounts(p,96,SBY+16,u);
	 ...
	 if (u&1024)
	 {
		  ...
		  if (p->curr_weapon != KNEE_WEAPON)
		  {
				if (p->curr_weapon == HANDREMOTE_WEAPON)
				    ...
				    i = p->curr_weapon;
				if (ss == 4)
				    digitalnumber(230-18,200-17,p->ammo_amount[i],-16,10+16+128);
				else
...
void tics(void)
{
    ...
    {                      //TICRATE
        sprintf(b,"Fps=%ld",(120*AVERAGEFRAMES)/(i-frameval[framecnt]));
        minitext(1,1,b,2,2+8+16+128);
        frameval[framecnt] = i;
    }
...
void operatefta(void)
{
	 ...
	 if (NAMGAME && ps[screenpeek].ftq == 99)
	     gametext(320>>1,k,"Matt Saettler.  matts@saettler.com",0,2+8+16+1);
     else
	 if (j > 2)
...
#ifdef _WIN32
    if (i == 0)
        ShellExecute(NULL, "Open", "Duke3dw.exe", "-setup", NULL, SW_SHOWNORMAL);
#endif
...
void displayrest(long smoothratio)
{
        ...
        if( ud.overhead_on > 0 )
        {
                ...
                if(ud.overhead_on == 2)
                {
                    ...
                    if (ud.screen_size == 4)
                        ...
                        a = 185;
                    if (boardfilename[0] != 0 && ud.volume_number == 0 && ud.level_number == 7)
                    {
                        getboardmapname(boardfilename);
                        minitext(3,a+5,boardmapname,0,2+8+16);
                    }
                    else
                    {
                        minitext(5,a+5,volume_names[ud.volume_number],0,2+8+16);
                        minitext(5,a+12,level_names[ud.volume_number*11 + ud.level_number],0,2+8+16);
                    }
                }
        }
    }
    ...
    {
        getboardmapname(boardfilename);
        menutext(160,90,0,0," GAME PAUSED");
        menutext(160,110,0,0,boardmapname);
    }
	...
	sprintf(tempbuf,"Time: %ld:%02ld", (ps[myconnectindex].player_par/(26*60)), (ps[myconnectindex].player_par/26)%60);
	minitext(1,134,tempbuf,0,26);

    if (ud.player_skill > 3 )
      	sprintf(tempbuf,"Kills: %ld",ps[myconnectindex].actors_killed);
    else
        sprintf(tempbuf,"Kills: %ld/%ld",ps[myconnectindex].actors_killed, ps[myconnectindex].max_actors_killed>ps[myconnectindex].actors_killed?
				ps[myconnectindex].max_actors_killed:ps[myconnectindex].actors_killed);
	minitext(1,142,tempbuf,0,26);

	sprintf(tempbuf,"Secrets: %ld/%ld", ps[myconnectindex].secret_rooms,ps[myconnectindex].max_secret_rooms);
	minitext(1,150,tempbuf,0,26);
    }
    if (tintf > 0 || dotint)
        palto(tintr,tintg,tintb,tintf|128);
}
...
void drawbackground(void)
{
	...
	else
	{
		...
		//rotatesprite(0,0,65536L,0,LOADSCREEN,0,0,2+8+16+64,0,0,xdim-1,ydim-1);
		//rotatesprite(0,0,65536L,0,MENUSCREEN,16,0,2+8+16+64,0,0,xdim-1,ydim-1);
		rotatesprite(0,0,65536L,0,BONUSSCREEN,0,0,2+8+16+64,0,0,xdim-1,ydim-1);
		return;
	}
...
void displayrooms(short snum,long smoothratio)
{
    ...
    else
    {
		...
		if (xres <= 320 && yres <= 240) {	// JBF 20030807: Increased tilted-screen quality
          ...
          if (getrendermode() > 0 /*&& (p->rotscrnang || p->orotscrnang)*/)
          {
...
void cheats(void)
{
    ...
    short gAmmo[10] = {0,20,12,20,5,6,5,10,3,10};
...
if (VOLUMEONE) {
                    ...
                    case 23:
                        ...
                        return;
                    case 24:
                        k = ps[myconnectindex].got_access;
                        ps[myconnectindex].got_access =  k ^ 1;      // blukey
                        KB_FlushKeyBoardQueue();
                        ps[myconnectindex].cheat_phase = 0;
                        strcpy(fta_quotes[122],"YOU GOT THE BLUE KEY");
                        FTA(122,&ps[myconnectindex]);
                        return;
                    case 25:
                        k = ps[myconnectindex].got_access;
                        ps[myconnectindex].got_access =  k ^ 2;      // redkey
                        KB_FlushKeyBoardQueue();
                        ps[myconnectindex].cheat_phase = 0;
                        strcpy(fta_quotes[122],"YOU GOT THE RED KEY");
                        FTA(122,&ps[myconnectindex]);
                        return;
                    case 26:
                        k = ps[myconnectindex].got_access;
                        ps[myconnectindex].got_access =  k ^ 4;      // yelkey
                        KB_FlushKeyBoardQueue();
                        ps[myconnectindex].cheat_phase = 0;
                        strcpy(fta_quotes[122],"YOU GOT THE YELLOW KEY");
                        FTA(122,&ps[myconnectindex]);
                        return;
                    case 27:
                        debug_on = 1-debug_on;
			  ...
			  if (!consolecheat) {		// JBF 20030914
			    ...
			    ud.m_volume_number = ud.volume_number = osdcmd_cheatsinfo_stat.volume;
                    ...
                    case 13:
                        ...
                        KB_FlushKeyBoardQueue();
                        return;
                    case 28:                                         // gun2 to gun0
                        j = cheatbuf[3] - '0';
                        if (j == 0)
                            j = 10;
                        j--;
                        addammo(j, &ps[myconnectindex], gAmmo[j]);
                        ps[myconnectindex].gotweapon[j] = 1;
                        KB_FlushKeyBoardQueue();
                        ps[myconnectindex].cheat_phase = 0;
                        sprintf(tempbuf,"YOU GOT WEAPON %d", j+1);
                        strcpy(fta_quotes[122],tempbuf);
                        FTA(122,&ps[myconnectindex]);
                        return;
                    case 29:                                         // fly - jetpack
                        iJet++;
                        if (iJet <= 25)
                           {
                           ps[myconnectindex].jetpack_amount = 400 / iJet;
                           sprintf(tempbuf,"YOU GOT %d %s JETPACK", 25 / iJet, "%");
                           strcpy(fta_quotes[122],tempbuf);
                           FTA(122,&ps[myconnectindex]);
                           ps[myconnectindex].cheat_phase = 0;
                           }
                    ...
                    case 30:                                         // medic
                        ...
                        if (iMedic <= 25)
                           {
                           ps[myconnectindex].firstaid_amount = 25 / iMedic;
                           sprintf(tempbuf,"YOU GOT %d %s HEALTH", 25 / iMedic, "%");
                           strcpy(fta_quotes[122],tempbuf);
                           FTA(122,&ps[myconnectindex]);
                           ps[myconnectindex].cheat_phase = 0;
                           }
                    ...
                    case 31:                                         // swim
                        ...
                        if (iTank <= 25)
                           {
                           ps[myconnectindex].scuba_amount = 1600 / iTank;
                           sprintf(tempbuf,"YOU GOT %d %s OXYGEN", 25 / iTank, "%");
                           strcpy(fta_quotes[122],tempbuf);
                           FTA(122,&ps[myconnectindex]);
                           ps[myconnectindex].cheat_phase = 0;
                           }
                        ...
                        for (i=numsectors-1; i>=0; i--)
                            ...
                            if (j >= 20)
                               ...
                               if ((j & 0x7fff) > 2)
                                  ...
                                  if (j&(0xffff-16384))
                                     {
                                     initprintf("DNOPEN Sectornum: %d | Hitag = %d | Lotag = %d \n", i, k, j);
                                     operatesectors(i,ps[myconnectindex].i);
                                     }
                                  }
                               }
...
//                        operateforcefields(ps[myconnectindex].i,-1);
    ...
    {
        if ( KB_KeyPressed(sc_D) || KB_KeyPressed(sc_X))
        {
...
void nonsharedkeys(void)
{
    ...
    if (KB_KeyPressed(sc_F12) && !SHIFTS_IS_PRESSED)
    {
		char *tpl;
		if (NAMGAME) tpl = "nam00000.pcx";
    ...
    if(!ALT_IS_PRESSED && !SHIFTS_IS_PRESSED)
    {
        ...
        if( KB_KeyPressed(sc_F1) || ( ud.show_help && ( KB_KeyPressed(sc_Space) || KB_KeyPressed(sc_Enter) || KB_KeyPressed(sc_kpad_Enter))))
        {
            ...
            if ((numplayers > 1 && playerswhenstarted > 1 && ud.coop != 1) || bFake )
            {
                clearsoundlocks();
                cmenu(1234);
                ps[myconnectindex].gm |= MODE_MENU;
...
//                setview(0,0,xdim-1,ydim-1);
        ...
        if (KB_KeyPressed(sc_F5) && (numplayers > 1 || bFake))
           {
        ...
        if (KB_KeyPressed(sc_F5) && numplayers < 2)
           {
            KB_ClearKeyDown(sc_F5);
            AutoSaveGame(1);
           }
...
*/
        ...
        if (KB_KeyPressed( sc_F9 ) && (ps[myconnectindex].gm&MODE_GAME) )
        {
            ...
            if (lastsavedpos >= 0 || (ud.autosave > 0 && ud.autodone == 1 && numplayers < 2))
                cmenu(15001);
            else
                cmenu(25000);
            FX_StopAllSounds();
...
{
	Showhelp(1);
	char *s = "See the Duke3dw.log file for details.";
...
void checkcommandline(int argc,char **argv)
{
    ...
    ud.warp_on = 0;
    ud.cashman = 0;
    ud.m_player_skill = ud.player_skill = 3;
    ud.wchoice[0][0] = 3;
    ud.wchoice[0][1] = 4;
    ud.wchoice[0][2] = 5;
    ud.wchoice[0][3] = 7;
        ...
        while(i < argc)
        {
			...
			if (((*c == '/') || (*c == '-')) && (!firstnet))
            {
				if (!Bstrcasecmp(c+1,"net"))
				{
            	    ...
            	    i++;
            	    if (!Bstrcasecmp(c+5,"/n1") || !Bstrcasecmp(c+5,"-n1"))
               	        bHost = 1;
                	continue;
				}
				...
				if (!Bstrcasecmp(c+1,"map"))
				{
					if (argc > i+1)
					{
				        ...
				        {
						    addsearchpath("Maps");
                            checkforsaves(CommandMap);               // 100303
						}
						i++;
					}
					i++;
				...
				if (!Bstrcasecmp(c+1,"nohrp"))                       // 100214
				{
					NoHrp = 1;
					i++;
					continue;
                ...
                if (!Bstrcasecmp(c+1,"game_dir"))
                {
                    if (argc > i+1)
                    {
                        strcpy(tempbuf,argv[i+1]);
                        checksearchpath(tempbuf, 4);
                        i++;
                    }
                    i++;
                    continue;
                }
                if (!Bstrcasecmp(c+1,"music"))
                {
                    if (argc > i+1)
                    {
                        strcpy(tempbuf,argv[i+1]);
                        checksearchpath(tempbuf, 5);
                        i++;
                    }
                    i++;
                    continue;
                }
                if (Bstrncasecmp(c+1, "col", 3) == 0)
                {
                    int tmp;
			...
			if ((*c == '/') || (*c == '-'))
            {
                ...
                switch(*c)
                {
                    ...
                    case 'C':
                        ...
                        {
                            case 0:
                                initprintf("Dukematch (spawn) - %d\n", ud.m_coop);
                                break;
                            case 1:
                                initprintf("Cooperative play - %d\n", ud.m_coop);
                                break;
                            case 2:
                                initprintf("Dukematch (no spawn) - %d\n", ud.m_coop);
                                break;
                        }
                    ...
                    case 'G':
                        ...
                        if (!*c) break;
                           strcpy(tempbuf,c);
                           bGrp = TRUE;
                           checksearchpath(tempbuf, 0);
                           checkforsaves(tempbuf);                   // 100303
						   {
						    struct strllist *s;
                    ...
                    case 'T':
                        ...
                        ud.m_respawn_inventory = ud.m_respawn_items;
                    ...
                    case 'X':
                        ...
                        if (*c)
                        {
							strcpy(Userconfilename,c); //confilename = c;
							checksearchpath(Userconfilename, 1);
                        }
                        break;
                    ...
                    case '10':
                        ...
                        if (CommandMap)
                        {
                           if (c[1] == '0')                          // Duke3dw.exe -map Escape4.map /s3 -10
                           {
                               CommandMap[strlen(CommandMap)-4] = 0;
                               strcpy(svgame, "Saves/map-");
                               strcat(svgame, CommandMap);
                               strcat(svgame, "-");
                               ud.warp_on = 12;
                               i++;
                           }
...
void Startup(void)
{
	...
	if (CommandMusicToggleOff)
	    MusicToggle = 0;
	if (CommandName)
	    strcpy(PlayerNameArg,CommandName);
	...
	if (CommandMap)
	{
	   ...
	   else
	   {
           ...
           {
              i = strlen(CommandMap);
              strncpy(tempbuf, CommandMap, i-4);
              tempbuf[i-4] = 0;
              strcat(tempbuf, ".mid");
              if ((fil = kopen4load(tempbuf,0)) >= 0)
                  strcpy(MapMusic, tempbuf);
              else
              {
                  tempbuf[i-4] = 0;
                  strcat(tempbuf, ".ogg");
              ...
              kclose(fil);
              if (MapMusic[0] != 0)
                  strcpy(MusicName, MapMusic);
           }

           if (SelectMulti == 1 && MenuMap[0] != 0)
           {
	           ud.m_level_number = 7;
               ud.m_volume_number = 0;
	       }
...
int app_main(int argc,char **argv)
{
	...
	{
		if (argc > 1 && Bstrcasecmp(argv[1]+1, "setup") != 0)
		{
	...
	OSD_SetLogFile("Duke3dw.log");                                  // moved here for initprintf's wxtc
    MapMusic[0] = 0;
    ud.multimode = 1;
    ...
    DetectShareware();
    if (shareware == 1)
        initprintf("\nDuke Nukem 3D (Shareware) - (c) 1996 3D Realms Entertainment\n");
    else
        initprintf("\nDuke Nukem 3D - (c) 1996 3D Realms Entertainment\n");

    svgame[0] = 0;
    strcpy(CLine, HEAD2W);
    wm_setapptitle(CLine);
    ...
    addsearchpath("Autoload");
    addsearchpath("Games");

    initprintf("Adding %s  group file.\n", duke3dgrp);

    i = initgroupfile("MAPHACKS.ZIP");
    if (i >= 0)
        initprintf("Adding Duke3d Maphacks\n");

    i = initgroupfile("Duke3d_hrp.zip");
    if (i >= 0)
        initprintf("Adding Duke3d High Resolution Zip Pack\n");
    else
    {
        i = initgroupfile("Duke3d_lrp.zip");
        if (i >= 0)
        {
            initprintf("Adding Duke3d Low Resolution Zip Pack\n");
            iLowres = 1;
        }
    }

    j = initgroupfile("Hrp_update.zip");
    if (j >= 0)
        initprintf("Adding Duke3d High Resolution Pack Update\n");
    else
    {
       j = initgroupfile("Duke3d_hrp_update.zip");
       if (j >= 0)
           initprintf("Adding Duke3d High Resolution Pack Update\n");
    }

    DnwGrp = 0;
    k = initgroupfile("Duke3dw.grp");
    if (k >= 0)
    {
       DnwGrp = 1;
       initprintf("Adding Duke3dw.grp group file.\n");
    }
    else
       ud.weaponicons = 0;
    ...
    if (argc > 1)
    {
       strcpy(CLine, _buildargv[0]);
       for (i=1; i<argc; i++)
       {
           strcat(CLine, " ");
           strcat(CLine, _buildargv[i]);
       }
    ...
    if (CommandMap)
    {
       checksearchpath(CommandMap, 3);
       checkforextras(CommandMap);
       initprintf("Starting Map: %s\n", Mapname);
       if (SelectMulti == 1 && MenuMap[0] != 0)
       {
           RemoveMapInfo(argc);
           argc = _buildargc;
...

    {
		...
		while (CommandGrps)
	    {
            ...
            if ( j == -1)
            {
               if (!Bstrcasecmp(CommandGrps->str, "_hrp.zip"))
                   initprintf("Warning: could not find group file %s \n", CommandGrps->str);
            }
            else
            {
               groupfile = j;
               initprintf("Adding Custom Grp: %s\n", CommandGrps->str);
               checkforextras(CommandGrps->str);
            }
	...
	if (netparamcount > 0)
	    _buildargc = (argc -= netparamcount+1);	// crop off the net parameters
    ...
    if (!getdeffile("duke3d.def", 1))                     // check root folder
        initprintf("Adding Duke3d.def definitions file.\n");
    else
    if (!getdeffile("highres\\duke3d_hrp.def",1))        // check if in folder
        initprintf("Adding Duke3d_hrp definitions file.\n");
    else
    if (!getdeffile("lowres\\duke3d_lrp.def",1))         // check if in folder
        initprintf("Adding Duke3d_lrp definitions file.\n");

    if (!getdeffile("duke3dw.def",1))
        initprintf("Adding Duke3dw.def definitions file.\n\n");
    ...
    if (!getdeffile(userdef,0))
        initprintf("Adding %s definitions file.\n", userdef);

    // gotta set the proper title after we compile the CONs if this is the full version
    if (!NAMGAME && VOLUMEALL)
    {
	if (PLUTOPAK)
    ...
    if (numplayers > 2 && ud.multimode > 1)
        ud.warp_on = 0;      // start map/volume/level in menu
    ...
    if (ud.multimode < 2)
    {
       if (ud.warp_on > 1)
       {
          ...
          nextpage();
          initprintf("Loading saved game: %d\n", ud.warp_on-2);
          if (loadplayer(ud.warp_on-2))
              ud.warp_on = 0;
       }

       if (ud.autosave > 0 && numplayers < 2)
       {
          char fn[40];
          ...
          if (ud.autosave == 1 && ud.autodone == 0)
              AutoSaveGame(0);
       }
    }
...
MAIN_LOOP_RESTART:
    ...
    if (ud.warp_on == 0) // includes multi with/without map
    {
        Logo();
        if (ud.multimode > 1 )
        {
    ...
    {
        if (numplayers > 1)
            waitforeverybody(4);           // 4b

        newgame(ud.m_volume_number,ud.m_level_number,ud.m_player_skill);  // 0, 7 = usermap
        if (enterlevel(MODE_GAME))
        {
            backtomenu();
        }
    ...
    if (ud.color)
    {
        sprite[ps[myconnectindex].i].pal = ps[myconnectindex].palookup = p_color[myconnectindex] = ud.color;
        SendPlayerInfo();
    }
    ud.warp_on = 0;
    ...
    while (!(ps[myconnectindex].gm&MODE_END)) //The whole loop!!!!!!!!!!!!!!!!!!
    {
        ...
        if (ud.multimode < 2 && ud.autosave > 0)
           ...
           if (ud.volume_number == 0 && ud.level_number == 7)
              ...
              {
              if (ud.autosave == 1 && ud.autodone == 0)   // start of episode level
                  AutoSaveGame(0);
              }
           }
...
long playback(void)
{
    ...
    while (ud.reccnt > 0 || foundemo == 0)
    {
        ...
        if (KB_KeyPressed(sc_Escape) && current_menu == 0)
        {
            KB_ClearKeyDown(sc_Escape);
            FX_StopAllSounds();
            clearsoundlocks();
    ...
    for (i=connecthead; i>=0; i=connectpoint2[i])
     {
          ...
          if (j < 0 && networkmode == 0)
              gameexit( "The Host Server just quit the game.\nAll players are returned from the game.");
      }
...
void dobonus(char bonusonly)
{
    ...
    sprintf(tempbuf, "%sgamex.asv", svgame);
    if (numplayers < 2)
        DeleteAutosave(1, tempbuf);
    else
        DeleteAutosave(0, tempbuf);
    ud.autodone = 0;
    ...
    if (playerswhenstarted > 1 && ud.coop != 1 )
    {
        ...
        if (boardmapname[0] != 0)
            gametext(160,58+10,boardmapname,0,2+8+16);
        else
        ...
        for (i=0;i<playerswhenstarted;i++)
        {
            ...
            minitext(94+(8*23),90+t,tempbuf,2,2+8+16+128);
    ...
    while( 1 )
    {
        ...
        if (ps[myconnectindex].gm&MODE_EOL)
        {
		    ...
		    if (!NAMGAME) { gametext(10,yy+9,"3D Realms' Time:",0,2+8+16); yy+=10; }
    ...
    if (numplayers < 2 && boardfilename[0] != 0 && ud.volume_number == 0 && ud.level_number == 8)
    {
        getboardmapname(boardfilename);
        SetMapPlayed(boardmapname);
    }
