...
// Added useprecache, weaponicons
// Added autosave
// Added for MapMusic
// Changed myname to playernamearg
// Added boardmapname for display
// Added bFake
// Added sbak
// Added m_color, color, p_color
// Added weaponhide
...
extern void getboardmapname(char *sMap);                             // wxmp
extern void AutoSaveGame(short disp);                                // wxas

extern char PlayerNameArg[32];                                       // wxmp
extern char boardmapname[80];                                        // wxbm
extern char *svgame[40];                                             // wxvg

extern int32 bFake;                                                  // wxfp
extern int sbak;                                                     // wxsb
...
struct user_defs
{
    ...
    int32 useprecache,weaponicons;                                   // wxpc
    int32 autosave,autodone;                                         // wxas

    char  autobuff[1][22];                                           // wxas
    int32 m_color,color;                                             // wxdm
    int32 weaponhide;                                                // wxwh
};

char p_color[32];                                                    // wxdm
