                 ...
                 int left, int right, int priority, unsigned int callbackval )
{
   ...
   if (!memcmp("Creative Voice File\x1a", ptr, 20)) {
      ...
      handle = MV_PlayMIDI(ptr, length, pitchoffset, vol, left, right, priority, callbackval);
   #endif	
   #ifdef HAVE_VORBIS
                       ...
                       unsigned int callbackval )
{
   ...
   if (!memcmp("Creative Voice File\x1a", ptr, 20)) {
      ...
      handle = MV_PlayLoopedMIDI(ptr, length, loopstart, loopend, pitchoffset,
                              vol, left, right, priority, callbackval);
   #endif
   #ifdef HAVE_VORBIS
   } else if (!memcmp("OggS", ptr, 4)) {
                   ...
                   int distance, int priority, unsigned int callbackval )
{
   ...
   if (!memcmp("Creative Voice File\x1a", ptr, 20)) {
      ...
      handle = MV_PlayMIDI3D(ptr, length, pitchoffset, angle, distance, priority, callbackval);
   #endif
   #ifdef HAVE_VORBIS
   } else if (!memcmp("OggS", ptr, 4)) {
