...
//
char cachedebug = 0;
char faketile[MAXTILES];                                             // wxdf
int h_xsize[MAXTILES], h_ysize[MAXTILES];                            // wxer
signed char h_xoffs[MAXTILES], h_yoffs[MAXTILES];                    // wxer
...
// squarerotatetile
//
// TX workaround for mingw 4.4.x                                     // wxtx
#ifdef __GNUC__
