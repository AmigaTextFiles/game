...
// Added eduke defs.c for hrp compatibility
// Added reject the hrp_update ice.def file
...
// Temp as not in Duke3dw atm
extern long pow2long[32];
extern char picsiz[MAXTILES];

#define RESERVEDPALS 2
...
enum
{
    ...
    T_SETUPTILE,T_SETUPTILERANGE,                                    // wxer
    T_ANIMTILERANGE,                                                 // wxer
    T_CACHESIZE,
    T_MUSIC,T_ID,T_SOUND,                                            // wxer
    T_REDPAL,T_BLUEPAL,T_BROWNPAL,T_GREYPAL,T_GREENPAL,T_SPECPAL,    // wxer
    T_WIDE                                                           // wxwi
};
...
static tokenlist basetokens[] =
{
    ...
    { "setuptile",       T_SETUPTILE        },                       // wxer
    { "setuptilerange",  T_SETUPTILERANGE   },                       // wxer
    { "animtilerange",   T_ANIMTILERANGE    },                       // wxer
...
static tokenlist modeltokens[] =
{
    ...
    { "glow",   T_GLOW   },
    { "detail", T_DETAIL },
    { "redmap",  T_REDPAL  },                                        // wxer
    { "bluepal", T_BLUEPAL },                                        // wxer
    { "brownpal",T_BROWNPAL},                                        // wxer
    { "greypal", T_GREYPAL },                                        // wxer
    { "greenpal",T_GREENPAL},                                        // wxer
    { "specpal", T_SPECPAL },                                        // wxer
    { "hud",    T_HUD    },
    { "flags",   T_FLAGS   },                                        // wxer
};
...
static tokenlist texturetokens_pal[] =
{
    ...
    { "nodownsize",   T_NODOWNSIZE },                                // wxer
    { "wide",         T_WIDE },                                      // wxwi
};

static tokenlist sound_musictokens[] =                               // wxer
{
    { "id",   T_ID  },
    { "file", T_FILE },
};
    ...
    while (1)
    {
        ...
        case T_INCLUDE:
        {
            ...
            if (!scriptfile_getstring(script,&fn))
            {
                ...
                if (strstr(fn, "ice.def"))   // reject the ice.def file - wxic
                    break;
...
//            if ((unsigned long)tile < MAXTILES) { spritecol2d[tile][0] = col; spritecol2d[tile][1] = col2; }
        }
        break;
        case T_2DCOL:
        {
        ...
        case T_TEXTURE:
        {
            ...
            while (script->textptr < textureend)
            {
                ...
                case T_DETAIL: case T_GLOW: {
                    ...
                    hicsetsubsttex(tile,pal,fn,-1.0,flags);
                } break;
                default:
                    break;
                }
