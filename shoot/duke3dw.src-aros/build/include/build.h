...
#endif
#ifdef POLYMOST
extern long usemodels, usehightile, usegoodalpha;                    // wxga
#endif
EXTERN int h_xsize[MAXTILES], h_ysize[MAXTILES];                     // wxer
EXTERN signed char h_xoffs[MAXTILES], h_yoffs[MAXTILES];             // wxer
...
extern long glwidescreen, glprojectionhacks, glfovscreen;            // wxws
