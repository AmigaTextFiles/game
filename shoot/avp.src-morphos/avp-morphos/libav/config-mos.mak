...
LIBAV_CONFIGURATION=--enable-gpl --disable-runtime-cpudetect --disable-programs --disable-doc --disable-pthreads --disable-network --cc=ppc-morphos-gcc-4 --host-cc=ppc-morphos-gcc-4 --ld=ppc-morphos-ld --disable-altivec
prefix=out-mos
...
SRC_PATH=.
CC_IDENT=gcc 4.4.5 (GCC/MorphOS)
ARCH=ppc
CC=ppc-morphos-gcc-4
AS=ppc-morphos-gcc-4
LD=ppc-morphos-ld
DEPCC=ppc-morphos-gcc-4
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=ppc-morphos-gcc-4
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar
...
RANLIB=ranlib
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -noixemul
...
HOSTCC=ppc-morphos-gcc-4
HOSTLD=ppc-morphos-gcc-4
HOSTCFLAGS=-O3 -g  -std=c99 -Wall
HOSTCPPFLAGS=-D_ISOC99_SOURCE -D_XOPEN_SOURCE=600
HOSTEXESUF=
HOSTLDFLAGS= 
HOSTLIBS=-lm
DEPHOSTCC=ppc-morphos-gcc-4
