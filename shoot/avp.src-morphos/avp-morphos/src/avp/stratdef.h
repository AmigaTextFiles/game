...
typedef enum bhvr_type
{
	...
	I_BehaviourProximityDoor,		//12
	I_BehaviourLiftDoor,			//13
	I_BehaviourSwitchDoor,			//14
	I_BehaviourSimpleAnimation,		//15
	I_BehaviourBinarySwitch,		//16
	I_BehaviourLift,				//17
	I_BehaviourPlatform,			//18
	I_BehaviourAutoGun,
	I_BehaviourAutoGunMuzzleFlash,	//20
...
// added by john for link switches
    ...
    I_BehaviourXenoborgMorphRoom,	//50

	I_BehaviourLightFX,
	I_BehaviourPlacedSound,			//52
	I_BehaviourMissionComplete,		//53
	I_BehaviourTrackObject,			//54
	I_BehaviourFan,					
	I_BehaviourMessage,				//56
	I_BehaviourNetCorpse,

	I_BehaviourRubberDuck,
	I_BehaviourPlacedHierarchy,
	I_BehaviourPlacedLight,			//60
	...
	I_BehaviourVideoScreen,			//68

	I_BehaviourFrisbee,
	I_BehaviourFrisbeeEnergyBolt,	//70
