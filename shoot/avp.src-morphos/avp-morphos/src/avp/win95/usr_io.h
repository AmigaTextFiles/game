...
/* Global Variables */
	...
	*/
	...
	extern void ByteSwap_PLAYER_INPUT_CONFIGURATION(PLAYER_INPUT_CONFIGURATION* p);
	extern void ByteSwap_CONTROL_METHODS(CONTROL_METHODS* p);
	extern void ByteSwap_JOYSTICK_CONTROL_METHODS(JOYSTICK_CONTROL_METHODS* p);
