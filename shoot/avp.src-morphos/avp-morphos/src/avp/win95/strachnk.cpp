...
{
chunk_implement("AVP_Strategy_Chunk::fill_data_block");
/*
...
//printf("EXTERNAL strategy chunk: %d (0x%08x, 0x%08x)\n\0", type, ObjID.id1, ObjID.id2);	
...
{
chunk_implement("AVP_External_Strategy_Chunk::fill_data_block");
/*
	strncpy (data_start, identifier, 8);
...
{
chunk_implement("Virtual_Object_Properties_Chunk::fill_data_block");
/*
	strncpy (data_start, identifier, 8);
	data_start += 8;
	*((int *) data_start) = chunk_size;
...
{
chunk_implement("AvpStrat::fill_data_block");
/*
...
{
chunk_implement("MiscStrategy::fill_data_block");
/*
...
{
chunk_implement("SimpleStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("R6SimpleStrategy::fill_data_block");
/*
...
:AvpStrat(data_start)
{
	...
	AssocCallSwitch.ByteSwap();
	data_start+=8;
	
	AssocFloorSwitch=*(ObjectID*)data_start;
	AssocFloorSwitch.ByteSwap();
	data_start+=8;
...
{
chunk_implement("LiftStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("PlatLiftStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
	*(int*)data=flags;
...
{
chunk_implement("DoorStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
	*(int*)data=DoorFlags;		
...
{
chunk_implement("SwitchDoorStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
	*(ObjectID*)data=AssocDoor;		
...
{
chunk_implement("BinSwitchStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("LinkSwitchStrategy::fill_data_block");
/*
...
{
chunk_implement("ConsoleStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("LightingStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("MultiSwitchStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
:MultiSwitchStrategy(data_start,size)
{
	...
	trigger_min.ByteSwap();
	data_start+=sizeof(ChunkVectorInt);	
	
	trigger_max=*(ChunkVectorInt*)data_start;
	trigger_max.ByteSwap();
	data_start+=sizeof(ChunkVectorInt);	
...
{
chunk_implement("AreaSwitchStrategy::fill_data_block");
/*
...
{
chunk_implement("TeleportStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
:AvpStrat(data_start)
{
	...
	DeathTarget.ByteSwap();
	data_start+=sizeof(ObjectID);
	
	ExtraMissionData=*(int*)data_start;
	BYTESWAP4(ExtraMissionData);
	data_start+=4;
...
{
chunk_implement("EnemyStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("GeneratorStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
:AvpStrat(data_start)
{
	...
	BYTESWAP4(mission_description_string);
	data_start+=4;
	
	mission_complete_string=*(int*)data_start;
	BYTESWAP4(mission_complete_string);
	data_start+=4;
	
	mission_number=*(int*)data_start;
	BYTESWAP4(mission_number);
	data_start+=4;
	...
	BYTESWAP4(mission_completion_effect);
	data_start+=4;

	num_mission_targets=*(int*)data_start;
	BYTESWAP4(num_mission_targets);
	data_start+=4;
...
{
chunk_implement("MissionObjectiveStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("MissionHintStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("TextMessageStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("TrackStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("TrackDestructStrategy::fill_data_block");
/*
...
{
chunk_implement("HierarchyStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
:AvpStrat(data_start)
{
	...
	BYTESWAP4(speed_up_time);
	data_start+=4;
	
	slow_down_time=*(int*)data_start;
	BYTESWAP4(slow_down_time);
	data_start+=4;

	fan_wind_strength=*(int*)data_start;
	BYTESWAP4(fan_wind_strength);
	data_start+=4;
...
{
chunk_implement("FanStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("DeathVolumeStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("SelfDestructStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("SwingDoorStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("PlacedBombStrategy::fill_data_bloc");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("R6SwitchStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("MummyInanimateStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
:AvpStrat(data)
{
	...
	BYTESWAP4(pickupType);
	
	CHUNK_EXTRACT(inactiveAtStart,BOOL);
	inactiveAtStart = (inactiveAtStart != 0) ? TRUE : FALSE;
...
{
chunk_implement("MummyPickupStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("MummyTriggerVolumeStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("MummyPivotObjectStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
{
chunk_implement("MummyChestStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
...
:AvpStrat(data)
{
	...
	BYTESWAP4(enter_range);
	
	CHUNK_EXTRACT(exit_range,int)	
	BYTESWAP4(exit_range);
...
{
chunk_implement("MummyAlterCameraRangeStrategy::fill_data_block");
/*
	AvpStrat::fill_data_block(data);
	data+=AvpStrat::GetStrategySize();
