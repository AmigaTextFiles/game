	...
	:Chunk(parent,"STRATEGY")
{
	...
	BYTESWAP4(strategy_data.Strategy);
}

void Map_Block_Chunk::fill_data_block (char* data_start)
{
chunk_implement("Map_Block_Chunk::fill_data_block");
/*
...
{
chunk_implement("Strategy_Chunk::fill_data_block");
/*
	strncpy (data_start, identifier, 8);
	data_start += 8;
	*((int *) data_start) = chunk_size;
