...
{
chunk_implement("Object_Hierarchy_Data_Chunk::fill_data_block\n\0");
/*
...
{
chunk_implement("Object_Hierarchy_Name_Chunk::fill_data_block\n\0");
/*
	strncpy (data_start, identifier, 8);
...
{
chunk_implement("Object_Hierarchy_Alternate_Shape_Set_Chunk::fill_data_block\n\0");
/*
	strncpy (data_start, identifier, 8);
...
{
chunk_implement("Hierarchy_Shape_Set_Collection_Chunk::fill_data_block\n\0");
/*
	strncpy (data_start, identifier, 8);
...
{
chunk_implement("Hierarchy_Degradation_Distance_Chunk::fill_data_block\n\0");
/*
	strncpy (data_start, identifier, 8);
...
{
printf("Hierarchy_Degradation_Distance_Chunk::size_chunk\n\0");
...
{
chunk_implement("Hierarchy_Bounding_Box_Chunk::fill_data_block\n\0");
/*
	strncpy (data_start, identifier, 8);
	data_start += 8;
	*((int *) data_start) = chunk_size;
