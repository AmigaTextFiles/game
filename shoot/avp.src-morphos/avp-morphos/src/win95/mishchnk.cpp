...
{
chunk_implement("Lockable_Chunk_With_Children::lock_chunk\n\0");
return TRUE;
...
{
chunk_implement("Lockable_Chunk_With_Children::unlock_chunk\n\0");
return TRUE;
/*
	if (updateyn)	{
		updated = TRUE;
...
{
chunk_implement("Lockable_Chunk_With_Children::update_chunk_in_file\n\0");
return TRUE;
/*
	unsigned long bytes_read;
	int length = 0;
...
// Load in whole chunk and traverse
	...
	{
		int size = *(int*)(buffer_ptr+8);
		BYTESWAP4(size);
		
		if ((size + (buffer_ptr-buffer)) > ((signed)file_size-12)) {
			error_code = CHUNK_FAILED_ON_LOAD_NOT_RECOGNISED;
			break;
		}
...
{
chunk_implement("File_Chunk::write_file\n\0");
return TRUE;
/*
...
{
chunk_implement("File_Chunk::check_file\n\0");
return TRUE;
/*
...
{
chunk_implement("File_Chunk::update_file\n\0");
return TRUE;
/*
	#if DisableLock
...
{
chunk_implement("File_Chunk::update_chunks_from_file\n\0");
return TRUE;
/*
	#if DisableLock
	return(TRUE);
...
: Chunk_With_Children (NULL, "REBINFF2")
{
	...
	{
		int s = *(int*)(buffer_ptr+8);
		BYTESWAP4(s);
		if ((s) + (buffer_ptr-buffer) > ((signed)size-12))
		{
			error_code = CHUNK_FAILED_ON_LOAD_NOT_RECOGNISED;
			break;
		}
...
{
chunk_implement("RIF_Version_Num_Chunk::fill_data_block\n\0");
/*
...
{
chunk_implement("RIF_Name_Chunk::fill_data_block\n\0");
/*
	strncpy (data_start, identifier, 8);
	data_start += 8;
	*((int *) data_start) = chunk_size;
...
: Chunk_With_Children (parent, "SUBRIFFL")
{
	...
	while ((buffer_ptr-buffer)< ((signed) file_size-12) && !error_code)
	{
		int s = *(int*)(buffer_ptr+8);
		BYTESWAP4(s);
		if ((s) + (buffer_ptr-buffer) > ((signed)file_size-12)) {
			error_code = CHUNK_FAILED_ON_LOAD_NOT_RECOGNISED;
			break;
		}
