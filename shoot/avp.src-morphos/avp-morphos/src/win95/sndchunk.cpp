...
{
chunk_implement("Sound_Object_Chunk::fill_data_block\n\0");
/*
...
Sound_Object_Chunk* Sound_Object_Extra_Data_Chunk::get_sound_chunk()
{
	...
	if(!chlist.size())
	{
		printf("Sound_Object_Extra_Data_Chunk::get_sound_chunk - SOUNDNAM not found!\n\0");
		return 0;
	}
	...
	printf("Sound_Object_Extra_Data_Chunk::get_sound_chunk - SOUNDEXD not found!\n\0");
	return 0;
}
...
{
chunk_implement("Sound_Object_Extra_Name_Chunk::fill_data_block\n\0");
/*
	strncpy (data_start, identifier, 8);
	data_start += 8;
	*((int *) data_start) = chunk_size;
...
{
chunk_implement("Indexed_Sound_Chunk::fill_data_block\n\0");
/*
	CHUNK_FILL_START
