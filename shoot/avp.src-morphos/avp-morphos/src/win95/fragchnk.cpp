...
{
chunk_implement("Fragment_Type_Data_Chunk::fill_data_block");
/*
...
{
chunk_implement("Fragment_Type_Shape_Chunk::fill_data_block");
/*
	strncpy (data_start, identifier, 8);
	data_start += 8;
	*((int *) data_start) = chunk_size;
...
{
chunk_implement("Fragment_Type_Sound_Chunk::fill_data_block");
/*
	strncpy (data_start, identifier, 8);
	data_start += 8;
	*((int *) data_start) = chunk_size;
