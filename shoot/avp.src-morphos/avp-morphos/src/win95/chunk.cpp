...
{
chunk_implement("Miscellaneous_Chunk::fill_data_block");
/*
...
{
chunk_implement("Chunk_With_Children::output_chunk");
return TRUE;
/*
	unsigned long junk;
	Chunk * child_ptr = children;
...
{
chunk_implement("Chunk_With_Children::fill_data_block_for_process");
/*
	strncpy (data_start, identifier, 8);
...
{
chunk_implement("Chunk_With_Children::fill_data_block");
/*
	strncpy (data_start, identifier, 8);
...
Chunk* Chunk_With_Children::DynCreate(const char* data)
{
	...
	*/
	...
	int s = *(int*)(data+8);
	BYTESWAP4(s);
	return new Miscellaneous_Chunk(this,data,(data + 12), s-12);
}
