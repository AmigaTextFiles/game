...
//	fprintf(stderr, "AwBackupTexture::ChoosePixelFormat(...)\n");
	...
	else
	{
		...
		pixelFormat.redLeftShift = 24;
		pixelFormat.greenLeftShift = 16;
		pixelFormat.blueLeftShift = 8;
		pixelFormat.redRightShift = 0;
		pixelFormat.greenRightShift = 0;
		pixelFormat.blueRightShift = 0;
		pixelFormat.dwRGBAlphaBitMask = 0x000000FF;
#else
...
#if defined(__BIG_ENDIAN__)
	_pfP->redLeftShift = 24;
	_pfP->greenLeftShift = 16;
	_pfP->blueLeftShift = 8;
	_pfP->redRightShift = 0;
	_pfP->greenRightShift = 0;
	_pfP->blueRightShift = 0;
	_pfP->dwRGBAlphaBitMask = 0x000000FF;
#else
	_pfP->redLeftShift = 0;
