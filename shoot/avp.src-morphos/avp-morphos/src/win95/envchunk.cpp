...
{
chunk_implement("Environment_Data_Header_Chunk::fill_data_block");
/*
...
{
chunk_implement("Environment_Scale_Chunk::fill_data_block");
/*
	strncpy (data_start, identifier, 8);
	data_start += 8;
	*((int *) data_start) = chunk_size;
...
{
chunk_implement("Environment_Acoustics_Chunk::fill_data_block");
/*
	strncpy (data_start, identifier, 8);
	data_start += 8;
	*((int *) data_start) = chunk_size;
...
{
chunk_implement("Sound_Directory_Chunk::fill_data_block");
/*
	strncpy (data_start, identifier, 8);
	data_start += 8;
	*((int *) data_start) = chunk_size;
...
{
chunk_implement("Random_Texture_ID_Chunk::fill_data_block");
/*
	CHUNK_FILL_START
