...
:Chunk(parent,"DUMOBJDT")
{
	...
	location.ByteSwap();
	min_extents.ByteSwap();
	max_extents.ByteSwap();
...
{
chunk_implement("Dummy_Object_Data_Chunk::fill_data_block\n\0");
/*
	CHUNK_FILL_START
...
{
chunk_implement("Dummy_Object_Text_Chunk::fill_data_block\n\0");
/*
	CHUNK_FILL_START
