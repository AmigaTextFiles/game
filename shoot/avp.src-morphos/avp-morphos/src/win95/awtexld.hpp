	...
	struct Colour
	{
		...
		class ConvNonTransp
		{
			public:
				...
				{
					return  ((((static_cast<unsigned>(_colP->r))&0xFF)>>pixelFormat.redRightShift)<<pixelFormat.redLeftShift) |
							((((static_cast<unsigned>(_colP->g))&0xFF)>>pixelFormat.greenRightShift)<<pixelFormat.greenLeftShift) |
							((((static_cast<unsigned>(_colP->b))&0xFF)>>pixelFormat.blueRightShift)<<pixelFormat.blueLeftShift) |
