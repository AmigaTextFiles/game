...
//#define DISABLE_PARTIAL_CLIPPING 
#define FAR_Z_CLIP 0
#define FAR_Z_CLIP_RANGE 49000


#ifdef DISABLE_PARTIAL_CLIPPING
int returnValueForPartialInsidePolys = 2;
#else
int returnValueForPartialInsidePolys = 1;
#endif
...
//		if (Dot(&pop, normalPtr)>0) return 0;
	...
	return returnValueForPartialInsidePolys;
}	
