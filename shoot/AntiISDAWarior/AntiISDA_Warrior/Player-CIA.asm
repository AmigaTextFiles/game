...
_LevelSong
    lea    ahxLevelMod,a0    ;Level Module
    jsr    _StartSong
    rts
...
_ShootLeft
    lea    ahxShootLeft,a0    ;ShootLeft Sound
    jsr    _StartSong
    rts

_ShootRight
    lea    ahxShootRight,a0    ;ShootRight Sound
    jsr    _StartSong
    rts

_BoomLeft
    lea    ahxBoomLeft,a0    ;BoomLeft Sound
    jsr    _StartSong
    rts

_BoomRight
    lea    ahxBoomRight,a0    ;BoomRight Sound
    jsr    _StartSong
    rts
...
ahxLevelMod    IncBIN    Level.AHX
ahxGameOverMod IncBIN    GameOver.AHX
ahxWinMod      IncBIN    Win.AHX
ahxShootLeft   IncBIN    ShootLeft.AHX
ahxShootRight  IncBIN    ShootRight.AHX
ahxBoomLeft    IncBIN    BoomLeft.AHX
ahxBoomRight   IncBIN    BoomRight.AHX
