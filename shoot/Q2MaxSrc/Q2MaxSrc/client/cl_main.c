...
//      cl_minfps = Cvar_Get ("cl_minfps", "5", 0);
	...
	cl_3dcam_angle = Cvar_Get ("cl_3dcam_angle", "0", 0);
	cl_3dcam_dist = Cvar_Get ("cl_3dcam_dist", "50", 0);
	cl_3dcam_alpha = Cvar_Get ("cl_3dcam_alpha", "1", 0);
	cl_3dcam_distmax = Cvar_Get ("cl_3dcam_distmax", "300", 0);
#endif
...
void CL_WriteConfiguration (void)
{
...
#ifdef Q2MAX
  Com_sprintf (path, sizeof(path),"%s/maxconfig.cfg",FS_Gamedir());
#else
  Com_sprintf (path, sizeof(path),"%s/config.cfg",FS_Gamedir());
	...
	{
#ifdef Q2MAX
		Com_Printf ("Couldn't write maxconfig.cfg.\n");
#else
