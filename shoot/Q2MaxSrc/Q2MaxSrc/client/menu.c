...
#ifdef Q2MAX
//interface
static menuslider_s		s_options_conalpha_slider;

//ingame
static menulist_s		s_options_railtrail_box;
static menuslider_s		s_options_railcolor_box[3];
#endif
...
{
	Cvar_SetValue( "cl_railred", s_options_railcolor_box[0].curvalue*16 );
}
static void RailColorGreenFunc( void *unused )
{
	Cvar_SetValue( "cl_railgreen", s_options_railcolor_box[1].curvalue*16 );
}
static void RailColorBlueFunc( void *unused )
{
	Cvar_SetValue( "cl_railblue", s_options_railcolor_box[2].curvalue*16 );
}
#endif
...
{
	Cvar_SetValue( "con_alpha", s_options_conalpha_slider.curvalue / 25.0F );
}
#endif
