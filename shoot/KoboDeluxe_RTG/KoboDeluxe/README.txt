(This document was generated from the kobodl.6 'man' file.)
                             ...
                             of the scrolling video game
                                       XKobo
                        Amiga 68k port by Artur "Arti Jarosik
...
This port notice / Uwagi dotycz±ce tego portu

Triple buffer works only in fullscreen mode on Vampire accelerators/computers.
To enable it, select Double buffer in Video menu options.

PL

Potrójne buforowanie dzia³a tylko na pe³nym ekranie na kartach/komputerach Vampire.
Wybierz Double Buffer w menu Video aby cieszyæ siê dodatkow± prêdko¶ci±. 
