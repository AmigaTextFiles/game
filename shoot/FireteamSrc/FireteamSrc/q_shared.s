...
.Lfe10:
	...
	.lcomm	value.167,1024,1
	.section	".sbss","aw",@nobits
	.align 2
valueindex.168:
	.space	4
	.size	 valueindex.168,4
	.section	".text"
	.align 2
...
Info_ValueForKey:
	...
	stmw 25,532(1)
	stw 0,564(1)
	lis 10,valueindex.168@ha
	mr 31,3
	lwz 0,valueindex.168@l(10)
	addi 11,31,1
	lis 9,value.167@ha
	la 27,value.167@l(9)
	mr 25,4
	xori 0,0,1
	lis 28,valueindex.168@ha
	stw 0,valueindex.168@l(10)
	addi 26,1,8
	li 29,0
	lbz 0,0(31)
	lis 30,.LC9@ha
...
.LC14:
	...
	.align 2
.LC15:
	.string	"Can't use keys or values with a semicolon\n"
	.align 2
.LC16:
	.string	"Can't use keys or values with a \"\n"
	.align 2
...
.L221:
	...
	blr
.Lfe38:
	.size	 Q_strcasecmp,.Lfe38-Q_strcasecmp
	.align 2
	.globl Q_strncasecmp
...
.L205:
	...
	blr
.Lfe39:
	.size	 Q_strncasecmp,.Lfe39-Q_strncasecmp
	.align 2
	.globl BigShort
...
LittleShort:
	...
	blr
.Lfe41:
	.size	 LittleShort,.Lfe41-LittleShort
	.align 2
	.globl BigLong
...
LittleLong:
	...
	blr
.Lfe43:
	.size	 LittleLong,.Lfe43-LittleLong
	.align 2
	.globl BigFloat
...
LittleFloat:
	...
	blr
.Lfe45:
	.size	 LittleFloat,.Lfe45-LittleFloat
	.align 2
	.globl Info_Validate
...
.L292:
	...
	blr
.Lfe46:
	.size	 Info_Validate,.Lfe46-Info_Validate
	.align 2
	.globl Q_fabs
...
.L43:
	...
	blr
.Lfe48:
	.size	 BoxOnPlaneSide2,.Lfe48-BoxOnPlaneSide2
	.align 2
...
.L119:
	...
	blr
.Lfe49:
	.size	 COM_FileExtension,.Lfe49-COM_FileExtension
	.comm	bigendien,4,4
	.comm	_BigShort,4,4
...
ShortSwap:
	...
	blr
.Lfe50:
	.size	 ShortSwap,.Lfe50-ShortSwap
	.align 2
	.globl ShortNoSwap
...
ShortNoSwap:
	blr
.Lfe51:
	.size	 ShortNoSwap,.Lfe51-ShortNoSwap
	.align 2
	.globl LongSwap
...
LongNoSwap:
	blr
.Lfe53:
	.size	 LongNoSwap,.Lfe53-LongNoSwap
	.align 2
	.globl FloatSwap
...
FloatSwap:
	...
	blr
.Lfe54:
	.size	 FloatSwap,.Lfe54-FloatSwap
	.align 2
	.globl FloatNoSwap
...
FloatNoSwap:
	blr
.Lfe55:
	.size	 FloatNoSwap,.Lfe55-FloatNoSwap
