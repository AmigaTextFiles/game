...
#define I_CAN_MODIFY_CONST_BOTLIB_FIELDS 1
...
// Changes Globals:		-
//===========================================================================
void AAS_SetupEntityNumbers()
{
	aas_t *localdefaultaasworld;
	aas_entity_t *localentities;
	int localmaxentities;
	int i;

	localdefaultaasworld = defaultaasworld;
	localmaxentities = localdefaultaasworld->maxentities;
	localentities = localdefaultaasworld->entities;

	for (i=0;i<localmaxentities;i++)
	{
		localentities[i].i.number = i;
	}
}
...
void AAS_InvalidateEntities( void ) {
	...
	for ( i = 0; i < localmaxentities; i++ )
	{
		localentities[i].i.valid = qfalse;
	} //end for
