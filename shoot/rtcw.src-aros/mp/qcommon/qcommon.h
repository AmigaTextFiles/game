...
struct SharedObjectSegments
{
	void *sbss_segment_start;
	unsigned int sbss_segment_size;

	void *bss_segment_start;
	unsigned int bss_segment_size;

	void *sdata_segment_start;
	unsigned int sdata_segment_size;
...
void    * QDECL Sys_LoadDll( const char *name, char *fqpath, int( QDECL * *entryPoint ) ( int, ... ), struct SharedObjectSegments *sos);
...
#define SYS_DLLNAME_QAGAME_SHIFT 0
#define SYS_DLLNAME_QAGAME "qagame_morphos_ppc.so"

#define SYS_DLLNAME_CGAME_SHIFT 0
#define SYS_DLLNAME_CGAME "cgame_morphos_ppc.so"

#define SYS_DLLNAME_UI_SHIFT 0
#define SYS_DLLNAME_UI "ui_morphos_ppc.so"

#elif defined(__AROS__)

#define SYS_DLLNAME_QAGAME_SHIFT 0
#define SYS_DLLNAME_QAGAME "qagame_mp_aros_i386.dll"

#define SYS_DLLNAME_CGAME_SHIFT 0
#define SYS_DLLNAME_CGAME "cgame_mp_aros_i386.dll"

#define SYS_DLLNAME_UI_SHIFT 0
#define SYS_DLLNAME_UI "ui_mp_aros_i386.dll"
