...
#ifdef I_CAN_MODIFY_CONST_BOTLIB_FIELDS
#define BE_BOTLIB_ONLY_WRITER
#else
#define BE_BOTLIB_ONLY_WRITER const
#endif
...
typedef struct aas_entityinfo_s
{
	...
	BE_BOTLIB_ONLY_WRITER int number;             // number of the entity
