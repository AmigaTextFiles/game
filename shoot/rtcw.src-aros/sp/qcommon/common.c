...
#if defined(__linux__) || defined(__FreeBSD__) || defined(C_ONLY) || ( !id386 && ( !defined __i386__ ) ) // Please, get these checks right :( -bigfoot
