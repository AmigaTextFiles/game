...
extern unsigned char colourDepth;
extern unsigned char colourTable[256];
...
void DrawPlayBorderSides()
{
	...
	if(colourDepth == 8) col = 127;
	if(colourDepth == 5) col = colourTable[127];
	...
	if (xl == 0) {
		...
		VW_Bar(0,0,xl-1,200-STATUSLINES,col);
		VW_Bar(xl+viewwidthwin+1,0,xl-2,200-STATUSLINES,col);

		if(colourDepth == 8) VW_Vlin(yl-1,yl+viewheightwin,xl-1,0);
		if(colourDepth == 5) VW_Vlin(yl-1,yl+viewheightwin,xl-1,colourTable[0]);
		if(colourDepth == 8) VW_Vlin(yl-1,yl+viewheightwin,xl+viewwidthwin,125);
		if(colourDepth == 5) VW_Vlin(yl-1,yl+viewheightwin,xl+viewwidthwin,colourTable[125]);
	}
}
...
void DrawPlayBorder()
{
	...
	if(colourDepth == 8) VW_Bar(0,0,320,200-STATUSLINES+1,127);
	if(colourDepth == 5) VW_Bar(0,0,320,200-STATUSLINES+1, colourTable[127]);

	xl = 160-(viewwidthwin>>1);
	yl = (200-STATUSLINES-viewheightwin)>>1;
	if(colourDepth == 8) VW_Bar(xl,yl,viewwidthwin,viewheightwin+1,0);
	if(colourDepth == 5) VW_Bar(xl,yl,viewwidthwin,viewheightwin+1, colourTable[0]);

	if (xl == 0) {
		if(colourDepth == 8) VW_Hlin(0,viewwidthwin-1,viewheightwin,125);
		if(colourDepth == 5) VW_Hlin(0,viewwidthwin-1,viewheightwin, colourTable[125]);
	} 
	else {
		if(colourDepth == 8) {
		...
		if(colourDepth == 5) {
			VW_Hlin(xl-1,xl+viewwidthwin,yl-1, colourTable[0]);
			VW_Hlin(xl-1,xl+viewwidthwin,yl+viewheightwin,colourTable[125]);
			VW_Vlin(yl-1,yl+viewheightwin,xl-1,colourTable[0]);
			VW_Vlin(yl-1,yl+viewheightwin,xl+viewwidthwin,colourTable[125]);
			VW_Plot(xl-1,yl+viewheightwin,colourTable[124]);
		}
	}
}
