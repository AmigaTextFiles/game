...
//#define FLOAT_TO_INT(x)  ((chop_temp = (x) + BIG_NUM), ((int*)(&chop_temp))[1])
//#define FLOAT_TO_FIX(x)  ((chop_temp = (x) + BIG_NUM/65536.0), ((int*)(&chop_temp))[1])

#define FLOAT_TO_INT(x) ((int)(x))
#define FLOAT_TO_FIX(x) ((int)((x)*65536.0))
