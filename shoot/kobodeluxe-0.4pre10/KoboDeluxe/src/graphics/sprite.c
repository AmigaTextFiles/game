...
#if SDL_BYTEORDER == SDL_BIG_ENDIAN
		tmp = SDL_CreateRGBSurface(SDL_SWSURFACE, nw, nh, 32, 0xff000000, 0x00ff0000, 0x0000ff00, 0x000000ff);
#else
		tmp = SDL_CreateRGBSurface(SDL_SWSURFACE, nw, nh, 32, 0x000000ff, 0x0000ff00, 0x00ff0000, 0xff000000);
#endif
		if(!tmp)
			return -1;
