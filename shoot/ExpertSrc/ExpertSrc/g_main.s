...
.Lfe4:
	...
	.align 2
.LC8:
	.string	"Level cycling: current level %s\nFound property with value %s\nGoing to level %s\n"
	.align 2
.LC9:
	.string	"gamemap \"%s\"\n"
	.align 2
...
.L8:
	...
	blr
.Lfe7:
	.size	 ShutdownGame,.Lfe7-ShutdownGame
	.section	".rodata"
	.align 2
.LC15:
	.long 0x0
...
.L18:
	...
	blr
.Lfe8:
	.size	 ClientEndServerFrames,.Lfe8-ClientEndServerFrames
	.align 2
	.globl EndDMLevel
...
.L26:
	...
	blr
.Lfe9:
	.size	 EndDMLevel,.Lfe9-EndDMLevel
