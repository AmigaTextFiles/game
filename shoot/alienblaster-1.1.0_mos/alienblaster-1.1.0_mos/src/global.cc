...
void initAllSurfaces() {
  surfaceDB.loadSurface(PATH"images/fighter.bmp" );
  surfaceDB.loadSurface(PATH"images/fighterShadow.bmp", true);
  surfaceDB.loadSurface(PATH"images/bomber.bmp");
  surfaceDB.loadSurface(PATH"images/bomberShadow.bmp", true);
  surfaceDB.loadSurface(PATH"images/tank.bmp");
  surfaceDB.loadSurface(PATH"images/boss1MainGun.bmp");
  surfaceDB.loadSurface(PATH"images/boss1RocketLauncher.bmp");
  surfaceDB.loadSurface(PATH"images/boss1ShotBatteryLeft.bmp");
  surfaceDB.loadSurface(PATH"images/boss1ShotBatteryRight.bmp");
  surfaceDB.loadSurface(PATH"images/wreckFighter.bmp");
  surfaceDB.loadSurface(PATH"images/wreckBomber.bmp");
  surfaceDB.loadSurface(PATH"images/wreckTank.bmp");
  surfaceDB.loadSurface(PATH"images/wreckBoss1.bmp");
  surfaceDB.loadSurface(PATH"images/wreckBossBackground.bmp");
  surfaceDB.loadSurface(PATH"images/boss.bmp");
  surfaceDB.loadSurface(PATH"images/normalShot.bmp");
  surfaceDB.loadSurface(PATH"images/heavyShot.bmp");
  surfaceDB.loadSurface(PATH"images/normalShotHF.bmp");
  surfaceDB.loadSurface(PATH"images/dumbfire.bmp");
  surfaceDB.loadSurface(PATH"images/kickAssRocket.bmp");
  surfaceDB.loadSurface(PATH"images/kickAssRocketShadow.bmp", true);
  surfaceDB.loadSurface(PATH"images/hellfire.bmp");
  surfaceDB.loadSurface(PATH"images/hellfireShadow.bmp", true);
  surfaceDB.loadSurface(PATH"images/machineGun.bmp");
  surfaceDB.loadSurface(PATH"images/energyBeam.bmp", true);
  surfaceDB.loadSurface(PATH"images/laser.bmp");
  surfaceDB.loadSurface(PATH"images/enemyShotNormal.bmp");
  surfaceDB.loadSurface(PATH"images/tankRocket.bmp");
  surfaceDB.loadSurface(PATH"images/tankRocketShadow.bmp", true);
  surfaceDB.loadSurface(PATH"images/heatseeker.bmp");
  surfaceDB.loadSurface(PATH"images/shotNuke.bmp");
  surfaceDB.loadSurface(PATH"images/shotNukeShadow.bmp", true);
  surfaceDB.loadSurface(PATH"images/nukeEffect.bmp");
  surfaceDB.loadSurface(PATH"images/sonic.bmp");
  surfaceDB.loadSurface(PATH"images/itemPrimaryUpgrade.bmp");
  surfaceDB.loadSurface(PATH"images/itemDumbfireDouble.bmp");
  surfaceDB.loadSurface(PATH"images/itemKickAssRocket.bmp");
  surfaceDB.loadSurface(PATH"images/itemHellfire.bmp");
  surfaceDB.loadSurface(PATH"images/itemMachineGun.bmp");
  surfaceDB.loadSurface(PATH"images/itemHealth.bmp");
  surfaceDB.loadSurface(PATH"images/itemHeatseeker.bmp");
  surfaceDB.loadSurface(PATH"images/itemNuke.bmp");
  surfaceDB.loadSurface(PATH"images/itemDeflector.bmp");
  surfaceDB.loadSurface(PATH"images/itemEnergyBeam.bmp");
  surfaceDB.loadSurface(PATH"images/itemLaser.bmp");
  surfaceDB.loadSurface(PATH"images/background.bmp");
  surfaceDB.loadSurface(PATH"images/lightFighterShieldDamaged.bmp");
  surfaceDB.loadSurface(PATH"images/heavyFighterShieldDamaged.bmp");
  surfaceDB.loadSurface(PATH"images/heavyFighterDeflector.bmp", true);
  surfaceDB.loadSurface(PATH"images/font-20red.bmp");
  surfaceDB.loadSurface(PATH"images/font-20blue.bmp");
  surfaceDB.loadSurface(PATH"images/explosion.bmp");
  surfaceDB.loadSurface(PATH"images/explosionEnemy.bmp");
  surfaceDB.loadSurface(PATH"images/bannerExcellent.bmp", true);
  surfaceDB.loadSurface(PATH"images/bannerYouRule.bmp", true);
  surfaceDB.loadSurface(PATH"images/bannerHeiho.bmp", true);
  surfaceDB.loadSurface(PATH"images/bannerHealth.bmp", true);
  surfaceDB.loadSurface(PATH"images/bannerEnemysKilled.bmp", true);
  surfaceDB.loadSurface(PATH"images/bannerBonus100.bmp", true);
  surfaceDB.loadSurface(PATH"images/bannerBonus200.bmp", true);
}
