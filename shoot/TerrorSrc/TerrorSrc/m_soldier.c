...
void SP_monster_soldier_x (edict_t *self);//TROND 14/3
...
mmove_t soldier_move_stand1 = {0, 19, soldier_frames_stand1, soldier_stand};
...
mmove_t soldier_move_stand3 = {20, 39, soldier_frames_stand3, soldier_stand};
...
mmove_t soldier_move_walk1 = {40, 45, soldier_frames_walk1, NULL};
...
mmove_t soldier_move_walk2 = {40, 45, soldier_frames_walk2, NULL};
...
mmove_t soldier_move_start_run = {40, 45, soldier_frames_start_run, soldier_run};
...
mmove_t soldier_move_run = {40, 45, soldier_frames_run, NULL};
...
mmove_t soldier_move_pain1 = {58, 61, soldier_frames_pain1, soldier_run};
...
mmove_t soldier_move_pain2 = {54, 57, soldier_frames_pain2, soldier_run};
...
mmove_t soldier_move_pain3 = {62, 65, soldier_frames_pain3, soldier_run};
...
mmove_t soldier_move_pain4 = {62, 65, soldier_frames_pain4, soldier_run};
...
//	{
	if (deathmatch->value)
	{
		monster_fire_bullet (self, start, aim, 52, 150, 200, 200, flash_index);
	}
	else
	{
		monster_fire_bullet (self, start, aim, 52, 150, 900, 900, flash_index);
	}
...
mmove_t soldier_move_attack1 = {46, 53, soldier_frames_attack1, soldier_run};
...
mmove_t soldier_move_attack2 = {46, 53, soldier_frames_attack2, soldier_run};
...
mmove_t soldier_move_attack3 = {46, 49, soldier_frames_attack3, soldier_run};
...
mmove_t soldier_move_attack4 = {46, 47, soldier_frames_attack4, soldier_run};
...
mmove_t soldier_move_attack6 = {46, 49, soldier_frames_attack6, soldier_run};
...
//		if (random() > 0.5)//TROND 17/3 var 0.5
		if (random() > 0.5)
			self->monsterinfo.currentmove = &soldier_move_attack6;//TROND 17/3 var _attack6;
	}
}
...
mmove_t soldier_move_duck = {135, 139, soldier_frames_duck, soldier_run};
...
void DM_Respawn (edict_t *soldier)
{
	edict_t		*self;
	edict_t		*target = NULL;
	vec3_t		spawn_origin;
...
//	self->classname = "police";
	...
	self->s.modelindex2 = gi.modelindex("players/team2/w_1911.md2");
	...
	if (deathmatch->value)
	{
		while ((target = findradius (target, self->s.origin, 8000)) != NULL)
		{
			...
			{
				self->enemy = target;
//				gi.cprintf (target, PRINT_HIGH, "You are a 1911 bot`s enemy, have fun\n");
			}
		}
	}
}
...
mmove_t soldier_move_death1 = {178, 183, soldier_frames_death1, soldier_dead};
...
mmove_t soldier_move_death2 = {184, 189, soldier_frames_death2, soldier_dead};
...
mmove_t soldier_move_death3 = {190, 197, soldier_frames_death3, soldier_dead};
