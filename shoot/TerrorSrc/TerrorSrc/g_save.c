...
void InitGame (void)
{
	...
	deathmatch = gi.cvar ("deathmatch", "0", CVAR_LATCH);//TROND var slått av "0"
	coop = gi.cvar ("coop", "0", CVAR_LATCH);
	skill = gi.cvar ("skill", "3", CVAR_LATCH);
	maxentities = gi.cvar ("maxentities", "1024", CVAR_LATCH);//TROND lure på kå me kan mekke te her.... :^)

	//TROND
	//SERVER OPTIONS
	blood = gi.cvar ("blood", "0", CVAR_LATCH);
	bullethole = gi.cvar ("bullethole", "0", CVAR_LATCH);
	lights = gi.cvar ("lights", "1", CVAR_LATCH);
	selflove = gi.cvar ("selflove", "0", CVAR_LATCH);
	tpfrag = gi.cvar ("tpfrag", "1", CVAR_LATCH);
	compatible = gi.cvar ("compatible", "0", CVAR_LATCH);
	leader = gi.cvar ("leader", "0", CVAR_LATCH);
	lms = gi.cvar ("lms", "0", CVAR_LATCH);
	wepmenu = gi.cvar ("wepmenu", "1", CVAR_LATCH);
	teamdmg = gi.cvar ("teamdmg", "1", CVAR_LATCH);
	explosives = gi.cvar ("explosives", "1", CVAR_LATCH);
	//TROND slutt
