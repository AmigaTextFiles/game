...
qboolean infront (edict_t *self, edict_t *other)
{
	...
	if (deathmatch->value)//TROND 16/3 var 0.3
		return true;//TROND 16/3 var 0.3
	if (dot > 0.1)//TROND 16/3 var 0.3
		return true;
	return false;
}
...
//	if (!(self->monsterinfo.aiflags & AI_STAND_GROUND))//TROND 17/3 tatt vekk
