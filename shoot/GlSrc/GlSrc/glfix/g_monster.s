...
.LC48:
	...
	.section	".text"
	.align 2
	.globl monster_fire_hrocket
	.type	 monster_fire_hrocket,@function
monster_fire_hrocket:
	stwu 1,-48(1)
	mflr 0
	stmw 26,24(1)
	stw 0,52(1)
	...
	blr
.Lfe12:
	.size	 monster_fire_hrocket,.Lfe12-monster_fire_hrocket
	.align 2
...
.L15:
	...
	blr
.Lfe23:
	.size	 M_FliesOn,.Lfe23-M_FliesOn
	.align 2
	.globl M_SetEffects
...
.L80:
	...
	blr
.Lfe24:
	.size	 M_SetEffects,.Lfe24-M_SetEffects
	.align 2
	.globl monster_use
...
.L130:
	...
	blr
.Lfe25:
	.size	 monster_use,.Lfe25-monster_use
	.section	".rodata"
	.align 2
.LC61:
	.long 0x3f800000
...
.L137:
	...
	blr
.Lfe26:
	.size	 monster_triggered_spawn,.Lfe26-monster_triggered_spawn
	.section	".rodata"
	.align 3
.LC63:
	.long 0x3fb99999
...
.L139:
	...
	blr
.Lfe27:
	.size	 monster_triggered_spawn_use,.Lfe27-monster_triggered_spawn_use
	.align 2
...
monster_triggered_start:
	...
	blr
.Lfe28:
	.size	 monster_triggered_start,.Lfe28-monster_triggered_start
	.section	".rodata"
	.align 2
.LC64:
	.long 0x3f800000
...
.L181:
	...
	blr
.Lfe29:
	.size	 walkmonster_start_go,.Lfe29-walkmonster_start_go
	.section	".rodata"
	.align 2
.LC66:
	.long 0x0
...
.L187:
	...
	blr
.Lfe30:
	.size	 flymonster_start_go,.Lfe30-flymonster_start_go
	.section	".rodata"
	.align 2
.LC67:
	.long 0x0
...
.L192:
	...
	blr
.Lfe31:
	.size	 swimmonster_start_go,.Lfe31-swimmonster_start_go
	.align 2
...
M_FliesOff:
	...
	blr
.Lfe32:
	.size	 M_FliesOff,.Lfe32-M_FliesOff
