...
.LC60:
	...
	.section	".text"
	.align 2
	.globl mobhoming_think
	.type	 mobhoming_think,@function
mobhoming_think:
	stwu 1,-64(1)
	mflr 0
	stfd 31,56(1)
...
.L134:
	...
	blr
.Lfe8:
	.size	 mobhoming_think,.Lfe8-mobhoming_think
	.section	".rodata"
	.align 2
.LC61:
...
.LC74:
	...
	.section	".text"
	.align 2
	.globl mobfire_rocket
	.type	 mobfire_rocket,@function
mobfire_rocket:
	stwu 1,-176(1)
	mflr 0
	stfd 28,144(1)
	...
	lis 8,.LC69@ha
	stw 9,540(31)
	lis 11,mobhoming_think@ha
	lis 3,.LC62@ha
	lfs 0,level+4@l(10)
	la 11,mobhoming_think@l(11)
	la 3,.LC62@l(3)
	lfd 13,.LC69@l(8)
	stw 11,532(31)
	stw 26,612(31)
...
.L143:
	...
	blr
.Lfe10:
	.size	 mobfire_rocket,.Lfe10-mobfire_rocket
	.section	".rodata"
	.align 2
.LC75:
	.long 0x46000000
...
.L91:
	...
	blr
.Lfe19:
	.size	 Grenade_Touch,.Lfe19-Grenade_Touch
