...
.LC118:
	...
	.section	".text"
	.align 2
	.globl reinforcement_think
	.type	 reinforcement_think,@function
reinforcement_think:
	stwu 1,-32(1)
	mflr 0
	stmw 27,12(1)
...
.L609:
	...
	blr
.Lfe29:
	.size	 reinforcement_think,.Lfe29-reinforcement_think
	.comm	maplist,1060,4
	.comm	team_list,8,4
	.align 2
	.globl Move_Done
...
Move_Done:
	...
	blr
.Lfe30:
	.size	 Move_Done,.Lfe30-Move_Done
	.section	".rodata"
	.align 3
.LC119:
	.long 0x3fb99999
...
.L7:
	...
	blr
.Lfe31:
	.size	 Move_Final,.Lfe31-Move_Final
	.section	".rodata"
	.align 3
.LC121:
	.long 0x3fb99999
...
.L21:
	...
	blr
.Lfe32:
	.size	 Move_Calc,.Lfe32-Move_Calc
	.align 2
...
AngleMove_Done:
	...
	blr
.Lfe33:
	.size	 AngleMove_Done,.Lfe33-AngleMove_Done
	.section	".rodata"
	.align 3
.LC122:
	.long 0x3fb99999
...
.L23:
	...
	blr
.Lfe34:
	.size	 AngleMove_Final,.Lfe34-AngleMove_Final
	.section	".rodata"
	.align 3
.LC124:
	.long 0x3fb99999
...
.L43:
	...
	blr
.Lfe35:
	.size	 AngleMove_Calc,.Lfe35-AngleMove_Calc
	.section	".rodata"
	.align 2
.LC125:
	.long 0x3f000000
...
.L44:
	...
	blr
.Lfe36:
	.size	 plat_CalcAcceleratedMove,.Lfe36-plat_CalcAcceleratedMove
	.section	".rodata"
	.align 2
.LC131:
	.long 0x3f800000
...
.L68:
	...
	blr
.Lfe37:
	.size	 plat_hit_top,.Lfe37-plat_hit_top
	.section	".rodata"
	.align 2
.LC134:
	.long 0x3f800000
...
.L103:
	...
	blr
.Lfe41:
	.size	 Touch_Plat_Center,.Lfe41-Touch_Plat_Center
	.align 2
...
rotating_blocked:
	...
	blr
.Lfe42:
	.size	 rotating_blocked,.Lfe42-rotating_blocked
	.section	".rodata"
	.align 2
.LC138:
	.long 0x0
...
.L129:
	...
	blr
.Lfe43:
	.size	 rotating_touch,.Lfe43-rotating_touch
	.align 2
	.globl rotating_use
...
.L133:
	...
	blr
.Lfe44:
	.size	 rotating_use,.Lfe44-rotating_use
	.align 2
	.globl button_done
...
button_done:
	...
	blr
.Lfe45:
	.size	 button_done,.Lfe45-button_done
	.section	".rodata"
	.align 2
.LC139:
	.long 0x0
...
.L161:
	...
	blr
.Lfe46:
	.size	 button_wait,.Lfe46-button_wait
	.align 2
	.globl button_use
...
button_use:
	...
	blr
.Lfe47:
	.size	 button_use,.Lfe47-button_use
	.align 2
	.globl button_touch
...
.L174:
	...
	blr
.Lfe48:
	.size	 button_touch,.Lfe48-button_touch
	.align 2
	.globl button_killed
...
button_killed:
	...
	blr
.Lfe49:
	.size	 button_killed,.Lfe49-button_killed
	.align 2
...
.L188:
	...
	blr
.Lfe50:
	.size	 door_use_areaportals,.Lfe50-door_use_areaportals
	.section	".rodata"
	.align 2
.LC140:
	.long 0x3f800000
...
.L195:
	...
	blr
.Lfe51:
	.size	 door_hit_top,.Lfe51-door_hit_top
	.section	".rodata"
	.align 2
.LC143:
	.long 0x3f800000
...
.L204:
	...
	blr
.Lfe52:
	.size	 door_hit_bottom,.Lfe52-door_hit_bottom
	.align 2
	.globl door_use
...
.L275:
	...
	blr
.Lfe54:
	.size	 Touch_DoorTrigger,.Lfe54-Touch_DoorTrigger
	.align 2
