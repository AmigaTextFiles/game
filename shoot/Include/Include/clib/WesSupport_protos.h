...
#define WES_OpenStick(unit,name) LP2(0x48, int, WES_OpenStick, int, unit, d0, char *, name, a0, , WESSUPPORT_BASE_NAME,IF_CACHEFLUSHALL,0,0,IF_CACHEFLUSHALL,0,0)

#define WES_CloseStick(unit) LP1NR(0x4e, WES_CloseStick, int, unit, d0, , WESSUPPORT_BASE_NAME,IF_CACHEFLUSHALL,0,0,IF_CACHEFLUSHALL,0,0)

#define WES_ReadStick(unit,data) \
		LP2NR(0x54, WES_ReadStick, int, unit, d0, struct WES_JoyData *, data, a0, \
    , WESSUPPORT_BASE_NAME,IF_CACHEFLUSHALL,0,0,IF_CACHEFLUSHALL,0,0)
