...
;  2  - Init ok, C2P supports only 320x200 resolution.
        ...
        move.l  d2,d3
        add.l   d2,d3           ;WIDTH_B*2
        move.w  d3,c2p_p5+2
        move.w  d3,c2p_p11+2
        move.w  d3,c2p_p14+2
        move.w  d3,c2p_p19+2

        add.l   d2,d3           ;WIDTH_B*3
        move.w  d3,c2p_p4+2
        move.w  d3,c2p_p9+2
        move.w  d3,c2p_p13+2
        move.w  d3,c2p_p18+2

        add.l   d2,d3           ;WIDTH_B*4
        move.w  d3,c2p_p1+2

        add.l   d2,d3           ;WIDTH_B*5
        add.l   d2,d3           ;WIDTH_B*6
        add.l   d2,d3           ;WIDTH_B*7
        move.w  d3,c2p_p7+2
        move.w  d3,c2p_p16+2
