...
int I_GetTime (void);
//static __inline__ int I_GetTime(void) { return (clock() * 20) / TICRATE; }
...
static __inline__ ticcmd_t* I_BaseTiccmd(void) { return &emptycmd; }
...
// NOVA_CODER - extern int mousepresent;                // killough
