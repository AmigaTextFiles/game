...
void *c2p8_reloc_stub(struct BitMap *bitmap) {
    ...
    register void *_return __asm("d0") = NULL;
...
static __inline__ void c2p8_deinit_stub(void *c2p) {
...
static __inline__ void c2p8_stub(void *c2p, struct BitMap *bitmap, UBYTE *chunky, ULONG size) {
