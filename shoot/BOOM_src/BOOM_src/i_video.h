...
// NOVA_CODER - void I_UpdateNoBlit (void);

void I_FinishUpdate(void);

// Wait for vertical retrace or pause a bit.
// NOVA_CODER - void I_WaitVBL(int count);
...
// NOVA_CODER - extern int use_vsync;  // killough 2/8/98: controls whether vsync is called
...
//void I_SetDisplayType(DisplayType_t displayType, BOOL autoSelectDisplayMode);
