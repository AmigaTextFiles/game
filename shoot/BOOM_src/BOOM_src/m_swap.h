...
static __inline__ short SHORT_SWAP(short val) {
	__asm __volatile
	(
		"ror.w	#8,%0"
...
static __inline__ long LONG_SWAP(long val) {
	__asm __volatile
	(
		"ror.w	#8,%0 \n\t"
		"swap	%0 \n\t"
...
//short SHORT_SWAP(short x);
/*__inline__ static short SHORT_SWAP(short x)
{
...
// Swapping 32bit.
//long LONG_SWAP(long x);

/*__inline__ static long LONG_SWAP(long x)
{
