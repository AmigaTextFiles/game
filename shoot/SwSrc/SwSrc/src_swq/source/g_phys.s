...
.L192:
	...
	blr
.Lfe5:
	.size	 SV_Physics_Noclip,.Lfe5-SV_Physics_Noclip
	.section	".rodata"
	.align 2
.LC32:
...
.L200:
	...
	blr
.Lfe6:
	.size	 SV_Physics_Toss,.Lfe6-SV_Physics_Toss
	.section	".rodata"
	.align 3
.LC36:
	.long 0x3fb99999
...
.LC43:
	...
	.section	".text"
	.align 2
	.globl SV_Physics_Float
	.type	 SV_Physics_Float,@function
SV_Physics_Float:
	stwu 1,-144(1)
	mflr 0
	stmw 29,132(1)
...
.L253:
	...
	blr
.Lfe7:
	.size	 SV_Physics_Float,.Lfe7-SV_Physics_Float
	.section	".rodata"
	.align 2
.LC48:
...
.L31:
	...
	blr
.Lfe10:
	.size	 ClipVelocity,.Lfe10-ClipVelocity
	.align 2
...
.L379:
	...
	blr
.Lfe11:
	.size	 SV_TestEntityPosition,.Lfe11-SV_TestEntityPosition
	.align 2
...
.L13:
	...
	blr
.Lfe12:
	.size	 SV_CheckVelocity,.Lfe12-SV_CheckVelocity
	.section	".rodata"
	.align 3
.LC63:
	.long 0x3f50624d
...
.L382:
	...
	blr
.Lfe13:
	.size	 SV_RunThink,.Lfe13-SV_RunThink
	.align 2
	.globl SV_Impact
...
.L25:
	...
	blr
.Lfe14:
	.size	 SV_Impact,.Lfe14-SV_Impact
	.section	".rodata"
	.align 3
.LC65:
	.long 0x3fb99999
