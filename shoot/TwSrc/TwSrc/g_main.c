	...
	if (timelimit->value)
	{
		if (level.time >= timelimit->value*60)
		{
			gi.bprintf (PRINT_HIGH, "Timelimit hit.\n");
                        ...
                        {
                        if (level.team3_score > level.team2_score)
                        if (level.team3_score > level.team1_score) {
                        gi.bprintf (PRINT_HIGH, "Result:CIVILIAN WINS!\n");
                        }
                        else
                        {
                        if (level.team1_score == level.team2_score)
...
void endsound_all (void)
{
	...
	{
                stuffcmd(joe_bloggs, "play ending.wav \n");
	}
}
