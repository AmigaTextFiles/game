...
//Demolisher
	...
	{"message", FOFS(message), F_LSTRING},
        {"team3on", FOFS(t3on), F_INT},
        {"team1max", FOFS(team1max), F_INT},
        {"team2max", FOFS(team2max), F_INT},
        {"shotgun", FOFS(shotgun), F_INT},
        {"rifle", FOFS(rifle), F_INT},
        {"playerhealth", FOFS(phealth), F_INT},
        {"noweapons", FOFS(noweap), F_INT},
	...
	{"style", FOFS(style), F_INT},
        {"tw_team", FOFS(tw_team), F_INT},
        {"detuse", FOFS(detuse), F_INT},
        {"endlevel", FOFS(endlevel), F_INT},
	{"count", FOFS(count), F_INT},
	{"health", FOFS(health), F_INT},
        {"frags", FOFS(frags), F_INT},
        {"teamfrags", FOFS(teamfrags), F_INT},
	{"sounds", FOFS(sounds), F_INT},
        {"ammotype", FOFS(ammotype), F_INT},
        {"firerate", FOFS(firerate), F_FLOAT},
	{"light", 0, F_IGNORE},
	{"dmg", FOFS(dmg), F_INT},
