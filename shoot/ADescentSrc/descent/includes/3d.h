...
*/
/*
 * $Source: /usr/CVS/descent/includes/3d.h,v $
 * $Revision: 1.3 $
 * $Author: nobody $
 * $Date: 1999/03/10 23:26:46 $
 *
 * Header file for 3d library
 *
 * $Log: 3d.h,v $
 * Revision 1.3  1999/03/10 23:26:46  nobody
 * Warp3D V2 adaption
 *
 * Revision 1.2  1998/03/25 21:33:13  tfrieden
 * New g3_project_point with fpu support
 *
 * Revision 1.1.1.1  1998/03/03 15:11:51  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:20:15  hfrieden
 * Initial Import
 */
...
#define g3_project_point(a) (*g3_project_point_func)((a))
extern void (*g3_project_point_func)(g3s_point *p);
#else
extern void g3_project_point_new(g3s_point *p);
#define g3_project_point(a) g3_project_point_new(a)
#endif

// init function pointers for different math models
...
#else
#define g3_calc_point_depth(pnt) \
	((pnt->x - View_position.x)*View_matrix.fvec.x) +   \
