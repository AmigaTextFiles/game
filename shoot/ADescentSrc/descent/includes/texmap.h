...
*/
/*
 * $Source: /usr/CVS/descent/includes/texmap.h,v $
 * $Revision: 1.2 $
 * $Author: nobody $
 * $Date: 1998/12/21 17:12:26 $
 *
 * Include file for entities using texture mapper library.
 *
 * $Log: texmap.h,v $
 * Revision 1.2  1998/12/21 17:12:26  nobody
 * *** empty log message ***
 *
...
#define FIX_XLIMIT	(800 * F1_0)
#define FIX_YLIMIT	(600 * F1_0)
