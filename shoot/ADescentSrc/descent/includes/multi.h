...
*/
/*
 * $Source: /usr/CVS/descent/includes/multi.h,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/04/24 14:22:32 $
 * 
 * Defines and exported variables for multi.c
 * 
 * $Log: multi.h,v $
 * Revision 1.2  1998/04/24 14:22:32  tfrieden
 * Bugfixes for endian/alignment problems
 *
 * Revision 1.1.1.1  1998/03/03 15:11:58  nobody
