...
*/
/*
 * $Source: /usr/CVS/descent/includes/vecmat.h,v $
 * $Revision: 1.5 $
 * $Author: nobody $
 * $Date: 1998/08/08 15:41:41 $
 *
 * Header file for vector/matrix library
 *
 * $Log: vecmat.h,v $
 * Revision 1.5  1998/08/08 15:41:41  nobody
 * Activated the Editior
 *
 * Revision 1.4  1998/04/01 21:17:54  tfrieden
 * New function pointers
 *
 * Revision 1.3  1998/03/31 14:30:17  tfrieden
 * Vecmat function pointers inserted
 *
 * Revision 1.2  1998/03/25 22:01:22  tfrieden
 * Made the vecmat stuff inline
 *
 * Revision 1.1.1.1  1998/03/03 15:12:05  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:20:32  hfrieden
 * Initial Import
 */
...
vms_vector *vm_vec_avg(vms_vector *dest __asm("a0") ,vms_vector *src0 __asm("a1"),vms_vector *src1 __asm("a2"));
...
#define vm_vec_mag(a) (*vm_vec_mag_func)((a))
extern fix (*vm_vec_mag_func)(vms_vector *v __asm("a0"));
...
extern fix (*vm_vec_dotprod_func)(vms_vector *v0 __asm("a0"),vms_vector *v1 __asm("a1"));
#define vm_vec_dotprod(a,b) (*vm_vec_dotprod_func)((a),(b))
#define vm_vec_dot(a,b) (*vm_vec_dotprod_func)((a),(b))

//computes cross product of two vectors. returns ptr to dest
//dest CANNOT equal either source
extern vms_vector *(*vm_vec_crossprod_func)(vms_vector *dest __asm("a0"),vms_vector *src0 __asm("a1"),vms_vector *src1 __asm("a2"));
#define vm_vec_crossprod(a,b,c) (*vm_vec_crossprod_func)((a),(b),(c))
#define vm_vec_cross(a,b,c) (*vm_vec_crossprod_func)((a),(b),(c))
