...
*/
/*
 * $Source: /usr/CVS/descent/includes/render.h,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/04/24 14:23:05 $
 * 
 * Header for rendering-based functions
 * 
 * $Log: render.h,v $
 * Revision 1.2  1998/04/24 14:23:05  tfrieden
 * Removed warnings
 *
 * Revision 1.1.1.1  1998/03/03 15:12:01  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:20:26  hfrieden
 * Initial Import
 */
