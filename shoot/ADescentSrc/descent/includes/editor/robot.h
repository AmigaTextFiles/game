/*
 * $Source: /usr/CVS/descent/includes/editor/robot.h,v $
 * $Revision: 1.1.1.1 $
 * $Author: nobody $
 * $Date: 1998/03/03 15:12:09 $
 * 
 * Header for robot.c
 * 
 * $Log: robot.h,v $
 * Revision 1.1.1.1  1998/03/03 15:12:09  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:20:36  hfrieden
 * Initial Import
 *
