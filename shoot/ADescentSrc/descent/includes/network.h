...
*/
/*
 * $Source: /usr/CVS/descent/includes/network.h,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/04/02 13:42:25 $
 * 
 * Prototypes for network management functions.
 * 
 * $Log: network.h,v $
 * Revision 1.2  1998/04/02 13:42:25  tfrieden
 * removed old comments
 *
 * Revision 1.1.1.1  1998/03/03 15:11:59  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:20:23  hfrieden
 * Initial Import
 */
...
int network_endlevel_poll2( int nitems, newmenu_item * menus, int * key, int citem );
