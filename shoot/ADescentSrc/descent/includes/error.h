...
*/
/*
 * $Source: /usr/CVS/descent/includes/error.h,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/04/09 16:14:04 $
 *
 * Header for error handling/printing/exiting code
 *
 * $Log: error.h,v $
 * Revision 1.2  1998/04/09 16:14:04  tfrieden
 * Int3 activated for debugging
 *
...
// void Int3();
#define Int3()  error_int3(__FILE__,__LINE__)
