...
*/
/*
 * $Source: /usr/CVS/descent/includes/game.h,v $
 * $Revision: 1.3 $
 * $Author: tfrieden $
 * $Date: 1998/04/05 01:54:48 $
 * 
 * Constants & prototypes which pertain to the game only
 * 
 * $Log: game.h,v $
 * Revision 1.3  1998/04/05 01:54:48  tfrieden
 * Changes for ECS/Halfbride
 *
 * Revision 1.2  1998/03/22 15:22:46  tfrieden
 * removed lots of warning messages
 *
 * Revision 1.1.1.1  1998/03/03 15:11:55  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:20:20  hfrieden
 * Initial Import
 */
...
// Kludge. I didn't feel like finding a "proper" location for this --PCM
#define min MIN
#define max MAX
