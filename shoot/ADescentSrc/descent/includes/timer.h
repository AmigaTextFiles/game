...
*/
/*
 * $Source: /usr/CVS/descent/includes/timer.h,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/08/09 23:02:46 $
 *
 * Header for timer functions
 *
 * $Log: timer.h,v $
 * Revision 1.2  1998/08/09 23:02:46  tfrieden
 * Removed thad f@*king TICKER
 *
...
#define TICKER (timer_get_fixed_seconds() / 3600)
