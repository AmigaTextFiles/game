...
*/
/*
 * $Source: /usr/CVS/descent/includes/gr.h,v $
 * $Revision: 1.2 $
 * $Author: hfrieden $
 * $Date: 1998/03/22 15:59:26 $
 *
 * Definitions for graphics lib.
 *
 * $Log: gr.h,v $
 * Revision 1.2  1998/03/22 15:59:26  hfrieden
 * Empty log message
 *
 * Revision 1.1.1.1  1998/03/03 15:11:56  nobody
 * reimport after crash from backup
 *
 * Revision 1.2  1998/02/28 00:34:04  tfrieden
 * aga support
 *
...
typedef struct _grs_bitmap {
	...
	void           *bm_Handle;  //  Amiga-Specific
/*    int             bm_RealWidth; // Real width for bitmap (to avoid CV64 doublescan)
	ubyte           bm_Planar;  //  it`s a planar bitmap */
} grs_bitmap;
