/*
 * $Source: /usr/CVS/descent/main/dumpmine.c,v $
 * $Revision: 1.2 $
 * $Author: nobody $
 * $Date: 1998/08/08 15:43:18 $
 * 
...
static char rcsid[] = "$Id: dumpmine.c,v 1.2 1998/08/08 15:43:18 nobody Exp $";
