...
*/
/*
 * $Source: /usr/CVS/descent/main/gamefont.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: nobody $
 * $Date: 1998/03/03 15:12:20 $
 * 
 * Fonts for the game.
 * 
 * $Log: gamefont.c,v $
 ...
 *
 * Revision 1.1.1.1  1998/02/13  20:20:52  hfrieden
 * Initial Import
 *
...
static char rcsid[] = "$Id: gamefont.c,v 1.1.1.1 1998/03/03 15:12:20 nobody Exp $";
