...
*/
/*
 * $Source: /usr/CVS/descent/main/bmread.c,v $
 * $Revision: 1.2 $
 * $Author: nobody $
 * $Date: 1998/08/08 15:42:19 $
 * 
 * Routines to parse bitmaps.tbl
 * 
 * $Log: bmread.c,v $
 * Revision 1.2  1998/08/08 15:42:19  nobody
...
static char rcsid[] = "$Id: bmread.c,v 1.2 1998/08/08 15:42:19 nobody Exp $";
