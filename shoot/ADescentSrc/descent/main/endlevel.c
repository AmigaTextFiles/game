...
*/
/*
 * $Source: /usr/CVS/descent/main/endlevel.c,v $
 * $Revision: 1.6 $
 * $Author: nobody $
 * $Date: 1998/09/26 15:09:17 $
 * 
 * Code for rendering external scenes
 * 
 * $Log: endlevel.c,v $
 * Revision 1.6  1998/09/26 15:09:17  nobody
 * Added Warp3D support
 *
 * Revision 1.5  1998/04/09 17:16:15  hfrieden
 * Endlevel graphics bug removed
 *
 * Revision 1.4  1998/03/29 21:23:14  tfrieden
 * Fixed the low-framerates-after-endsequence-bug
 *
 * Revision 1.3  1998/03/25 22:04:01  tfrieden
 * Revision bumped to reflect new g3_project_point
 *
 * Revision 1.2  1998/03/22 15:24:19  tfrieden
 * removed lots of warning messages
 *
 * Revision 1.1.1.1  1998/03/03 15:12:14  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:20:50  hfrieden
 * Initial Import
 */

#pragma off (unreferenced)
static char rcsid[] = "$Id: endlevel.c,v 1.6 1998/09/26 15:09:17 nobody Exp $";
...
extern void gr_direct_pixel(int, int);
#endif
...
draw_stars()
{
	...
	for (i=0;i<MAX_STARS;i++) {
		...
		if (p.p3_codes == 0) {
			...
			g3_project_point(&p);
			#if defined(VIRGIN) || defined(WARP3D)
			gr_direct_pixel(f2i(p.p3_sx), f2i(p.p3_sy));
			#else
