...
*/
/*
 * $Source: /usr/CVS/descent/main/newdemo.c,v $
 * $Revision: 1.2 $
 * $Author: nobody $
 * $Date: 1998/08/08 15:44:40 $
 * 
 * Code to make a complete demo playback system.
 * 
 * $Log: newdemo.c,v $
 * Revision 1.2  1998/08/08 15:44:40  nobody
 * Activated the Editior
 *
 * Revision 1.1.1.1  1998/03/03 15:12:27  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:20:41  hfrieden
 * Initial Import
 *
...
static char rcsid[] = "$Id: newdemo.c,v 1.2 1998/08/08 15:44:40 nobody Exp $";
...
void newdemo_start_playback(char * filename)
{
	...
	if (filename==NULL) {
		glob_ret.gl_offs=0;
		if (!glob("*.dem",0,NULL,&glob_ret)&&glob_ret.gl_pathc)
			filename=glob_ret.gl_pathv[rand()%glob_ret.gl_pathc];
