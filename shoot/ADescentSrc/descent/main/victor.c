...
*/
/*
 * $Source: /usr/CVS/descent/main/victor.c,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/04/24 14:31:33 $
 * 
 * Routines to access the VictorMaxx helmet.
 * 
 * $Log: victor.c,v $
 * Revision 1.2  1998/04/24 14:31:33  tfrieden
 * Removed a reference to a unimplemented function
 *
...
static char rcsid[] = "$Id: victor.c,v 1.2 1998/04/24 14:31:33 tfrieden Exp $";
