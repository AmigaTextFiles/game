...
*/
/*
 * $Source: /usr/CVS/descent/main/gameseq.c,v $
 * $Revision: 1.4 $
 * $Author: nobody $
 * $Date: 1998/08/08 15:44:11 $
 * 
 * Routines for EndGame, EndLevel, etc.
 *
 * $Log: gameseq.c,v $
 * Revision 1.4  1998/08/08 15:44:11  nobody
 * Activated the Editior
 *
 * Revision 1.3  1998/03/22 15:24:47  tfrieden
...
static char rcsid[] = "$Id: gameseq.c,v 1.4 1998/08/08 15:44:11 nobody Exp $";
