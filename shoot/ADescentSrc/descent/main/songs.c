...
*/
/*
 * $Source: /usr/CVS/descent/main/songs.c,v $
 * $Revision: 1.2 $
 * $Author: hfrieden $
 * $Date: 1998/04/03 13:35:43 $
 * 
 * Routines to manage the songs in Descent.
 * 
 * $Log: songs.c,v $
 * Revision 1.2  1998/04/03 13:35:43  hfrieden
 * Fixed nosong switch
 *
 * Revision 1.1.1.1  1998/03/03 15:12:32  nobody
 * reimport after crash from backup
 *
 * Revision 1.2  1998/02/28 00:40:41  hfrieden
 * Added -nosongs switch for MAC HOG file (hopefully)
 *
...
static char rcsid[] = "$Id: songs.c,v 1.2 1998/04/03 13:35:43 hfrieden Exp $";
