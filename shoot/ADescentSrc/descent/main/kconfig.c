...
*/
/*
 * $Source: /usr/CVS/descent/main/kconfig.c,v $
 * $Revision: 1.5 $
 * $Author: tfrieden $
 * $Date: 1998/04/24 14:29:05 $
 * 
 * Routines to configure keyboard, joystick, etc..
 * 
 * $Log: kconfig.c,v $
 * Revision 1.5  1998/04/24 14:29:05  tfrieden
 * Removed null pointer references
 *
 * Revision 1.4  1998/04/05 01:57:27  tfrieden
 * Original default values for keyboard/joystick
 *
 * Revision 1.3  1998/03/14 13:49:54  hfrieden
 * Merge conflicts removed
 *
 * Revision 1.2  1998/03/13 23:52:21  tfrieden
 ...
 *
 * Revision 1.4  1998/02/28 13:06:09  tfrieden
 * AGA support
 *
 * Revision 1.3  1998/02/28 00:27:53  hfrieden
 * Support for Analog Joysticks added
 *
 * Revision 1.2  1998/02/22 13:26:32  tfrieden
 * Various changes regarding mouse support
 *
 * Revision 1.1.1.1  1998/02/13  20:20:56  hfrieden
 * Initial Import
 */


#pragma off (unreferenced)
static char rcsid[] = "$Id: kconfig.c,v 1.5 1998/04/24 14:29:05 tfrieden Exp $";
...
"","","","","","","" };*/
char *key_text[256] = {
	"~",   "1",   "2",   "3",   "4",   "5",   "6",   "7",   "8",   "9",   "0",   "-",   "=",   "'",    "","PAD0",
	"Q",   "W",   "E",   "R",   "T",   "Y",   "U",   "I",   "O",   "P",   "[",   "]",    "","PAD1","PAD2","PAD3",
	"A",   "S",   "D",   "F",   "G",   "H",   "J",   "K",   "L",   ";",  """",    "",    "","PAD4","PAD5","PAD6",
	"<",   "Z",   "X",   "C",   "V",   "B",   "N",   "M",   ",",   ".",   "/",    "","PAD.","PAD7","PAD8","PAD9",
  "SPC","BSPC", "TAB","PADÉ",   "É", "ESC", "DEL",    "",    "",    "","PAD-",    "",   "Ç",   "Ä",   "",  "Å",
   "F1",  "F2",  "F3",  "F4",  "F5",  "F6",  "F7",  "F8",  "F9", "F10", "F11", "F12","PAD/","PAD*","PAD+","HELP",
"LSHFT","RSHFT","CPSLK","CTRL","LALT","RALT","LAMI","RAMI",  "",    "",    "",    "",    "",    "",    "",    "",
	 "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",
	 "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",
	 "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",
	 "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",    "",
...
{0x4c,0xff,0x4d,0xff,0x4f,0xff,0x4e,0xff,0x66,0xff,0x2d,0xff,0x2f,0xff,0x3e,0xff,0x1e,0xff,0x11,0xff,0x10,0x47,0x12,0x49,0x63,0x2e,0x60,0xff,0x23,0xff,0x20,0xff,0x31,0xff,0x35,0xff,0x13,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x42,0xff,0xff,0xff,0xff,0xff},
...
ubyte default_kconfig_settings[CONTROL_MAX_TYPES][MAX_CONTROLS] = {
{0x4c,0x3e,0x4d,0x1e,0x4f,0x2d,0x4e,0x2f,0x64,0xff,0xff,0x1d,0xff,0x1f,0xff,0x4a,0xff,0x5e,0xff,0xff,0x10,0x3d,0x12,0x3f,0x63,0x43,0x40,0xff,0x23,0xff,0x20,0xff,0x31,0xff,0x35,0xff,0x13,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x42,0xff,0xff,0xff,0xff,0xff},
{0x0,0x1,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x1,0x0,0x0,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff},
{0x5,0xc,0xff,0xff,0xff,0xff,0x7,0xf,0x13,0xb,0xff,0x6,0x8,0x1,0x0,0x0,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff},
{0x0,0x1,0xff,0xff,0x2,0xff,0x7,0xf,0x13,0xb,0xff,0xff,0xff,0x1,0x0,0x0,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0x3,0xff,0x3,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff},
{0x3,0x0,0x1,0x2,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x1,0x0,0x0,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff},
...
void kconfig_set_fcs_button( int , int);
...
void controls_read_all()
{
	...
	if (Config_control_type==5 ) {
		...
		//mprintf(( 0, "Mouse %d,%d b:%d, 0x%x\n", dx, dy, mouse_buttons, FrameTime ));
		/*mouse_axis[0], mouse_axis[1],*/
		use_mouse=1;
...
void kc_set_controls()
{
	...
	if (Config_control_type == 1 || Config_control_type == 2) {
		mouse_switch_off();
	} else {
		mouse_switch_on();
	}
