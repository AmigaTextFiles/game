...
*/
/*
 * $Source: /usr/CVS/descent/main/morph.c,v $
 * $Revision: 1.3 $
 * $Author: hfrieden $
 * $Date: 1998/03/22 17:10:47 $
 * 
 * Morphing code
 * 
 * $Log: morph.c,v $
 * Revision 1.3  1998/03/22 17:10:47  hfrieden
 * Removed compilation error
 *
 * Revision 1.2  1998/03/22 15:25:56  tfrieden
...
static char rcsid[] = "$Id: morph.c,v 1.3 1998/03/22 17:10:47 hfrieden Exp $";
