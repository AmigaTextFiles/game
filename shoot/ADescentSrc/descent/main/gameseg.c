...
*/
/*
 * $Source: /usr/CVS/descent/main/gameseg.c,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/04/14 23:53:30 $
 * 
 * Functions moved from segment.c to make editor separable from game.
 * 
 * $Log: gameseg.c,v $
 * Revision 1.2  1998/04/14 23:53:30  tfrieden
 * Some changes for multiplayer
 *
...
static char rcsid[] = "$Id: gameseg.c,v 1.2 1998/04/14 23:53:30 tfrieden Exp $";
...
//
//  db_printf(( "Positn: %08x %08x %08x    %08x %08x %08x\n", objp->pos.x, objp->pos.y, objp->pos.z,
