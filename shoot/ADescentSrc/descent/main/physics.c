...
*/
/*                                        
 * $Source: /usr/CVS/descent/main/physics.c,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/03/22 15:26:27 $
 * 
 * Code for flying through the mines
 * 
 * $Log: physics.c,v $
 * Revision 1.2  1998/03/22 15:26:27  tfrieden
...
static char rcsid[] = "$Id: physics.c,v 1.2 1998/03/22 15:26:27 tfrieden Exp $";
