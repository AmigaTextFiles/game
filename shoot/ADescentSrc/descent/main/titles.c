...
*/
/*
 * $Source: /usr/CVS/descent/main/titles.c,v $
 * $Revision: 1.5 $
 * $Author: nobody $
 * $Date: 1998/09/26 15:12:10 $
 * 
 * Routines to display title screens...
 * 
 * $Log: titles.c,v $
 * Revision 1.5  1998/09/26 15:12:10  nobody
 * Added Warp3D support
 *
 * Revision 1.4  1998/04/09 17:19:14  hfrieden
 * ViRGE briefings reworked
 *
 * Revision 1.3  1998/03/22 16:14:47  hfrieden
 * Title stuff edited for ViRGE support
 *
 * Revision 1.2  1998/03/14 13:54:23  hfrieden
 * Preliminary ViRGE support added
 *
 * Revision 1.1.1.1  1998/03/03 15:12:31  nobody
 * reimport after crash from backup
 *
 * Revision 1.2  1998/02/28 00:34:45  tfrieden
 * aga support
 *
 * Revision 1.1.1.1  1998/02/13  20:20:42  hfrieden
 * Initial Import
 */

#pragma off (unreferenced)
static char rcsid[] = "$Id: titles.c,v 1.5 1998/09/26 15:12:10 nobody Exp $";
...
int show_briefing_message(int screen_num, char *message)
{
	...
	//mprintf((0, "Going to print message [%s] \n", message));
...
//              prev_ch = 10;                           //  read to eoln
			...
			if (delay_count != 0) gr_update(NULL);
		}
