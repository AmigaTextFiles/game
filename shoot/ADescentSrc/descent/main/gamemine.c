...
*/
/*
 * $Source: /usr/CVS/descent/main/gamemine.c,v $
 * $Revision: 1.4 $
 * $Author: nobody $
 * $Date: 1998/08/08 15:43:46 $
 * 
 * Functions for loading mines in the game
 * 
 * $Log: gamemine.c,v $
 * Revision 1.4  1998/08/08 15:43:46  nobody
 * Activated the Editior
 *
 * Revision 1.3  1998/04/24 14:27:37  tfrieden
 * Bugfixes (alignment problems)
 *
 * Revision 1.2  1998/03/13 23:51:54  tfrieden
...
static char rcsid[] = "$Id: gamemine.c,v 1.4 1998/08/08 15:43:46 nobody Exp $";
