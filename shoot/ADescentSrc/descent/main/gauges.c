...
*/
/*
 * $Source: /usr/CVS/descent/main/gauges.c,v $
 * $Revision: 1.5 $
 * $Author: nobody $
 * $Date: 1998/09/26 15:09:40 $
 *
 * Inferno gauge drivers
 *
 * $Log: gauges.c,v $
 * Revision 1.5  1998/09/26 15:09:40  nobody
 * Added Warp3D support
 *
 * Revision 1.4  1998/03/30 11:48:26  tfrieden
 * removed fps/memory counter
 *
 * Revision 1.3  1998/03/22 16:05:55  hfrieden
 * Fixed Gauges to go directly to ViRGE display
 *
 * Revision 1.2  1998/03/22 15:25:02  tfrieden
 * removed lots of warning messages
 *
 * Revision 1.1.1.1  1998/03/03 15:12:21  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:20:54  hfrieden
 * Initial Import
 * 
 */

#pragma off (unreferenced)
static char rcsid[] = "$Id: gauges.c,v 1.5 1998/09/26 15:09:40 nobody Exp $";
...
#define gr_ubitmapm gr_direct_ubitmapm
#endif
...
//    fprintf(stderr, "%d %d (%d)\n", w,h, grd_curcanv->cv_w); //REMOVE_ME_I_AM_DEBUG
