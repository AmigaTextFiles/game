...
*/
/*
 * $Source: /usr/CVS/descent/main/wall.c,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/04/24 14:31:46 $
 * 
 * Destroyable wall stuff
 * 
 * $Log: wall.c,v $
 * Revision 1.2  1998/04/24 14:31:46  tfrieden
 * Bugfixes
 *
 * Revision 1.1.1.1  1998/03/03 15:12:32  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:21:05  hfrieden
 * Initial Import
 */

#pragma off (unreferenced)
static char rcsid[] = "$Id: wall.c,v 1.2 1998/04/24 14:31:46 tfrieden Exp $";
