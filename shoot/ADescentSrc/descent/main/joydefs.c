...
*/
/*
 * $Source: /usr/CVS/descent/main/joydefs.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: nobody $
 * $Date: 1998/03/03 15:12:25 $
 * 
 * .
 *
 * $Log: joydefs.c,v $
 ...
 *
 * Revision 1.2  1998/02/28 00:38:05  hfrieden
 * Modified joystick stuff for analog joysticks
 *
 * 
 */
...
static char rcsid[] = "$Id: joydefs.c,v 1.1.1.1 1998/03/03 15:12:25 nobody Exp $";
