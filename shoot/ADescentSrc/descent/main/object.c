...
*/
/*
 * $Source: /usr/CVS/descent/main/object.c,v $
 * $Revision: 1.6 $
 * $Author: nobody $
 * $Date: 1998/09/26 15:11:12 $
 * 
 * object rendering
 * 
 * $Log: object.c,v $
 * Revision 1.6  1998/09/26 15:11:12  nobody
 * Added Warp3D support
 *
 * Revision 1.5  1998/08/08 15:45:12  nobody
 * Activated the Editior
 *
 * Revision 1.4  1998/03/31 17:10:14  hfrieden
 * Added functions for transparent Cloaked ships on ViRGE
 *
 * Revision 1.3  1998/03/25 22:07:58  tfrieden
 * Revision bumped to reflect new g3_project_point
 *
 * Revision 1.2  1998/03/22 15:26:13  tfrieden
 * removed lots of warning messages
 *
 * Revision 1.1.1.1  1998/03/03 15:12:28  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:21:02  hfrieden
 * Initial Import
 */


#pragma off (unreferenced)
static char rcsid[] = "$Id: object.c,v 1.6 1998/09/26 15:11:12 nobody Exp $";
...
draw_cloaked_object(object *obj,fix light,fix *glow,fix cloak_start_time,fix cloak_end_time,bitmap_index * alt_textures)
{
	...
	if (fading) {
		...
		#if defined(VIRGIN) || defined(WARP3D)
		g3_set_special_render(draw_tmap_flat_ghost,NULL,NULL);        //use special flat ViRGE ghost drawer
		#else
