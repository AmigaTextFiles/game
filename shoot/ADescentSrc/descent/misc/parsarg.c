...
*/
/*
 * $Source: /usr/CVS/descent/misc/parsarg.c,v $
 * $Revision: 1.1.1.1 $
 * $Author: nobody $
 * $Date: 1998/03/03 15:12:42 $
 *
 * Source for parse_args() function.  See header file (parsarg.h) for info
 *
 * $Log: parsarg.c,v $
 * Revision 1.1.1.1  1998/03/03 15:12:42  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:21:17  hfrieden
 * Initial Import
 *
...
static char rcsid[] = "$Id: parsarg.c,v 1.1.1.1 1998/03/03 15:12:42 nobody Exp $";
