...
*/
/*
 * $Source: /usr/CVS/descent/3d/rod.c,v $
 * $Revision: 1.2 $
 * $Author: nobody $
 * $Date: 1998/12/21 17:12:17 $
 * 
 * Rod routines
 * 
 * $Log: rod.c,v $
 * Revision 1.2  1998/12/21 17:12:17  nobody
 * *** empty log message ***
 *
...
static char rcsid[] = "$Id: rod.c,v 1.2 1998/12/21 17:12:17 nobody Exp $";
