...
*/
/*
 * $Source: /usr/CVS/descent/3d/points.c,v $
 * $Revision: 1.6 $
 * $Author: nobody $
 * $Date: 1999/03/10 23:26:41 $
 * 
 * Routines for point definition, rotation, etc.
 * 
 * $Log: points.c,v $
 * Revision 1.6  1999/03/10 23:26:41  nobody
 * Warp3D V2 adaption
 *
 * Revision 1.5  1998/08/08 15:35:57  nobody
 * Activated the Editor
 *
 * Revision 1.4  1998/04/01 21:16:44  tfrieden
 * Changed the integer version of g3_project_point
 *
 * Revision 1.3  1998/03/28 23:04:42  tfrieden
 * Another fix-point release
 *
 * Revision 1.2  1998/03/25 21:30:14  tfrieden
 * New g3_project_point with fpu support
 *
 * Revision 1.1.1.1  1998/03/03 15:11:48  nobody
...
static char rcsid[] = "$Id: points.c,v 1.6 1999/03/10 23:26:41 nobody Exp $";
...
extern void g3_project_point_fpu(g3s_point *p);
void g3_project_point_double(g3s_point *p);
void (*g3_project_point_func)(g3s_point *p);

void g3_init_math(void) {

	g3_project_point_func = g3_project_point_double;

	if (FindArg("-fpu")) {
		g3_project_point_func = g3_project_point_fpu;
	}
}
...
#ifdef WANT_FPU
void g3_project_point_new(g3s_point *p)
{
	...
	p->p3_sx = fCanv_w2 + (p->p3_x * fCanv_w2 / p->p3_z);
	p->p3_sy = fCanv_h2 - (p->p3_y * fCanv_h2 / p->p3_z);
...
void g3_project_point_old(g3s_point *p)
{
