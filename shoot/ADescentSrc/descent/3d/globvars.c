...
*/
/*
 * $Source: /usr/CVS/descent/3d/globvars.c,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/03/25 21:33:56 $
 * 
 * Global variables for 3d
 * 
 * $Log: globvars.c,v $
 * Revision 1.2  1998/03/25 21:33:56  tfrieden
 * New g3_project_point with fpu support
 *
 * Revision 1.1.1.1  1998/03/03 15:11:48  nobody
 * reimport after crash from backup
 *
 * Revision 1.1.1.1  1998/02/13  20:20:09  hfrieden
 * Initial Import
 *
...
static char rcsid[] = "$Id: globvars.c,v 1.2 1998/03/25 21:33:56 tfrieden Exp $";
