...
*/
/*
 * $Source: /usr/CVS/descent/2d/line.c,v $
 * $Revision: 1.5 $
 * $Author: nobody $
 * $Date: 1998/11/09 22:20:11 $
 *
 * Graphical routines for drawing lines.
 *
 * $Log: line.c,v $
 * Revision 1.5  1998/11/09 22:20:11  nobody
 * *** empty log message ***
 *
 * Revision 1.4  1998/09/26 15:04:10  nobody
 * Added Warp3D support
 *
 * Revision 1.3  1998/04/24 14:18:33  tfrieden
 * Preparations for direct automap mode
 *
 * Revision 1.2  1998/03/30 18:27:26  hfrieden
 * Additional direct render stuff for ViRGE automapper added
 *
...
int gr_direct_line(fix a1, fix b1, fix a2, fix b2)
{
	int x1, y1, x2, y2;
	int clipped=0;
#ifdef WARP3D
	int Add = (1-WARP_Buffer)*WARP_Window->Height/2;
#endif
	...
	//gr_uline( a1, b1, a2, b2 );
#if defined(VIRGIN)
	VirgeDrawLine2D(f2i(a1), f2i(b1), f2i(a2), f2i(b2));
#elif defined(WARP3D)
	Move(WARP_Window->RPort, f2i(a1), f2i(b1)+Add);
	Draw(WARP_Window->RPort, f2i(a2), f2i(b2)+Add);
#else
//    DrawCGXLine2D(f2i(a1), f2i(b1), f2i(a2), f2i(b2));
#endif
	return clipped;
