...
*/
/*
 * $Source: /usr/CVS/descent/2d/pcx.c,v $
 * $Revision: 1.2 $
 * $Author: tfrieden $
 * $Date: 1998/04/24 14:19:13 $
 * 
 * Routines to read/write pcx images.
 * 
 * $Log: pcx.c,v $
 * Revision 1.2  1998/04/24 14:19:13  tfrieden
 * Bug fixes
 *
...
static char rcsid[] = "$Id: pcx.c,v 1.2 1998/04/24 14:19:13 tfrieden Exp $";
