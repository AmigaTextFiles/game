...
*/
/*
 * $Source: /usr/CVS/descent/editor/medmisc.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:25 $
 * 
 * Miscellaneous functions stripped out of med.c
 * 
 * $Log: medmisc.c,v $
 * Revision 1.1  1998/08/11 14:33:25  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:46  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: medmisc.c,v 1.1 1998/08/11 14:33:25 nobody Exp $";
