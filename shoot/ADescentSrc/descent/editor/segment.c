...
*/
/*
 * $Source: /usr/CVS/descent/editor/segment.c,v $
 * $Revision: 1.2 $
 * $Author: nobody $
 * $Date: 1998/09/26 15:08:25 $
 *
 * Interrogation functions for segment data structure.
 *
 * $Log: segment.c,v $
 * Revision 1.2  1998/09/26 15:08:25  nobody
 * Added Warp3D support
 *
 * Revision 1.1  1998/08/11 14:33:36  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:03:00  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: segment.c,v 1.2 1998/09/26 15:08:25 nobody Exp $";
...
int med_form_joint(segment *seg1, int side1, segment *seg2, int side2)
{
	...
	debug(("In med_form_joint: Seg1=0x%08x, side1=%x, seg2=0x%08x, side2=%d\n",
			seg1, side1, seg2, side2));
...
{
//    char temp[1];         //  Can anybody tell me what this is for ???
	char temp[32];
	int result;
