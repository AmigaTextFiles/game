...
*/
/*
 * $Source: /usr/CVS/descent/editor/kcurve.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:00 $
 *
 * Functions for curve stuff.
 *
 * $Log: kcurve.c,v $
 * Revision 1.1  1998/08/11 14:33:00  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:12  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: kcurve.c,v 1.1 1998/08/11 14:33:00 nobody Exp $";
