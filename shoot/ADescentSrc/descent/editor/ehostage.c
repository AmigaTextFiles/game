...
*/
/*
 * $Source: /usr/CVS/descent/editor/ehostage.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:44 $
 * 
 * Routines for placing hostages, etc...
 * 
 * $Log: ehostage.c,v $
 * Revision 1.1  1998/08/11 14:32:44  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:01:50  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: ehostage.c,v 1.1 1998/08/11 14:32:44 nobody Exp $";
