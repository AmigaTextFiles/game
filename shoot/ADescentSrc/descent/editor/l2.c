...
*/
/*
 * $Source: /usr/CVS/descent/editor/l2.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:19 $
 * 
 * Routines for displaying texture pages
 * 
 * $Log: l2.c,v $
 * Revision 1.1  1998/08/11 14:33:19  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:37  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: l2.c,v 1.1 1998/08/11 14:33:19 nobody Exp $";
