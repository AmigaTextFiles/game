...
*/
/*		
 * $Source: /usr/CVS/descent/editor/group.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:54 $
 * 
 * group functions
 * 
 * $Log: group.c,v $
 * Revision 1.1  1998/08/11 14:32:54  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:05  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: group.c,v 1.1 1998/08/11 14:32:54 nobody Exp $";
