...
*/
/*
 * $Source: /usr/CVS/descent/editor/ktmap.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:13 $
 * 
 * Texture map key bindings.
 * 
 * $Log: ktmap.c,v $
 * Revision 1.1  1998/08/11 14:33:13  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:29  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: ktmap.c,v 1.1 1998/08/11 14:33:13 nobody Exp $";
