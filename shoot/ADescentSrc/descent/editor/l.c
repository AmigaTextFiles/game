...
*/
/*
 * $Source: /usr/CVS/descent/editor/l.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:16 $
 * 
 * Routines for displaying texture pages
 * 
 * $Log: l.c,v $
 * Revision 1.1  1998/08/11 14:33:16  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:33  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: l.c,v 1.1 1998/08/11 14:33:16 nobody Exp $";
