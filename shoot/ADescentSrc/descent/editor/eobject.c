...
*/
/*
 * $Source: /usr/CVS/descent/editor/eobject.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:48 $
 * 
 * Editor object functions.
 * 
 * $Log: eobject.c,v $
 * Revision 1.1  1998/08/11 14:32:48  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:01:56  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: eobject.c,v 1.1 1998/08/11 14:32:48 nobody Exp $";
