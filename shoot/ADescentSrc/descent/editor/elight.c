...
*/
/*
 * $Source: /usr/CVS/descent/editor/elight.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:46 $
 * 
 * Editor lighting functions.
 * 
 * $Log: elight.c,v $
 * Revision 1.1  1998/08/11 14:32:46  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:01:54  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: elight.c,v 1.1 1998/08/11 14:32:46 nobody Exp $";
