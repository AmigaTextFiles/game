...
*/
/*
 * $Source: /usr/CVS/descent/editor/khelp.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:06 $
 *
 * Functions for showing help.
 *
 * $Log: khelp.c,v $
 * Revision 1.1  1998/08/11 14:33:06  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:18  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: khelp.c,v 1.1 1998/08/11 14:33:06 nobody Exp $";
