...
*/
/*
 * $Source: /usr/CVS/descent/editor/meddraw.c,v $
 * $Revision: 1.2 $
 * $Author: nobody $
 * $Date: 1998/09/26 15:07:27 $
 * 
 * Med drawing functions.
 * 
 * $Log: meddraw.c,v $
 * Revision 1.2  1998/09/26 15:07:27  nobody
 * Added Warp3D support
 *
 * Revision 1.1  1998/08/11 14:33:24  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:44  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: meddraw.c,v 1.2 1998/09/26 15:07:27 nobody Exp $";
...
#define MAX_EDGES (MAX_VERTICES*4)*8
