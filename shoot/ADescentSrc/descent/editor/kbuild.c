...
*/
/*
 * $Source: /usr/CVS/descent/editor/kbuild.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:58 $
 *
 * Functions for building parts of mines.
 *
 * $Log: kbuild.c,v $
 * Revision 1.1  1998/08/11 14:32:58  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:10  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: kbuild.c,v 1.1 1998/08/11 14:32:58 nobody Exp $";
...
{
	if (!Markedsegp)
		diagnostic_message("Marked segment not set -- unable to create bridge.");
	else if (!med_form_bridge_segment(Cursegp,Curside,Markedsegp,Markedside)) {
