...
*/
/*
 * $Source: /usr/CVS/descent/editor/mine.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:32 $
 * 
 * Mine specific editing functions, such as load_mine, save_mine
 * 
 * $Log: mine.c,v $
 * Revision 1.1  1998/08/11 14:33:32  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:55  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: mine.c,v 1.1 1998/08/11 14:33:32 nobody Exp $";
