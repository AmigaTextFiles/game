...
*/
/*
 * $Source: /usr/CVS/descent/editor/eglobal.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:42 $
 *
 * Globals for editor.
 *
 * $Log: eglobal.c,v $
 * Revision 1.1  1998/08/11 14:32:42  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:01:48  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: eglobal.c,v 1.1 1998/08/11 14:32:42 nobody Exp $";
