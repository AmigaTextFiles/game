...
*/
/*
 * $Source: /usr/CVS/descent/editor/medsel.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:29 $
 * 
 * Routines stripped from med.c for segment selection
 * 
 * $Log: medsel.c,v $
 * Revision 1.1  1998/08/11 14:33:29  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:51  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: medsel.c,v 1.1 1998/08/11 14:33:29 nobody Exp $";
