...
*/
/*
 * $Source: /usr/CVS/descent/editor/func.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:53 $
 * 
 * .
 * 
 * $Log: func.c,v $
 * Revision 1.1  1998/08/11 14:32:53  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:03  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: func.c,v 1.1 1998/08/11 14:32:53 nobody Exp $";
