...
*/
/*
 * $Source: /usr/CVS/descent/editor/macro.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:20 $
 * 
 * Routines for recording/playing/saving macros
 * 
 * $Log: macro.c,v $
 * Revision 1.1  1998/08/11 14:33:20  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:39  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: macro.c,v 1.1 1998/08/11 14:33:20 nobody Exp $";
