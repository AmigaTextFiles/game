...
*/
/*
 * $Source: /usr/CVS/descent/editor/ksegmove.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:09 $
 *
 * Functions for moving segments.
 *
 * $Log: ksegmove.c,v $
 * Revision 1.1  1998/08/11 14:33:09  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:23  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: ksegmove.c,v 1.1 1998/08/11 14:33:09 nobody Exp $";
