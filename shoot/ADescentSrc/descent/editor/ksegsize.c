...
*/
/*
 * $Source: /usr/CVS/descent/editor/ksegsize.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:12 $
 *
 * Functions for sizing segments
 *
 * $Log: ksegsize.c,v $
 * Revision 1.1  1998/08/11 14:33:12  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:27  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: ksegsize.c,v 1.1 1998/08/11 14:33:12 nobody Exp $";
