...
*/
/*
 * $Source: /usr/CVS/descent/editor/med.c,v $
 * $Revision: 1.2 $
 * $Author: nobody $
 * $Date: 1998/09/26 15:07:16 $
 *
 * Editor loop for Inferno
 *
 * $Log: med.c,v $
 * Revision 1.2  1998/09/26 15:07:16  nobody
 * Added Warp3D support
 *
 * Revision 1.1  1998/08/11 14:33:22  nobody
 * Moved editor directory to root
 *
 * Revision 1.3  1998/08/09 23:05:00  tfrieden
 * Too much changed to mention here
 *
 * Revision 1.2  1998/08/08 16:02:41  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: med.c,v 1.2 1998/09/26 15:07:16 nobody Exp $";
...
void medkey_init()
{
	...
	if (keyfile)
	{
		while (2 == fscanf( keyfile, "%s %s", keypress, LispCommand ))
		{
			if (strlen(keypress) < 2) break;
