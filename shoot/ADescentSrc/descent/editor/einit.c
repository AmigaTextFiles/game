...
*/
/*
 * $Source: /usr/CVS/descent/editor/einit.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:45 $
 *
 * Initialization routines for editor.
 *
 * $Log: einit.c,v $
 * Revision 1.1  1998/08/11 14:32:45  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:01:52  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: einit.c,v 1.1 1998/08/11 14:32:45 nobody Exp $";
