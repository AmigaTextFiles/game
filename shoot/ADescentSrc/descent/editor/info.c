...
*/
/*
 * $Source: /usr/CVS/descent/editor/info.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:57 $
 * 
 * Print debugging info in ui.
 * 
 * $Log: info.c,v $
 * Revision 1.1  1998/08/11 14:32:57  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:08  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: info.c,v 1.1 1998/08/11 14:32:57 nobody Exp $";
