...
*/
 /*
 * $Source: /usr/CVS/descent/editor/seguvs.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:38 $
 * 
 * u,v coordinate computation for segment faces
 * 
 * $Log: seguvs.c,v $
 * Revision 1.1  1998/08/11 14:33:38  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:03:03  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: seguvs.c,v 1.1 1998/08/11 14:33:38 nobody Exp $";
