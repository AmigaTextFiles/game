...
*/
/*
 * $Source: /usr/CVS/descent/editor/kview.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:15 $
 *
 * Functions for changing viewer's position
 *
 * $Log: kview.c,v $
 * Revision 1.1  1998/08/11 14:33:15  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:31  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: kview.c,v 1.1 1998/08/11 14:33:15 nobody Exp $";
