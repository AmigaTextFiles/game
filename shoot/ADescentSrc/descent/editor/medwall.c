...
*/
/*
 * $Source: /usr/CVS/descent/editor/medwall.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:30 $
 * 
 * Created from version 1.11 of main\wall.c
 * 
 * $Log: medwall.c,v $
 * Revision 1.1  1998/08/11 14:33:30  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:53  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: medwall.c,v 1.1 1998/08/11 14:33:30 nobody Exp $";
