...
*/
/*
 * $Source: /usr/CVS/descent/editor/ksegsel.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:10 $
 *
 * Functions for selecting segments
 *
 * $Log: ksegsel.c,v $
 * Revision 1.1  1998/08/11 14:33:10  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:25  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: ksegsel.c,v 1.1 1998/08/11 14:33:10 nobody Exp $";
