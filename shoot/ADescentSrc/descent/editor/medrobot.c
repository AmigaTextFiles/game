...
*/
/*
 * $Source: /usr/CVS/descent/editor/medrobot.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:27 $
 * 
 * Dialog box to edit robot properties.
 * 
 * $Log: medrobot.c,v $
 * Revision 1.1  1998/08/11 14:33:27  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:48  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: medrobot.c,v 1.1 1998/08/11 14:33:27 nobody Exp $";
