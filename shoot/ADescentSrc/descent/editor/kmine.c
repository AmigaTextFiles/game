...
*/
/*
 * $Source: /usr/CVS/descent/editor/kmine.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:07 $
 *
 * Functions to change entire mines.
 *
 * $Log: kmine.c,v $
 * Revision 1.1  1998/08/11 14:33:07  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:20  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: kmine.c,v 1.1 1998/08/11 14:33:07 nobody Exp $";
