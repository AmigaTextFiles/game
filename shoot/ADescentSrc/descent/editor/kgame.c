...
*/
/*
 * $Source: /usr/CVS/descent/editor/kgame.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:03 $
 * 
 * Game Loading editor functions
 * 
 * $Log: kgame.c,v $
 * Revision 1.1  1998/08/11 14:33:03  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:16  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: kgame.c,v 1.1 1998/08/11 14:33:03 nobody Exp $";
