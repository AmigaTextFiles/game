...
*/
/*
 * $Source: /usr/CVS/descent/editor/autosave.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:39 $
 * 
 * Autosave system: 
 * Saves current mine to disk to prevent loss of work, and support undo.
 * 
 * $Log: autosave.c,v $
 * Revision 1.1  1998/08/11 14:32:39  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:01:42  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: autosave.c,v 1.1 1998/08/11 14:32:39 nobody Exp $";
