...
*/
/*
 * $Source: /usr/CVS/descent/editor/fixseg.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:51 $
 * 
 * Functions to make faces planar and probably other things.
 * 
 * $Log: fixseg.c,v $
 * Revision 1.1  1998/08/11 14:32:51  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:01  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: fixseg.c,v 1.1 1998/08/11 14:32:51 nobody Exp $";
