...
*/
/*
 * $Source: /usr/CVS/descent/editor/kfuncs.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:01 $
 * 
 * .
 * 
 * $Log: kfuncs.c,v $
 * Revision 1.1  1998/08/11 14:33:01  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:02:14  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: kfuncs.c,v 1.1 1998/08/11 14:33:01 nobody Exp $";
