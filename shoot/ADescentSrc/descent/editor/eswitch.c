...
*/
/*
 * $Source: /usr/CVS/descent/editor/eswitch.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:50 $
 * 
 * Editor switch functions. 
 * 
 * $Log: eswitch.c,v $
 * Revision 1.1  1998/08/11 14:32:50  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:01:59  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: eswitch.c,v 1.1 1998/08/11 14:32:50 nobody Exp $";
