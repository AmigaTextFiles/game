...
*/
/*
 * $Source: /usr/CVS/descent/editor/texture.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:33:42 $
 * 
 * Texture map assignment.
 * 
 * $Log: texture.c,v $
 * Revision 1.1  1998/08/11 14:33:42  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:03:08  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: texture.c,v 1.1 1998/08/11 14:33:42 nobody Exp $";
