...
*/
/*
 * $Source: /usr/CVS/descent/editor/centers.c,v $
 * $Revision: 1.1 $
 * $Author: nobody $
 * $Date: 1998/08/11 14:32:40 $
 * 
 * Dialog box stuff for control centers, material centers, etc.
 * 
 * $Log: centers.c,v $
 * Revision 1.1  1998/08/11 14:32:40  nobody
 * Moved editor directory to root
 *
 * Revision 1.2  1998/08/08 16:01:44  nobody
 * Activated Editor
 *
...
static char rcsid[] = "$Id: centers.c,v 1.1 1998/08/11 14:32:40 nobody Exp $";
