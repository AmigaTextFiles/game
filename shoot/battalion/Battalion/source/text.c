...
static    float summaryBox[4][3] = {
    ...
    glPushMatrix();
        ...
        if (killfighters > 1)
                sprintf(textline,  "%1d Fighters", killfighters);
        else
                sprintf(textline,  "%1d Fighter", killfighters);
        tkDrawStr(strokeBase, textline);
    glPopMatrix();
        }
    ...
    glPushMatrix();
        ...
        if (killtanks > 1)
                sprintf(textline,  "%1d Tanks", killtanks);
        else
                sprintf(textline,  "%1d Tank", killtanks);
        tkDrawStr(strokeBase, textline);
    glPopMatrix();
        }
    ...
    glPushMatrix();
        ...
        if (killlaunchers > 1)
                sprintf(textline,  "%1d Launchers", killlaunchers);
        else
                sprintf(textline,  "%1d Launcher", killlaunchers);
        tkDrawStr(strokeBase, textline);
    glPopMatrix();
        }
    ...
    glPushMatrix();
        ...
        if (killhelos > 1)
                sprintf(textline,  "%1d Helos", killhelos);
        else
                sprintf(textline,  "%1d Helo", killhelos);
        tkDrawStr(strokeBase, textline);
    glPopMatrix();
        }
    ...
    glPushMatrix();
        ...
        if (killmtanks > 1)
                sprintf(textline,  "%1d Masers", killmtanks);
        else
                sprintf(textline,  "%1d Maser", killmtanks);
        tkDrawStr(strokeBase, textline);
    glPopMatrix();
        }
    ...
    glPushMatrix();
        ...
        if (killplanes > 1)
                sprintf(textline,  "%1d Bombers", killplanes);
        else
                sprintf(textline,  "%1d Bomber", killplanes);
        tkDrawStr(strokeBase, textline);
    glPopMatrix();
        }
    ...
    glPushMatrix();
        ...
        if (killmechags > 1)
                sprintf(textline,  "%1d MechaGs", killmechags);
        else
                sprintf(textline,  "%1d MechaG", killmechags);
        tkDrawStr(strokeBase, textline);
    glPopMatrix();
        }
    ...
    glPushMatrix();
        ...
        if (killCHHs > 1)
                sprintf(textline,  "%1d Hunters", killCHHs);
        else
                sprintf(textline,  "%1d Hunter", killCHHs);
        tkDrawStr(strokeBase, textline);
    glPopMatrix();
        }
    ...
    glPushMatrix();
        ...
        if (killheros > 1)
                sprintf(textline,  "%1d Heros", killheros);
        else
                sprintf(textline,  "%1d Hero", killheros);
        tkDrawStr(strokeBase, textline);
    glPopMatrix();
        }
