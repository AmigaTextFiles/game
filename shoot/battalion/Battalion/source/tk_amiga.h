...
#define TK_DOWN                 0x28
#define TK_DEL                  0x7f
#define TK_SHIFT_L              0x100
#define TK_SHIFT_R              0x101
#define TK_CONTROL_L            0x102
#define TK_ALT_L                0x104
#define TK_ALT_R                0x105
#define TK_A                    'A'
#define TK_B                    'B'
#define TK_C                    'C'
#define TK_D                    'D'
...
extern void tkKeyUpFunc(GLenum (*)(int, GLenum));
