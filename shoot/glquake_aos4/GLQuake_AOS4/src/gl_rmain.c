...
cvar_t  r_skybox = {"r_skybox", "1", true};
...
void R_RenderView (void)
{
  ...
  static GLfloat colors[4] = {(GLfloat) 0.5, (GLfloat) 0.5, (GLfloat) 0.5, (GLfloat) 0.10};
...
****** Use r_fullbright if you enable ******/
  if (gl_fog.value) {
     ...
     //glFogf(GL_FOG_START, 25600.0);
     //glFogf(GL_FOG_END, 5120000.0);
