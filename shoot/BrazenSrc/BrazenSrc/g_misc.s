...
.L186:
	...
	cmpwi 0,9,0
	bc 12,2,.L187
	lis 9,func_explosive_activate@ha
	la 9,func_explosive_activate@l(9)
	b .L196
.L188:
	lwz 9,300(31)
	li 0,3
...
.L212:
	...
	stw 9,456(31)
	lis 10,barrel_start@ha
	li 0,1
	stw 11,444(31)
	la 10,barrel_start@l(10)
	li 9,1024
	stw 0,512(31)
	lis 11,level+4@ha
	lis 8,.LC91@ha
...
.Lfe23:
	...
	.align 2
.LC163:
	.string	"models/objects/core/tris.md2"
	.section	".text"
	.align 2
...
.Lfe45:
	...
	.align 2
	.globl func_explosive_activate
	.type	 func_explosive_activate,@function
func_explosive_activate:
	stwu 1,-32(1)
	mflr 0
	stmw 29,20(1)
	stw 0,36(1)
...
.L176:
	...
	blr
.Lfe46:
	.size	 func_explosive_activate,.Lfe46-func_explosive_activate
	.align 2
...
.LC193:
	...
	.align 2
	.globl barrel_think
	.type	 barrel_think,@function
barrel_think:
	stwu 1,-32(1)
	mflr 0
	stmw 28,16(1)
	stw 0,36(1)
	lis 9,barrel_think@ha
	mr 29,3
	la 9,barrel_think@l(9)
	lis 28,level@ha
	la 28,level@l(28)
	stw 9,436(29)
	lis 11,.LC192@ha
	...
	blr
.Lfe50:
	.size	 barrel_think,.Lfe50-barrel_think
	.section	".rodata"
	.align 3
.LC194:
	.long 0x3fb99999
...
barrel_start:
	...
	blr
.Lfe51:
	.size	 barrel_start,.Lfe51-barrel_start
	.align 2
...
.Lfe84:
	...
	.align 2
	.globl misc_nuke_core_use
	.type	 misc_nuke_core_use,@function
misc_nuke_core_use:
	lwz 0,184(3)
	andi. 9,0,1
	bc 12,2,.L357
...
.L357:
	...
	blr
.Lfe85:
	.size	 misc_nuke_core_use,.Lfe85-misc_nuke_core_use
	.align 2
	.globl SP_misc_nuke_core
	.type	 SP_misc_nuke_core,@function
SP_misc_nuke_core:
	stwu 1,-32(1)
	mflr 0
	stmw 28,16(1)
	...
	mtlr 0
	blrl
	lis 9,misc_nuke_core_use@ha
	la 9,misc_nuke_core_use@l(9)
	stw 9,448(28)
	lwz 0,36(1)
	mtlr 0
	lmw 28,16(1)
	...
	blr
.Lfe86:
	.size	 SP_misc_nuke_core,.Lfe86-SP_misc_nuke_core
	.align 2
...
.L366:
	...
	blr
.Lfe87:
	.size	 light_use,.Lfe87-light_use
