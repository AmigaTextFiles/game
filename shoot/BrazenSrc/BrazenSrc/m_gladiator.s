...
.L51:
	...
	lis 26,gladiator_blocked@ha
	lis 25,GladiatorDMGAdjust@ha
	lis 8,0x4200
	li 7,400
	lis 9,0x4280
	stw 8,204(31)
	...
	la 26,gladiator_blocked@l(26)
	stw 7,400(31)
	la 25,GladiatorDMGAdjust@l(25)
	oris 24,24,0x2
	stw 5,816(31)
	lis 23,0xc200
	lis 0,0xc1c0
...
.L50:
	...
	blr
.Lfe1:
	.size	 SP_monster_gladiator,.Lfe1-SP_monster_gladiator
...
gladiator_idle:
	...
	blr
.Lfe2:
	.size	 gladiator_idle,.Lfe2-gladiator_idle
	.section	".rodata"
	.align 2
.LC21:
	.long 0x3f800000
...
gladiator_sight:
	...
	blr
.Lfe3:
	.size	 gladiator_sight,.Lfe3-gladiator_sight
	.section	".rodata"
	.align 2
.LC23:
	.long 0x3f800000
...
gladiator_search:
	...
	blr
.Lfe4:
	.size	 gladiator_search,.Lfe4-gladiator_search
	.section	".rodata"
	.align 2
.LC25:
	.long 0x3f800000
...
gladiator_cleaver_swing:
	...
	blr
.Lfe5:
	.size	 gladiator_cleaver_swing,.Lfe5-gladiator_cleaver_swing
	.align 2
...
gladiator_stand:
	...
	blr
.Lfe6:
	.size	 gladiator_stand,.Lfe6-gladiator_stand
	.align 2
...
gladiator_walk:
	...
	blr
.Lfe7:
	.size	 gladiator_walk,.Lfe7-gladiator_walk
	.align 2
	.globl gladiator_run
...
.L13:
	...
	blr
.Lfe8:
	.size	 gladiator_run,.Lfe8-gladiator_run
	.section	".rodata"
	.align 2
.LC27:
	.long 0x3f800000
...
.L17:
	...
	blr
.Lfe9:
	.size	 GaldiatorMelee,.Lfe9-GaldiatorMelee
	.align 2
...
gladiator_melee:
	...
	blr
.Lfe10:
	.size	 gladiator_melee,.Lfe10-gladiator_melee
	.align 2
	.globl GladiatorGun
...
GladiatorGun:
	...
	blr
.Lfe11:
	.size	 GladiatorGun,.Lfe11-GladiatorGun
	.section	".rodata"
	.align 2
.LC29:
	.long 0x42e00000
...
.L20:
	...
	blr
.Lfe12:
	.size	 gladiator_attack,.Lfe12-gladiator_attack
	.section	".rodata"
	.align 2
.LC33:
	.long 0x46fffe00
...
.L22:
	...
	blr
.Lfe13:
	.size	 gladiator_pain,.Lfe13-gladiator_pain
	.align 2
...
.Lfe15:
	...
	.align 2
	.globl GladiatorDMGAdjust
	.type	 GladiatorDMGAdjust,@function
GladiatorDMGAdjust:
	andi. 0,7,16
	li 10,0
	bc 12,2,.L45
...
.L45:
	...
	blr
.Lfe16:
	.size	 GladiatorDMGAdjust,.Lfe16-GladiatorDMGAdjust
	.section	".rodata"
	.align 3
.LC42:
	.long 0x3fa99999
...
.LC43:
	...
	.section	".text"
	.align 2
	.globl gladiator_blocked
	.type	 gladiator_blocked,@function
gladiator_blocked:
	stwu 1,-32(1)
	mflr 0
	stfd 31,24(1)
...
.L54:
	...
	blr
.Lfe17:
	.size	 gladiator_blocked,.Lfe17-gladiator_blocked
