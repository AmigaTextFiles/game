...
Use_Quad:
	...
	b .L159
.L158:
	lis 9,QuadDamageTime@ha
	lwz 10,QuadDamageTime@l(9)
.L159:
	lis 11,level@ha
	lwz 8,84(31)
	lwz 11,level@l(11)
...
Use_Invulnerability:
	...
	fcmpu 0,12,0
	bc 4,1,.L173
	lis 11,InvulnerabilityTime@ha
	lwz 0,InvulnerabilityTime@l(11)
	xoris 0,0,0x8000
	stw 0,28(1)
	stw 7,24(1)
	lfd 0,24(1)
...
Use_Breather:
	...
	fcmpu 0,12,0
	bc 4,1,.L165
	lis 11,RebreatherTime@ha
	lwz 0,RebreatherTime@l(11)
	xoris 0,0,0x8000
	stw 0,20(1)
	stw 8,16(1)
	lfd 0,16(1)
...
Use_Envirosuit:
	...
	fcmpu 0,12,0
	bc 4,1,.L169
	lis 11,EnvironmentSuitTime@ha
	lwz 0,EnvironmentSuitTime@l(11)
	xoris 0,0,0x8000
	stw 0,20(1)
	stw 8,16(1)
	lfd 0,16(1)
