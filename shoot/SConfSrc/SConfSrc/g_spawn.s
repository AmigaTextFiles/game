...
.LC126:
	...
	.ascii	"8 \tpic\t11 endif xr -42 yt 2 string Frags xr\t-50 yt 10 num"
	.ascii	" 3 14 if 17 yb -58 xv 116 stat_string 17 endif if 16 xr -34 "
	.ascii	"yt 50 string Time xr -50 yt 58 num 3 16 endif if 18 \txr\t-3"
	.ascii	"4  yt  98 \tstring Rank \txr\t-50  yt  108 num 3 18 endif if"
	.ascii	" 21 ifeq 21 1 \txr\t-42  yb  -58  string2 Cells \txr\t-50  y"
	.ascii	"b  -48  num 3 22 endif endif if 20 ifeq 20 1 xr -228 yb -118"
	.ascii	"  string2 \"ServerConfigMOD v3.2 DM\" xr -228 yb -108  strin"
	.ascii	"g2 \"http://quake2.com/sconfig\" xr -228 yb"
	.string	" -98  string2 \"sconfig@quake2.com\" xr -228 yb -78  string \"Type 'menu' or press key\" xr -228 yb -68  string \"bound to 'Inventory' to \" xr -228 yb -58  string \"toggle menu.\" endif endif if 19 \txr\t-58  yt  148  string Players \txr\t-50  yt  156 num 3 19 endif "
	.section	".sdata","aw"
	.align 2
