...
void M_Help_Draw (void)
{
  ...
  if (help_page)
    ...
    sprintf(vstr,"       Amiga Quake V%2.2f        ",(float)AMIGA_VERSION);
    M_DrawTextBox (16, 16, 34, 16);
    M_PrintWhite(32, 48,  vstr);
    M_Print     (32, 64,  " by Frank Wille, Steffen Haeuser");
    M_Print     (32, 72,  "       and Jarmo Laakkonen      ");
