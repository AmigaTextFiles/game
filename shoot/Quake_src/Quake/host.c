...
void Host_Init (quakeparms_t *parms)
{
  ...
  Key_Init ();
  Con_Init ();  
  Con_Printf ("\02Quake V%4.2f (%s)\n",AMIGA_VERSION,Sys_TargetName());
  Con_Printf ("\02Amiga port 2000-2005 by Frank Wille, Steffen Haeuser "
              "and Jarmo Laakkonen.\n");
  ...
  if (cls.state != ca_dedicated)
  {
    ...
    IN_Init();  /* IN_Init needs mode_screen initialized ! */
