...
.macro	glab	# global label definition
	.globl	_\1
_\1:
.endm

.macro	lab	# local label definition
_\1:
.endm

.macro	obj	# object type and size definition
        .type   _\1,@object
        .size   _\1,$-_\1
.endm
...
.macro	save	# firstGPR, frameOffset
.set	__reg,\1
.set	__off,\2
	.rept	32-\1
	stw	__reg,__off(r1)
...
.macro	restore	# firstGPR, frameOffset
.set	__reg,\1
.set	__off,\2
	.rept	32-\1
	lwz	__reg,__off(r1)
