##
## MorphOS Input interrupt routine for mouse control
##
## Translation of in_amigamouse68k.s into PPC code by Frank Wille
## @@@ The mouse button events are for PSX-device only ???
##

# from emul/emulinterface.h
.set	TRAP_LIB,0xff00
.set	REG_A0,32
.set	REG_A1,36
...
InputIntCode:
	.short	TRAP_LIB,0
	.long	InputIntCodeNative
InputIntCodeNative:
	lwz	r4,REG_A0(r2)		# input events from A0
	mr	r3,r4
	lwz	r5,REG_A1(r2)		# InputIntDat from A1
