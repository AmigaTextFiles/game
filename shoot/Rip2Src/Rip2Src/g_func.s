...
.L291:
	...
	blr
.Lfe15:
	.size	 Touch_DoorTrigger,.Lfe15-Touch_DoorTrigger
	.section	".rodata"
	.align 2
.LC61:
	.long 0x42700000
...
.L365:
	...
	blr
.Lfe17:
	.size	 door_blocked,.Lfe17-door_blocked
	.section	".rodata"
	.align 2
.LC63:
	.string	"%s"
...
RplatAngleMove_Done:
	...
	blr
.Lfe34:
	.size	 RplatAngleMove_Done,.Lfe34-RplatAngleMove_Done
	.align 2
...
.L110:
	...
	blr
.Lfe43:
	.size	 Touch_Plat_Center,.Lfe43-Touch_Plat_Center
	.align 2
...
rotating_blocked:
	...
	blr
.Lfe44:
	.size	 rotating_blocked,.Lfe44-rotating_blocked
	.section	".rodata"
	.align 2
.LC139:
	.long 0x0
...
.L142:
	...
	blr
.Lfe45:
	.size	 rotating_touch,.Lfe45-rotating_touch
	.align 2
	.globl rotating_use
...
.L146:
	...
	blr
.Lfe46:
	.size	 rotating_use,.Lfe46-rotating_use
	.align 2
	.globl button_done
...
button_done:
	...
	blr
.Lfe47:
	.size	 button_done,.Lfe47-button_done
	.section	".rodata"
	.align 2
.LC140:
	.long 0x0
...
.L174:
	...
	blr
.Lfe48:
	.size	 button_wait,.Lfe48-button_wait
	.align 2
	.globl button_use
...
button_use:
	...
	blr
.Lfe49:
	.size	 button_use,.Lfe49-button_use
	.align 2
	.globl button_touch
...
.L190:
	...
	blr
.Lfe50:
	.size	 button_touch,.Lfe50-button_touch
	.align 2
	.globl button_killed
...
button_killed:
	...
	blr
.Lfe51:
	.size	 button_killed,.Lfe51-button_killed
	.align 2
...
.L204:
	...
	blr
.Lfe52:
	.size	 door_use_areaportals,.Lfe52-door_use_areaportals
	.section	".rodata"
	.align 2
.LC141:
	.long 0x3f800000
...
.L211:
	...
	blr
.Lfe53:
	.size	 door_hit_top,.Lfe53-door_hit_top
	.section	".rodata"
	.align 2
.LC144:
	.long 0x3f800000
...
.L220:
	...
	blr
.Lfe54:
	.size	 door_hit_bottom,.Lfe54-door_hit_bottom
	.align 2
	.globl door_use
...
.L331:
	...
	blr
.Lfe56:
	.size	 Think_CalcMoveSpeed,.Lfe56-Think_CalcMoveSpeed
	.align 2
	.globl door_killed
