...
G_PointEntity:
	...
	blr
.Lfe18:
	.size	 G_PointEntity,.Lfe18-G_PointEntity
	.align 2
	.globl G_ImpactEntity
	.type	 G_ImpactEntity,@function
G_ImpactEntity:
	stwu 1,-48(1)
	mflr 0
	stmw 25,20(1)
	...
	blr
.Lfe19:
	.size	 G_ImpactEntity,.Lfe19-G_ImpactEntity
	.align 2
	.globl G_LineEntity
	.type	 G_LineEntity,@function
G_LineEntity:
	stwu 1,-48(1)
	mflr 0
	stmw 24,16(1)
	...
	blr
.Lfe20:
	.size	 G_LineEntity,.Lfe20-G_LineEntity
	.align 2
	.globl G_SplashEntity
	.type	 G_SplashEntity,@function
G_SplashEntity:
	stwu 1,-48(1)
	mflr 0
	stmw 23,12(1)
	...
	blr
.Lfe21:
	.size	 G_SplashEntity,.Lfe21-G_SplashEntity
	.align 2
	.globl G_TraceEntity
	.type	 G_TraceEntity,@function
G_TraceEntity:
	stwu 1,-48(1)
	mflr 0
	stmw 23,12(1)
	...
	blr
.Lfe22:
	.size	 G_TraceEntity,.Lfe22-G_TraceEntity
	.align 2
	.globl muzzleflash
	.type	 muzzleflash,@function
muzzleflash:
	stwu 1,-32(1)
	mflr 0
	stmw 29,20(1)
...
.L168:
	...
	blr
.Lfe23:
	.size	 muzzleflash,.Lfe23-muzzleflash
	.align 2
	.globl Think_Delay
...
Think_Delay:
	...
	blr
.Lfe24:
	.size	 Think_Delay,.Lfe24-Think_Delay
	.align 2
	.globl entdist
