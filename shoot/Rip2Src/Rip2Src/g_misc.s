...
.LC100:
	...
	.align 2
.LC103:
	.string	"models/banner_bl/tris.md2"
	.align 2
.LC105:
...
.L223:
	...
	li 6,2
	lwz 10,776(31)
	lis 11,misc_deadsoldier_die@ha
	lis 7,0x4180
	stw 0,196(31)
	lis 29,0xc180
	la 11,misc_deadsoldier_die@l(11)
	li 0,200
	stw 6,492(31)
	ori 9,9,6
	ori 10,10,256
...
.LC202:
	...
	.section	".text"
	.align 2
	.globl SP_misc_blue_banner
	.type	 SP_misc_blue_banner,@function
SP_misc_blue_banner:
	stwu 1,-32(1)
	mflr 0
	stmw 28,16(1)
	...
	blr
.Lfe64:
	.size	 SP_misc_blue_banner,.Lfe64-SP_misc_blue_banner
	.section	".rodata"
	.align 2
.LC203:
	.long 0x3f800000
...
.L213:
	...
	blr
.Lfe65:
	.size	 misc_deadsoldier_die,.Lfe65-misc_deadsoldier_die
	.align 2
...
misc_viper_use:
	...
	blr
.Lfe66:
	.size	 misc_viper_use,.Lfe66-misc_viper_use
	.align 2
...
SP_misc_bigviper:
	...
	blr
.Lfe67:
	.size	 SP_misc_bigviper,.Lfe67-SP_misc_bigviper
	.section	".rodata"
	.align 3
.LC205:
	.long 0x43300000
...
misc_viper_bomb_touch:
	...
	blr
.Lfe68:
	.size	 misc_viper_bomb_touch,.Lfe68-misc_viper_bomb_touch
	.section	".rodata"
	.align 3
.LC207:
	.long 0xbff00000
...
.L240:
	...
	blr
.Lfe69:
	.size	 misc_viper_bomb_prethink,.Lfe69-misc_viper_bomb_prethink
	.align 2
...
misc_viper_bomb_use:
	...
	blr
.Lfe70:
	.size	 misc_viper_bomb_use,.Lfe70-misc_viper_bomb_use
	.align 2
...
.L243:
	...
	blr
.Lfe71:
	.size	 SP_misc_viper_bomb,.Lfe71-SP_misc_viper_bomb
	.align 2
...
misc_strogg_ship_use:
	...
	blr
.Lfe72:
	.size	 misc_strogg_ship_use,.Lfe72-misc_strogg_ship_use
	.section	".rodata"
	.align 3
.LC211:
	.long 0x3fb99999
...
misc_satellite_dish_think:
	...
	blr
.Lfe73:
	.size	 misc_satellite_dish_think,.Lfe73-misc_satellite_dish_think
	.section	".rodata"
	.align 3
.LC212:
	.long 0x3fb99999
...
misc_satellite_dish_use:
	...
	blr
.Lfe74:
	.size	 misc_satellite_dish_use,.Lfe74-misc_satellite_dish_use
	.align 2
...
SP_misc_satellite_dish:
	...
	blr
.Lfe75:
	.size	 SP_misc_satellite_dish,.Lfe75-SP_misc_satellite_dish
	.align 2
...
SP_light_mine1:
	...
	blr
.Lfe76:
	.size	 SP_light_mine1,.Lfe76-SP_light_mine1
	.align 2
...
SP_light_mine2:
	...
	blr
.Lfe77:
	.size	 SP_light_mine2,.Lfe77-SP_light_mine2
	.align 2
...
SP_target_character:
	...
	blr
.Lfe78:
	.size	 SP_target_character,.Lfe78-SP_target_character
	.align 2
...
.L260:
	...
	blr
.Lfe79:
	.size	 target_string_use,.Lfe79-target_string_use
	.align 2
...
.L273:
	...
	blr
.Lfe80:
	.size	 SP_target_string,.Lfe80-SP_target_string
	.align 2
...
.L304:
	...
	blr
.Lfe81:
	.size	 func_clock_use,.Lfe81-func_clock_use
	.align 2
...
SP_misc_teleporter_dest:
	...
	blr
.Lfe82:
	.size	 SP_misc_teleporter_dest,.Lfe82-SP_misc_teleporter_dest
	.align 2
...
SP_monster_berserk:
	...
	blr
.Lfe83:
	.size	 SP_monster_berserk,.Lfe83-SP_monster_berserk
	.align 2
