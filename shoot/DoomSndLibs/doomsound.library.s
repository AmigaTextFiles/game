...
;		length.
;	Sfx_Update - pass in new settings for a sfx.
...
;	Sfx_StartLoop - pass in new sound effect to play with loop.
;		a0 = wave, d0 = cnum, d1 = pitch, d2 = vol, d3 = sep,
;		d4 = length, d5 = loop point or -1 for no looping.
;	Sfx_UpdatePitch - pass in new pitch setting for a sfx.
;		d0 = cnum, d1 = pitch.
;	Sfx_UpdateVol - pass in new volume setting for a sfx.
;		d0 = cnum, d2 = vol, d3 = sep.
;
;------------------------------------------------------------------------
...
FuncTable	dc.l	OpenLib		; -6
		...
		dc.l	Sfx_StartLoop	; -108
		dc.l	Sfx_UpdatePitch	; -114
		dc.l	Sfx_UpdateVol	; -120
...
;--------------------------------------------------------------------
		...
		dc.b	'16 channels of music can be playing at any time.',0
...
Sfx_Update	bsr	Sfx_UpdatePitch

Sfx_UpdateVol	movem.l	d2-d4,-(a7)
		lea	sfxVoiceTbl,a1
...
Mus_Register	movem.l	d1-d7/a0-a6,-(sp)
		...
		move.l	#MEMF_CLEAR+MEMF_PUBLIC,d0	    ; any memory
...
Sfx_StartLoop	movem.l	d2-d4,-(a7)
		lea	sfxVoiceTbl,a1
		movea.l	(a1,d0.w*4),a1
		lea	8(a0),a0
		subq.l	#8,d4
...
Sfx_UpdatePitch	lea	sfxVoiceTbl,a1
		movea.l	(a1,d0.w*4),a1
		swap	d1
		clr.w	d1
		divu.l	#11025,d1
