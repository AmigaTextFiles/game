/* $Id: fragment.c,v 1.61 2004/08/15 02:52:41 oohara Exp $ */
             ...
             int life)
{
  ...
  /* list of count
   * [0] size of fragment
   * [1] number of fragment
   * [2] color
   * [3] life
   * [4] time passed
   */
  count[0] = size_fragment;
  count[1] = number_fragment;
  count[2] = color;
  count[3] = life;
  count[4] = 0;
  ...
  new = tenm_object_new("fragment", 0, 0, 0, x, y,
                        5, count, 4 + 12 * number_fragment, count_d,
                        0, NULL,
