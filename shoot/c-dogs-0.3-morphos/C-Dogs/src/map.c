...
-------------------------------------------------------------------------------
 ...
 Rev:    $Revision: 61 $
 URL:    $HeadURL: svn://svn.icculus.org/cdogs-sdl/tags/cdogs-sdl-0.3/src/map.c $
 ID:     $Id: map.c 61 2006-08-14 07:35:20Z lmartinking $
...
#ifdef __MORPHOS__
		srand(clock());
		*x = rand() % gMission.missionData->mapWidth;
#else
...
#ifdef __MORPHOS__
		*y = rand() % gMission.missionData->mapHeight;
#else
