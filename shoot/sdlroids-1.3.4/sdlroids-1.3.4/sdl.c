...
#include "config.h"
RCSID("$Id: sdl.c,v 1.16 2001/03/27 22:08:16 neotron Exp $");
...
void init_graphics(int *palrgb)
{
  ...
  SDL_WM_SetCaption("SDLRoids " VERSION " - Aros port by Tito of Amigang", "SDLRoids");
