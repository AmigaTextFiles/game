...
#if defined(WARPUP) || defined(MORPHOS)
...
INLINE void _BeginIO(struct IORequest *ioRequest)
{
	...
	Caos.reg_a1 = (ULONG) ioRequest;
	Caos.reg_a6 = (ULONG) ioRequest->io_Device;
...
/*
Replacement for the ppc.library function
Yeah, I'm a lazy typer ;)
*/
#ifdef WARPUP
static INLINE ULONG PPCCallM68k(struct Caos *MyCaos)
{
	struct PPCArgs args;
	args.PP_Code = (APTR)MyCaos->caos_Un.Offset;
	args.PP_Offset = 0;
	args.PP_Flags = 0;
	args.PP_Stack = NULL;
	args.PP_StackSize = 0;
	args.PP_Regs[PPREG_D0] = MyCaos->d0;
	args.PP_Regs[PPREG_D1] = MyCaos->d1;
	args.PP_Regs[PPREG_D2] = MyCaos->d2;
	args.PP_Regs[PPREG_D3] = MyCaos->d3;
	args.PP_Regs[PPREG_D4] = MyCaos->d4;
	args.PP_Regs[PPREG_D5] = MyCaos->d5;
	args.PP_Regs[PPREG_D6] = MyCaos->d6;
	args.PP_Regs[PPREG_D7] = MyCaos->d7;
	args.PP_Regs[PPREG_A0] = MyCaos->a0;
	args.PP_Regs[PPREG_A1] = MyCaos->a1;
	args.PP_Regs[PPREG_A2] = MyCaos->a2;
	args.PP_Regs[PPREG_A3] = MyCaos->a3;
	args.PP_Regs[PPREG_A4] = MyCaos->a4;
	args.PP_Regs[PPREG_A5] = MyCaos->a5;
	Run68K(&args);
...
{
	struct EmulCaos Caos;
	Caos.caos_Un.Offset = MyCaos->caos_Un.Offset;
	Caos.reg_d0 = MyCaos->d0;
	Caos.reg_d1 = MyCaos->d1;
	Caos.reg_d2 = MyCaos->d2;
	Caos.reg_d3 = MyCaos->d3;
	Caos.reg_d4 = MyCaos->d4;
	Caos.reg_d5 = MyCaos->d5;
	Caos.reg_d6 = MyCaos->d6;
	Caos.reg_d7 = MyCaos->d7;
	Caos.reg_a0 = MyCaos->a0;
	Caos.reg_a1 = MyCaos->a1;
	Caos.reg_a2 = MyCaos->a2;
	Caos.reg_a3 = MyCaos->a3;
	Caos.reg_a4 = MyCaos->a4;
	Caos.reg_a5 = MyCaos->a5;
	return (ULONG)(*MyEmulHandle->EmulCallOS)(&Caos);
}
#endif
...
static INLINE void Sfx_SetVol(int vol)
{
struct Caos	MyCaos;
...
static INLINE void Sfx_Start(char *wave, int cnum, int step, int vol, int sep, int length)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHALL;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE void Sfx_Update(int cnum, int step, int vol, int sep)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHNO;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE void Sfx_Stop(int cnum)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHNO;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE int Sfx_Done(int cnum)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHNO;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE void Mus_SetVol(int vol)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHNO;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE int Mus_Register(void *musdata)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHALL;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE void Mus_Unregister(int handle)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHNO;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE void Mus_Play(int handle, int looping)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHNO;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE void Mus_Stop(int handle)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHNO;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE void Mus_Pause(int handle)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHNO;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE void Mus_Resume(int handle)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHNO;
//	MyCaos.M68kStart		=	NULL;
...
static INLINE int MUS_Done(int handle)
{
struct Caos	MyCaos;
	MyCaos.M68kCacheMode		=	IF_CACHEFLUSHNO;
//	MyCaos.M68kStart		=	NULL;
...
void I_InitSound (void)
{
  ...
  if (DoomSndBase == NULL) {
    ...
    if ((audio_mp = CreateMsgPort ()) == NULL ||
      ...
      I_Error ("CreateMsgPort() or AllocMem() failed");
