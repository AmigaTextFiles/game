...
staticvar fix scan[768][2];							/* TODO: remove global calling */
staticvar vec1D tmap[9];

/*
 * NOTE: subdivision of 16 is a really hard thing, it works most,
 *       but you can see sometimes curved textures
 ...
 * splits the planes at every intersection of two polygons, that
...
#ifdef	DRIVER_8BIT
#include "draw-orig8.c"
#include "draw-orig8flat.c"
#include "draw-orig8wire.c"
#endif
#ifdef	DRIVER_16BIT
#include "draw-orig16.c"
#endif
#ifdef	DRIVER_24BIT
#include "draw-orig24.c"
#endif
#ifdef	DRIVER_32BIT
#endif
