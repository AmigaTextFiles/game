 ...
 *
 */
staticfnc void draw_spans24(int y, int ey)
{
...
#ifdef	USE_ZBUFFER
      draw_affine24(slen + 1, pBuffer, zBuffer, u, v, w, du, dv, dw);	/* for the last pixel the du and dv are thrown away */
#else
      draw_affine24(slen + 1, pBuffer, u, v, du, dv);		/* for the last pixel the du and dv are thrown away */
#endif
    }
