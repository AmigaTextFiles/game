...
.LC10:
	...
	.align 2
.LC11:
	.string	"KOTS Lives has completed.\n"
	.align 2
.LC12:
	.long 0x0
	.align 2
...
.L91:
	...
	cmpwi 0,0,0
	bc 12,2,.L90
	lwz 9,kots_lives@l(31)
	lfs 0,20(9)
	fcmpu 0,0,11
	bc 4,2,.L93
	lwz 0,920(10)
	lwz 11,fraglimit@l(27)
	xoris 0,0,0x8000
	stw 0,20(1)
	stw 3,16(1)
	lfd 0,16(1)
...
DLL_ImportSymbols:
	...
	.comm	dedicated,4,4
	.comm	kots_password,4,4
	.comm	kots_datapath,4,4
	.comm	kots_realtime,4,4
	.comm	kots_levelmin,4,4
	.comm	kots_levelmax,4,4
	.comm	kots_teamplay,4,4
	.comm	kots_skin1,4,4
	.comm	kots_skin2,4,4
	.comm	kots_lives,4,4
	.comm	kots_port,4,4
	.comm	kots_game,4,4
	.comm	kots_version,4,4
	.comm	filterban,4,4
	.comm	sv_gravity,4,4
