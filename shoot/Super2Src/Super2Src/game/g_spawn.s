...
.LC131:
	...
	.ascii	"xv\t246 \tnum\t2\t10 \txv\t296 \tpic\t9 endif if 22        x"
	.ascii	"l      2        yb      -126        num     3       23      "
	.ascii	"  yb      -102        pic     22 endif if 26 yb -104 xl 0 pi"
	.ascii	"c 26 endif if 24        xl      2        yb      -78        "
	.ascii	"num     3       25        yb      -54        pic     24 endi"
	.ascii	"f if 27 yb -56 xl 0 pic 27 endif if 20        yb      -78   "
	.ascii	"     xr      -58        num     2       21        xr      -2"
	.ascii	"4        pic     20 endif if 18        yb      -102   "
	.string	"     xr      -58        num     2       19        xr      -24        pic     18 endif if 16        yb      -126        xr      -58        num     2       17        xr      -24        pic     16 endif \tyb\t-50 if 11 \txv\t148 \tpic\t11 endif xr\t-50 yt 2 num 3 14"
	.section	".sdata","aw"
	.align 2
...
.LC186:
	...
	.align 2
.LC187:
	.string	"models/super2/invis/tris.md2"
	.align 2
.LC188:
	.string	"models/cripple/tris.md2"
	.align 2
.LC189:
	.string	"models/robot/tris.md2"
	.align 2
.LC190:
	.string	"m"
	.align 2
...
hunt_precache:
	...
	blr
.Lfe6:
	.size	 hunt_precache,.Lfe6-hunt_precache
	.comm	v_forward,12,4
	.comm	v_right,12,4
	.comm	v_up,12,4
...
.L6:
	...
	blr
.Lfe7:
	.size	 ED_CallSpawn,.Lfe7-ED_CallSpawn
	.align 2
	.globl ED_NewString
...
.L23:
	...
	blr
.Lfe8:
	.size	 ED_NewString,.Lfe8-ED_NewString
