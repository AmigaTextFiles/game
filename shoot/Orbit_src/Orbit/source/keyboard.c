/*
    ...
    28.04.2000 - fixed a problem with key states
                 left pitch roll assigned to <,>
                 right pitch roll assigned to <.>
                 cursor movement more precise (0.5 instead of 1.0)
    30.04.2000 - added FreeJoy() call to quit keys
*/
/*
