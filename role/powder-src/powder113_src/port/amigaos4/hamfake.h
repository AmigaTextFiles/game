...
// Raw data accessors.
//
bool hamfake_isPressed(SDLKey key);
...
#define F_CTRLINPUT_UP_PRESSED \
    hamfake_isPressed(SDLK_UP) || hamfake_isPressed(SDLK_k) || hamfake_isPressed(SDLK_8) || hamfake_isPressed(SDLK_KP8)
#define F_CTRLINPUT_DOWN_PRESSED \
    hamfake_isPressed(SDLK_DOWN) || hamfake_isPressed(SDLK_j) || hamfake_isPressed(SDLK_2) || hamfake_isPressed(SDLK_KP2)
#define F_CTRLINPUT_LEFT_PRESSED \
    hamfake_isPressed(SDLK_LEFT) || hamfake_isPressed(SDLK_h) || hamfake_isPressed(SDLK_4) || hamfake_isPressed(SDLK_KP4)
#define F_CTRLINPUT_RIGHT_PRESSED \
    hamfake_isPressed(SDLK_RIGHT) || hamfake_isPressed(SDLK_l) || hamfake_isPressed(SDLK_6) || hamfake_isPressed(SDLK_KP6)

#define F_CTRLINPUT_A_PRESSED \
    (hamfake_isPressed(SDLK_RETURN) || hamfake_isPressed(SDLK_SPACE)) || hamfake_isPressed(SDLK_5) || hamfake_isPressed(SDLK_KP5)
#define F_CTRLINPUT_B_PRESSED \
    hamfake_isPressed(SDLK_ESCAPE) || hamfake_isPressed(SDLK_0) || hamfake_isPressed(SDLK_KP0)
#define F_CTRLINPUT_R_PRESSED \
    0
#define F_CTRLINPUT_L_PRESSED \
    hamfake_isPressed(SDLK_p)

#define F_CTRLINPUT_SELECT_PRESSED \
    hamfake_isPressed(SDLK_i)
