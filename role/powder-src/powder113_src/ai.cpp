...
MOB::doAI()
{
    ...
    {
	// Check to see if we are an avatar hunter.  We are either
	// intrinsicly anti-avatar, or have recently acquired a hatred
	// ie, the hostile flag is set.
	if (glb_aidefs[ai].attackavatar ||
	    getAttitude(avatar) == ATTITUDE_HOSTILE)
	{
