...
void straggle_corridor(int fx,int fy,int tx,int ty,short loc,char rsi)
//int fx,fy,tx,ty;
//short loc;
//char rsi;
{
...
void corridor_crawl(int *fx,int *fy,int sx,int sy,int n,short loc,char rsi)
//int *fx,*fy,sx,sy,n;
//short loc;
//char rsi;
{
...
void sewer_corridor(int x,int y,int dx,int dy,short locchar)
//int x,y,dx,dy;
//short locchar;
{
  int continuing = TRUE;
