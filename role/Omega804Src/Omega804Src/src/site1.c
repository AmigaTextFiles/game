...
void l_bank()
{
  ...
  if (gamestatusp(BANK_BROKEN))
	...
	continue;
      ...
      else if (((response == 'P') || (response == 'p')) && (strcmp(Password,"") != 0)) {
	clearmsg();
	print1("Password: ");
...
//	    sleep(4);
      ...
      else if (((response == 'D') || (response == 'd')) && valid) {
	clearmsg();
	print1("Amount: ");
	...
	if (amount < 1) 
      ...
      else if (((response == 'w') || (response == 'W')) && valid) {
	clearmsg();
	print2("Amount: ");
	...
	print1("Bye!");
      ...
      else if (((response == 'O') || (response == 'o')) && (strcmp(Password,"")==0)) {
	clearmsg();
