...
===------------------                                ------------------===
        ...
        An attempt to answer all meta-questions regarding ADOM...
                ...
                (C) Copyright 1994-2017 by Thomas Biskup.
                           All Rights Reserved.
===------------------                                ------------------===
============--------------------------------------------------============
                  --------------------------------------
...
==============================================
  ...
  http://www.adom.de
	This is the official ADOM website which contains links to
        all current important resources.

  http://www.ancientdomainsofmystery.com
        This is the official ADOM blog.  It contains all the latest
  ...
  http://ancardia.wikia.com/wiki/ADOM_Wiki
        This is the primary spoiler site for ADOM.
...
====================================================================
  ...
  compiled below:
        ...
        2. How about a graphical version of ADOM?
           ...
           It's there. Since 2013 roughly. After we did that ADOM
           crowdfunding campaign on Indiegogo. Both the free
           version of ADOM (ADOM Classic) and the non-free version
	       (ADOM Deluxe) now contain graphics. Both versions also
	       allow to switch to ASCII at any point in time.

        3. How about an attribute roller?

           Maybe at some point, but then in a shareware version of ADOM.

        4. How about a cheat mode?

           ADOM Deluxe contains an exploration mode (that yields a
           wand of wishig with 42 charges). Additionally you can
           tweak die rolls, customize attributes with points and
           more. That's as close to cheating as the game ever is
           going to offer to you.

           Team ADOM (the devs) have a cheat mode but that mode
           is not compiled into the public binaries.

        5. How about monster inventories?

           Still being implemented. Due to the complexity of this
           issue quite a number of versions will go by until this
           feature is completed.

        6. How about more races?

           Ratlings and Mist Elves have been added as the result of
           the crowdfunding campaign. No other races currently are
           planned.
        ...
        7. What about more classes?

           A couple of additional classes are planned for future
           versions (after 3.0.0), among them Pirate, Shaman, Pilgrim,
           Summoner, Armsmaster, Noble, Miner, ...

        8. How about larger maps?
...
=====================================
  ...
  The campaign was very successful and since then ADOM again has been
  under active development. 2015 ADOM appeared on Steam (see
  http://www.adom.de/steam) and we have big plans for the future.


III.C. What can I do to further ADOM's development?
===================================================

  Although ADOM Classic is postcard-ware I'm not unhappy if someone feels 
  like sending money to me :-) If you want to do so please use Paypal
  and transfer money to thomas.biskup@gmail.com.

  Or buy the Steam version of ADOM. Or buy the Steam version of ADOM
  as a gift for all people you know ;-)

  And please spread the word about ADOM wherever you can - we need all
...
===================================================
  ...
  other make) and one Perl script (to compile the in-game manual).  

  As of ADOM 3.0.0 it consists of 122 '.c' modules, 123 '.h' files and
  many more LUA files (at least 47 LUA files with a total of 14500+
  lines of code, not counting all the code in the basic NotEye engine).
  The C parts total more than 266430 lines of code. And then there are
  varios scripts, the website, server code and more.

  As of ADOM 0.9.9 Gamma 9 it consisted of 71 '.c' modules, 74 '.h' files.
  ...
  months (ADOM required about 13 years to get this far).


III.I. Why don't you make save files compatible between versions?
=================================================================

  Good news: Thanks to the crowdfunding campaign by now save files
  are compatible. Enjoy :-)
...
==============================================
  ...
  It isn't any more. Use the following locations to get up to date
  information:

  http://www.ancientdomainsofmystery.com
	The ADOM blog. Most often updated with big information blocks.
	
  http://www.adom.de
	The official ADOM website. Repository for all links and other
	resources.
	
  https://www.twitter.com/adom_dev
	The official ADOM Twitter account. Very often updated with small
	tidbits of information.
	
  http://www.adom.de/forums
	The official ADOM forums. So much information :-)
	
  http://www.adom.de/bugs
	The bug & RFE tracker. Even more information and discussion :-)
...
===========================
  ...
  http://www.facebook.com/thomas.biskup Or on Twitter at
  https://www.twitter.com/thomas_biskup
...
===============================================
  ...
  * There are no native ports for ADOM to Windows. Heed the advice 
    for DOS.
