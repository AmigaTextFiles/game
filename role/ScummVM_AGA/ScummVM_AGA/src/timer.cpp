/* Timer.cpp: Timer Functions for ScummAGA (based on FlashNG) */
...
struct timerequest *CreateTimer(ULONG theUnit)
{
    ...
    Error=OpenDevice((UBYTE *)"timer.device", theUnit, (struct IORequest*)(TimeReq), 0);
    if (Error!=0)
    {
