 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-0-11-1/backends/platform/PalmOS/Src/native/pnoARM.c $
 * $Id: pnoARM.c 30944 2008-02-23 22:50:18Z sev $
 *
 */
