...
/* Variables: */
static const char *spritename = "PROGDIR:graphics/sprites.png";
static const char *groundname = "PROGDIR:graphics/ground.png";
static const char *fontname = "PROGDIR:graphics/font.png";
