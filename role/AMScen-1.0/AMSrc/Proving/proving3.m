...
ignore DeleteSymbol(tp_proving3, "makeCavern").
...
define tp_proving3 proc rockPileFight(thing rockPile)void:
    ...
    OPrint(Capitalize(attacker@p_pName) + " attacks the rock pile.\n");
corp;
