!----------------------------------------------------------------------------
!
!          HUGO Object Library v2.2.2 by Kent Tessman (c) 1995-1996
...
character female_character "female_character_class"
{
...
class direction "direction_class"
{
	type direction
	article "the"
...
! Each plural or identical object must have a property giving the total
! number specified:
...
! less than specified (or any at all, for that matter).
			...
			for (i=1; i<=self.#plural_of; i=i+1)
			{
...
routine InitPluralObjects
{
	...
	for (i=1; i<=objects; i=i+1)
	{
		if (i.type = plural_class or i.type = identical_class) and
			i ~= plural_class and i~=identical_class
		{
			plurals[count] = i
			count = count + 1
...
routine ParsePluralObjects
{
	...
	for (i=1; i<=words; i=i+1)      ! to overcome v2.2 parser behavior
	{
		if word[i] = "of", "the"
			DeleteWord(i)
	}
...
! no polite way of figuring out what the xobject might be at this point.
	  ...
	  for (i=w; i<words; i=i+1)
	  {
			...
			(k = "in" or k = "inside" or k = "on")):
		{
			...
			{
				i = i + 1       ! get next word
				for (j=1; j<=pobj.#plural_of; j=j+1)
				{
...
! the restrictions of pluralobj_heldmode:
	...
	{
		for (i=1; i<=pobj.#plural_of; i=i+1)
		{
			k = pobj.plural_of #i
			k is not workflag
...
class attachable "attachable_class"
{
	type attachable
	...
	desc_detail
	{
		...
		for (i=1; i<=self.#attached_to; i=i+1)
		{
...
routine DoDetachObject
{
	...
	{
		j = 0
		for (i=1; i<=object.#attached_to; i=i+1)
		{
...
routine ObjectAttach(att, obj)
{
	...
	for (i=1; i<=att.#attached_to; i=i+1)
	{
...
routine ListAttachments(obj)
{
	...
	for (a=1; a<=obj.#attached_to; a=a+1)
	{
		if obj.attached_to #a:  total = total + 1
	}
...
routine OMessage(obj, num, a, b)
{
	...
	case component:  print "You can't separate "; The(self); " from "; \
				The(self.part_of); "."
	...
	case vehicle        
	{
		...
		case 1
		{
			 print "To walk, you'll have to get "; self.prep #2; \ 
				" of "; The(self); ".  Otherwise, try \""; \
				self.vehicle_verbs; "\" ";
			 if self.#vehicle_verbs > 1
				print "or \""; self.vehicle_verbs #2; "\" ";
			 print "and a direction."
		}
		case 2:  print "You aren't in anything at the moment."
		case 3:  print "You're "; a.prep; " "; The(a);"--try 
				\""; a.vehicle_verbs; "\"."
		case 4:  print "You'll have to specify a direction as well."
		case 5:  print CArt(obstacle); " stop"; \
				MatchSubject(obstacle); " you from going 
				anywhere."
		case 6
		{
			print "You can't "; a.vehicle_verbs; " ";
			if object.prep
				print object.prep;
			else
				print "in";
		...
		case 7:  print "You can't "; a.vehicle_verbs; " that way."
	}
#endif  ! ifset USE_VEHICLES
	...
	case plural_class
	{
		...
		case 3:  print "You'll have to do that one "; \
	...
	case attachable
	{
		...
		case 2:  print "You see nothing special about "; \
			The(self); "."
		case 3
		{
		...
		case 13:  print "You "; object.attach_verb; " "; \
			The(object); " "; object.attach_prep; " "; \
			The(xobject); "."
		...
		case 16:  print "You'll have to be a little more specific 
			about what you'd like to "; word[1]; " "; \
			The(object); " "; object.detach_prep; "."
		case 17:  print "You "; object.detach_verb; " "; \
			The(object); " "; object.detach_prep; " "; \
			The(xobject); "."
		case 18
		{
			print "You can't go anywhere while "; The(a); \
			IsorAre(a, true); " still "; a.attached_desc; " ";
			ListAttachments(a)
			print "."
		}
		case 19
		{
			print "You can't move whatever is "; \
			a.attached_desc; " "; The(a); ", namely ";
			ListAttachments(a)
			print "."
		}
		case 20:  print "You can't pull "; The(a); " that way."
		case 21
		{
