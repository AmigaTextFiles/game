...
use t_base
source AmigaMUD:Src/Basics/base.m

/* The TimeKeeper code. */
source AmigaMUD:Src/Basics/timekeeper.m

/* Routines to do the graphics styles used in this scenario. */
public t_graphics CreateTable()$
use t_graphics
source AmigaMUD:Src/Basics/graphics.m

/* Routines for dealing with icons. */
public t_icons CreateTable()$
use t_icons
source AmigaMUD:Src/Basics/icons.m
