...
_multiMethodBuildBindings()
{
    ...
    /*
     *   Now run through the registry and figure the inherited function for
     *   each function - in other words, the next function in line in
     *   inheritance order, for automatic mminherited() calls. 
     */
    _multiMethodRegistry.funcTab_.forEachAssoc(new function(baseFunc, val)
    {
...
_multiMethodRegistry: object
    ...
    /* table of bound functions */
    boundFuncTab_ = static new LookupTable(64, 128)

    /* table of inherited functions */
