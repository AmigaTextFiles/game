...
save_dir_in_home(void)
{
  ...
  save_dir = concat_string(3, getenv ("HOME"), "/", ".kusemono");
  if (save_dir == NULL)
  {
...
do_version(void)
{
  printf("kusemono (Sat, 12 Mar 2011 release)\n");
  printf("Copyright (C) 2011 Oohara Yuuma <oohara@libra.interq.or.jp>\n");
  printf("This program is free software;\n");
  printf("see the file LICENSE in the source code for details.\n");
  printf("kusemono comes with NO WARRANTY, to the extent "
         "permitted by law.\n");
...
do_help(void)
{
  ...
  printf("Usage: kusemono [options]\n");
  printf("sneak into a mutant ant hive and stab them\n");
  printf("Options:\n");
