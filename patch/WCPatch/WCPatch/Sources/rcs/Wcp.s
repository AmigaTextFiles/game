...
2.4
date	98.02.13.00.12.25;	author MORB;	state Exp;
branches;
next	2.3;

2.3
date	98.02.04.21.00.09;	author MORB;	state Exp;
branches;
next	2.2;

2.2
date	98.02.04.19.49.21;	author MORB;	state Exp;
branches;
next	2.1;

2.1
date	98.02.04.17.46.21;	author MORB;	state Exp;
branches;
next	2.0;

2.0
date	98.02.04.17.44.01;	author MORB;	state Exp;
branches;
next	;


desc
@Wing Commander CD32 fix/patch
...
2.4
log
@Modifs WOTG (Tox'N), corrections (MORB)
@
text
@*
* Wing Commander Patch
* ©1997-1998, CdBS Software
* $Id: Wcp.s 2.3 1998/02/04 21:00:09 MORB Exp MORB $
*
...
start:
	 bra.s     .AfterVer
	 Dc.b      "$VER: Wing Commander Patch 2.0 (04.02.98) ©1997-98, CdBS Software"
	 even
.AfterVer:
...
2.3
log
@Now supports german version
@
text
@d4 1
a4 1
* $Id: Wcp.s 2.2 1998/02/04 19:49:21 MORB Exp MORB $
d41 1
a41 1
	 dc.b      "$VER: Wing Commander Patch 1.1 (30.07.97) ©1997, CdBS Software"
d314 1
a314 1
	 move.w    #57,d0
d324 2
...
2.2
log
@Now support imploded wc exe files
@
text
@d4 1
a4 1
* $Id: Wcp.s 2.1 1998/02/04 17:46:21 MORB Exp MORB $
d259 5
d267 2
d284 1
a284 1
	 move.b    #$6e,$3867(a4)       ; Fix of many dumb bugs that
d312 1
a312 1
**** Some funny credits patch ****
d372 107
d642 2
a643 1
	 move.l    -$30a(a4),a6
...
a279 3
	 ...
	 move.l    #$203c0000,$386c(a4) ; très cons pour pouvoir tourner sur
...
d295 4
a298 4
	 move.b    #$14,$1ef7(a4)      ; Force le buffer chunky en chip
				       ; pour faire marcher le c2p
				       ; merdique d'origine (Hihihi)
