...
Blop & ort_absolut::finde() {
  switch (art) {
    ...
    case absort_nirgends:
      throw iFehler(_("Internal error in ort_absolut::finde(): kein ort_absolut::korrekt()"));
    default:
      throw iFehler(_("Data corruption."));
  }
}
...
void ort_absolut::playSample(int nr) const {
  ...
  case absort_feld:
    ...
    break;
  case absort_nirgends:
    throw iFehler("illegal ort for ort_absolut::playSample");
    break;
  case absort_fall:
    ...
    case ortart_absolut:
      switch (mAbsArt) {
        ...
        default: throw iFehler(_(
          "Internal error in Ort::berechne(): Unbekannte Ort-Art %d"),
          mAbsArt);
      }
    default:
      throw iFehler(_("Data corruption."));
    ...
    case ortart_absolut:
      switch (mAbsArt) {
        ...
        case absort_nirgends:
          ...
          break;
        default: throw iFehler(_(
          "Internal error in Ort::toString(): Unbekannte Ort-Art %d"),
          mAbsArt);
      }
  }
  return ret;
