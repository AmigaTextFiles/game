  ...
  if (buch == 'b') {
    ...
    if (mGModus == gmodus_kein_spiel) {
      ...
      fprintf(stderr, "Level %s (%d)\n",
	      lna.data(), mLevelNr);
      fprintf(stderr, "Zum Abspielen im Hauptmenu r drücken.\n");
      mAbspielen = true;
    } else
      fprintf(stderr, "Debug: *Nicht* Logdatei laden während Spiel läuft.\n");
    ...
    fprintf(stderr, "  t: Test Rüber-Reihe an/aus\n");
	...
	printFehler(2, "Could not reload the level description file:\n",
      ...
      fprintf(stderr, "Debug: *Nicht* reload levelconf während Spiel läuft.\n");
    ...
    fprintf(stderr, "Debug: Test Rüber-Reihe = %d\n", mRueberReihenTest);
