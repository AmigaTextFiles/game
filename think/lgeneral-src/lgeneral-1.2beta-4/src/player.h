...
typedef struct {
    ...
    int orient;         /* inital orientation */
    int prestige;       /* current amount of prestige (loaded from start_prestige) */
    int prestige_per_turn; /* amount added in the beginning of each turn (including first one) */
