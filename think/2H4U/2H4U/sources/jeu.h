...
#define SC_BONUS_SCORE 10000 //Bonus spQcial.
#define SC_EMPTY_TERRAIN 100000 //Terrain a QtQ vidQ.
...
long m_iLastStrafe; //Timer du dernier moment ou le bloc a bougQ latQralement.
int m_iDureeStrafe; //Temps entre deux dQplacements latQraux.
