...
void CBonus::mayAddBonus(int x,int y,double vitesse)
{
    ...
    //S'il ya des bonus libres, on va peut  tre en crQer un.
    if (i!=-1)
    {
...
//Penser a modifier l'indice du tableau dans la fonction appellante si nQcessaire.
