...
//entrQe sortie etc standard.
#include <stdlib.h>
#include <stdio.h>
#include <time.h>

//Le moteur global de jeu dont on hQrite
#include "Engine.h"
//Le moteur du menu
#include "menu.h"
//Pour la gestion de paramøtres.
#include "Param.h"
//include pour l'objet jeu.
#include "jeu.h"
//Include pour la gestion des highscores.
#include "highscore.h"
//Permet de gQrer l'intro.
#include "intro.h"
...
//Plutot que d'accQder aux cases 0, 1 etc... on utilise des define.
#define K_NBKEYS  12 //Nombre de touches dQfinies.
#define K_ENTER   0
#define K_LEFT    1
#define K_RIGHT   2
#define K_UP      3
...
//Constantes reprQsentant les diffQrentes phases du programme.
...
void CMyEngine::ParamInit(int iWidth,int iHeight)
{
    ...
    //Dans un premier temps, on charge le fichier de paramøtres.
    m_Param.initParam("data/config.dat");

    m_Highscore.loadHighscore("data/HighScores.dat");

        //Puis on fait plein Qcran ou fenetre suivant le cas.
...
void CMyEngine::AdditionalInit()
{
    ...
    {
        //On prQpare l'entrQe vers l'intro.
        m_iPhase=P_INTRO;
...
void CMyEngine::Think( const int& iElapsedTime )
{
    ...
    switch(m_iPhase)
    {
        //Ce case est placQ en premier car il est celui qui nQcessite le plus de rapiditQ d'execution.
        case P_GAME:

            moveStrafe=0;
            //Dans un premier temps, on rQagit par rapport aux inputs.
            ...
            //Va gQrer aussi la descente automatique, et la destruction d'Qventuelles lignes.
            ...
            //Gestion du mouvement de la balle ET en meme temps des briques cassQes, via la meme fonction.
            ...
            //RQmise a 0 des touches nQcessaires (Celle qui sert au changement d'angle).
            m_iKey[K_Z]=false;
        ...
        break;
        case P_NEW_GAME:
            //Cette phase sert a gerer la transition avec le jeu, par exemple avec un Qcran de chargement.
            //Ou encore un dQcompte de temps et bloquant.
...
//Affichage a partir des donnQes disponibles.
...
//Rien encore de dQfinie, car non utilisQ par le menu (mais par le jeu).
...
void CMyEngine::WindowInactive()
{
    switch(m_iPhase)
    {
        ...
        //A voir Qventuellement si animations dans le menu.
        break;
        case P_NEW_GAME:
