...
Phase 1: Elimination of GetPlainWeight in cmove.tex.
  ...
  Note that the corresponding function GetWizardWe˜ht is called a maximum
...
* CHANGED: Basilisk ranged weapon to attack movement rating. (Basilisks are
  supposed to paralyze with their gaze according to the Monster Manual 8)
...
enemy creature.  Did you change this on purpose?
...
* STRANGE: On December 25th, the filesize of the demo was 366536.
...
BUG: If you select "quit" from the menu and then IMMEDIATELY click the
checkmark then some enforcer hits are generated.  You hafta be fast
with the mouse.  When I run the game under CPR, the game simply locks up
and does not quit. Leaving this for SAI.  Does any of this happen on your
system?
...
* I intentionally fixed the above two bugs and I part of the reason I
...
NEW POWERUP: An orc, goblin, or troll killing an elf, will now pick up the bow
  previously used by the elf.
...
* NEW SPELLS: Magic Wand and Vodka.  Neither have a real graphic yet.  I won't
  make any graphics till I implement the graphics upgrade.  I just had to
  program these in real quick while I still remembered where to put the code
  fragments that make them work.
...
Monday, April 12th: New phone line installed.  I now have reliable 24 hour
access to the net.  If the Chaos internet upgrade was completed today I could
immediately start running a full-time internet game server.
...
the LAST occurrence of CatLordID and you'll see it.
...
on empty space.  Leaving for SAI.
...
originally).  Then I used DiskSalv from Aminet to salvag all files off the
...
save at beginning of of spell selection phase.=YUK.
...
* NEW SPELLS: Fly, Singular Earthbind, Dual Earthbind, Nonarchery, Convert,
