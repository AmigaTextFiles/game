...
/*****************************************************
 ****************************************************/
SDL_Cursor * SE_InitCursor(const char * image[])
{
...
/*****************************************************
 ****************************************************/
SDL_Cursor * SE_GetHandCursor()
{
	if(!handCursor)
		handCursor = SE_InitCursor(hand);
	return handCursor;
}

/*****************************************************
 ****************************************************/
SDL_Cursor * SE_GetArrowCursor()
{
	if(!arrowCursor)
		arrowCursor = SE_InitCursor(arrow);
	return arrowCursor;
}
...
/*****************************************************
 ****************************************************/
SDL_Cursor * SE_SurfaceToCursor(SDL_Surface * image, int hx, int hy) 
{
	int w, x, y;
	Uint8 * data = NULL, * mask = NULL, * d = NULL, * m = NULL, r, g, b;
	Uint32 color;
