...
int moveOk( Board *board[] )
{
  ...
  if( pos1-WEST == pos2 || 
      ...
      pos1+SOUTH == pos2 )
    {
      ...
      switch( dir )
	{
	case 1:  dir = pos1+1; break;
	case 16: dir = pos1-1; break;
	case 4 : dir = pos1+9; break;
	case 64: dir = pos1-9; break;
	}
      /* statement true if user move over a ball */
      if( board[dir]->ball == TRUE ) return TRUE;
      else return FALSE;
    }
  else 
    return FALSE;
...
{
  if(tal > intS && tal < intS + WIDTH) return TRUE;
  else return FALSE;
}
...
void initBoard(Board *board[])
{
  ...
  board[0]->brick = 0; board[0]->ball = 0; // line 1
  board[1]->brick = 0; board[1]->ball = 0;
  board[2]->brick = 0; board[2]->ball = 0;
  board[6]->brick = 0; board[6]->ball = 0;
  board[7]->brick = 0; board[7]->ball = 0; 
  board[8]->brick = 0; board[8]->ball = 0;

  board[9]->brick = 0;  board[9]->ball = 0;// line 2
  board[10]->brick = 0; board[10]->ball = 0;
  board[11]->brick = 0; board[11]->ball = 0;
  board[15]->brick = 0; board[15]->ball = 0;
  board[16]->brick = 0; board[16]->ball = 0;
  board[17]->brick = 0; board[17]->ball = 0;

  board[18]->brick = 0; board[18]->ball = 0;// line 3
  board[19]->brick = 0; board[19]->ball = 0;
  board[25]->brick = 0; board[25]->ball = 0;
  board[26]->brick = 0; board[26]->ball = 0;

  board[54]->brick = 0; board[54]->ball = 0;// line 4
  board[55]->brick = 0; board[55]->ball = 0;
  board[61]->brick = 0; board[61]->ball = 0;
  board[62]->brick = 0; board[62]->ball = 0;

  board[63]->brick = 0; board[63]->ball = 0;// line 5
  board[64]->brick = 0; board[64]->ball = 0;
  board[65]->brick = 0; board[65]->ball = 0;
  board[69]->brick = 0; board[69]->ball = 0;
  board[70]->brick = 0; board[70]->ball = 0;
  board[71]->brick = 0; board[71]->ball = 0;

  board[72]->brick = 0; board[72]->ball = 0;// line 6
  board[73]->brick = 0; board[73]->ball = 0;
  board[74]->brick = 0; board[74]->ball = 0;
  board[78]->brick = 0; board[78]->ball = 0;
  board[79]->brick = 0; board[79]->ball = 0;
  board[80]->brick = 0; board[80]->ball = 0;
