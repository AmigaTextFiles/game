...
{ 
    ...
    {
        case 2:
            * (Sint16*) dest = SDL_SwapLE16(  * (Sint16*) src );
            break;

        case 4:
			* (Sint32*) dest = SDL_SwapLE32( * (Sint32*) src );
			break;
/*        case 8:
            break;
  */
        default: printf("rwbuffer: wrong buffer length given!\n");
    }
...
/*
{ // byte swap
    CACCEntry * swap = io_buf;
    Length = swap->SDL_SwapLE32( swap.Length );
    DiskLength = swap->SDL_SwapLE32( swap.DiskLength );
    Offset = swap->SDL_SwapLE32( swap.Offset );
    Attr = swap->SDL_SwapLE32( swap.Attr );
}
*/
