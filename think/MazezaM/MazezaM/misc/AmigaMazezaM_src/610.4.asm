...
_StartSong
        lea  Songs,A1
        asl.b #2,D0   ;D0 = D0*4 for getting long offset.
        move.l (A1,D0),A0
        sub.l  A1,A1  ;A1 = 0 (Samples are in the module).
        bra.s  _InitPlayer
...
P61_timerint
        ...
        endc
P61_etu
Songs   ;Song adresses table
        dc.l TitleSong,Level1Song,Level2Song,Level3Song,Level4Song
        dc.l Level5Song,Level6Song,Level7Song,Level8Song,Level9Song
        dc.l Level10Song,WinSong,GameOverSong
******** END OF BINARY FILE **************

        section chip,data_c
TitleSong    incbin  "P61.da strike!"           ;The actual Songs are here.
Level1Song   incbin  "P61.Chippy_nr.478"        ;They are not in the archive
Level2Song   incbin  "P61.Chippy_nr.480"        ;but only in the game for
Level3Song   incbin  "P61.Chippy_nr.350"        ;space/bandwidth savings.
Level4Song   incbin  "P61.rakish acid"
Level5Song   incbin  "P61.the happy organ"
Level6Song   incbin  "P61.Chippy_nr.466"
Level7Song   incbin  "P61.Chippy_nr.469"
Level8Song   incbin  "P61.Chippy_nr.470"
Level9Song   incbin  "P61.Chippy_nr.482"
Level10Song  incbin  "P61.WHAT"
WinSong      incbin  "P61.Basement"
GameOverSong incbin  "P61.Chippy_nr.307"
