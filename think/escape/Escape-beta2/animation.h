...
# include "animation_defs.h"
  ...
  static  SDL_Surface ** animation::pic_guy_up;
  static  SDL_Surface ** animation::pic_guy_down;
  static  SDL_Surface ** animation::pic_guy_left;
  static  SDL_Surface ** animation::pic_guy_right;

  static  SDL_Surface ** animation::pic_deadrobot;

  /* XXX these are currently all the same */
  static  SDL_Surface ** animation::pic_dalek_up;
  static  SDL_Surface ** animation::pic_dalek_down;
  static  SDL_Surface ** animation::pic_dalek_left;
  static  SDL_Surface ** animation::pic_dalek_right;

  /* XXX these are currently all the same */
  static  SDL_Surface ** animation::pic_hugbot_up;
  static  SDL_Surface ** animation::pic_hugbot_down;
  static  SDL_Surface ** animation::pic_hugbot_left;
  static  SDL_Surface ** animation::pic_hugbot_right;
...
struct anflyingtile : public anflying {
  ...
  /* draw with these instead; then we can override them. */
  virtual void blit(int x, int y) {
...
#if 0
/* started implementing this, then decided to use
   aninplace instead */
struct anflyinganim : public anflying {
  aframe * frames;
...
struct anlaser : public animation {
  ...
  virtual void erase (dirt * dirty) { 
    /* doesn't erase, since it is opaque and
       non-moving, and finale */
    /* XXX correct in general? (robots zapped
       by lasers?) */
  }
