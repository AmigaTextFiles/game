...
; repeated operation into an nsis function
  ...
  SetOutPath $INSTDIR\triage\sophomoric
  File triage\sophomoric\*.esx
  File triage\sophomoric\*.esi

  SetOutPath $INSTDIR\triage\surprise
  File triage\surprise\*.esx
  File triage\surprise\*.esi
