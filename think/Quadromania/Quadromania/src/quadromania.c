 ...
 * last Modified: 14.12.2003 : 11:52
 *
...
/* save the amount of turns taken and the amoutn of maximum turns the player may take */
...
void drawplayfield(SDL_Surface *screen)
{
    ...
    text(screen,480,0,txt);

    sprintf(txt,"Quadromania v%s",VERSION);
    text(screen,0,450,txt);
}
