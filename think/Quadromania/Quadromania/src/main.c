 ...
 * last Modified: 14.12.2003 : 12:42
 *
...
enum GAMESTATE {UNINITIALIZED,NONE,TITLE,INSTRUCTIONS,SETUPCHANGED,GAME,WON,GAMEOVER,QUIT};
struct MOUSE { int x,y,button; };

/* prototypes */
void waitformousebutton(void);
...
int main(int argc, char *argv[])
{
    ...
    /* cleanup is done via atexit() hookups!
     * those are setup in the corresponding init routibnes
     */
    return(0);
}

/* a simple function to wait until the mousebutton has been released */
