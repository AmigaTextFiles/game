...
void BOMenu::SetViewMatrix(GLfloat *mView) {
   memcpy(matView , mView , 16*sizeof(GLfloat));
}

GLfloat *BOMenu::GetViewMatrix() {
   return matView;
}

// ---------------------------------------------------------------------

void BOMenu::FullRepaint() {
...
int BOMenu::Create(int width,int height) {
  ...
  if( !background.RestoreDeviceObjects("images/menuback.png","none",width,height) )
    return GL_FAIL;
  background.UpdateSprite(x1,y1,x2,y2,0.0f,0.0f,1.0f,1.0f);

  if(!background2.RestoreDeviceObjects("images/menucredits.png","none",width,height) )
    return GL_FAIL;
  ...
  if( !font.RestoreDeviceObjects("images/menufont.png","none",width,height) )
    return GL_FAIL;

  if(!font2.RestoreDeviceObjects("images/menufont2.png","none",width,height))
    return GL_FAIL;

  // onLine logo
  if( !onlineLogo.RestoreDeviceObjects("images/online.png","images/onlinea.png",width,height) )
    return GL_FAIL;
...
void BOMenu::RenderChar(int x,int y,int w,int h,BOOL selected,char c) {
...
void BOMenu::RenderTitle(char *title) {
...
void BOMenu::RenderText(int x,int y,BOOL selected,char *text) {
...
void BOMenu::InvalidateDeviceObjects() {
...
void BOMenu::ResetAnim(float fTime) {
...
void BOMenu::ProcessAnim(float fTime) {
