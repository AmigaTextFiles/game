SubWindow, gametiedwin = WindowObject,
    MUIA_Window_Title, "It's a draw",
    MUIA_Window_ID,     MAKE_ID('T','I','E','W'),
        ...
        VGroup,
            Child, HGroup,
                ...
                Child, VGroup,
                    ...
                    End,
                    Child, TextObject,
                        MUIA_Text_Contents, MUIX_C"Nobody won that time!",
                    End,
                    Child, TextObject,
                        MUIA_Text_Contents, MUIX_C"\nTry again\n",
                    End,
