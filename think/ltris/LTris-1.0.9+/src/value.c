    ...
    switch ( value->type ) {
        ...
        case VALUE_KEY:
            ...
            switch ( *value->val_int ) {
                ...
                case SDLK_INSERT: strcpy( value->val_str, "Insert" ); break;
                case SDLK_END: strcpy( value->val_str, "End" ); break;
                case SDLK_PAGEUP: strcpy( value->val_str, "PageUp" ); break;
                case SDLK_PAGEDOWN: strcpy( value->val_str, "PageDown" ); break;
                case SDLK_HOME: strcpy( value->val_str, "Home" ); break;
                default:
