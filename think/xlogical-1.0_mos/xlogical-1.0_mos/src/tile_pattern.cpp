...
Ctile_pattern::Ctile_pattern( )
{
#ifdef DEBUG_FUNC
	cerr << __FILE__ << " Ctile_pattern::constructor( )" << endl;
#endif
}
...
{
#ifdef DEBUG_FUNC
	cerr << __FILE__ << " Ctile_pattern::destructor( )" << endl;
#endif
}

void
Ctile_pattern::draw_under( int ulX, int ulY )
{
#ifdef DEBUG_FUNC
	cerr << __FILE__ << " Ctile_pattern::draw_under( ";
	cerr << ulX << ", " << ulY << " )" << endl;
#endif
	
	graphDriver->graph_draw_perm( BMP_PATTERN, 0, 0, ulX, ulY, 64, 64 );
}


void
Ctile_pattern::draw_over( int ulX, int ulY )
{
#ifdef DEBUG_FUNC
	cerr << __FILE__ << " Ctile_pattern::draw_over( ";
	cerr << ulX << ", " << ulY << " )" << endl;
#endif
	int i = 0;
	int done = 0;
...
// $Id: tile_pattern.cpp,v 1.2 2001/02/16 21:00:09 tom Exp $
//
// $Log: tile_pattern.cpp,v $
...
// imported sources
//
// Revision 1.5  2000/01/10 02:53:49  brown
