...
{
#ifdef DEBUG_FUNC
	cerr << __FILE__ << " Ctile_next::constructor( )" << endl;
#endif
}
...
{
#ifdef DEBUG_FUNC
	cerr << __FILE__ << " Ctile_next::destructor( )" << endl;
#endif
}

void
Ctile_next::draw_under( int ulX, int ulY )
{
#ifdef DEBUG_FUNC
	cerr << __FILE__ << " Ctile_next::draw_under( ";
	cerr << ulX << ", " << ulY << " )" << endl;
#endif
	
	graphDriver->graph_draw_perm( BMP_NEXT_BASE, 0, 0, ulX, ulY, 64, 64 );
}

void
Ctile_next::draw_over( int ulX, int ulY )
{
#ifdef DEBUG_FUNC
	cerr << __FILE__ << " Ctile_next::draw_over( ";
	cerr << ulX << ", " << ulY << " )" << endl;
#endif
...
// $Id: tile_next.cpp,v 1.2 2001/02/16 21:00:07 tom Exp $
//
// $Log: tile_next.cpp,v $
...
// imported sources
//
// Revision 1.7  1999/12/25 08:18:40  tom
