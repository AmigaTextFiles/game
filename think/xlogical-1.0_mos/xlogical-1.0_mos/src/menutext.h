...
class CMenuText : public CMenuBase
{
public:
	CMenuText( void );
	CMenuText( const string & );
	virtual ~CMenuText( void );
...
#endif
// $Id: menutext.h,v 1.4 2001/02/16 21:00:01 tom Exp $
//
// $Log: menutext.h,v $
// Revision 1.4  2001/02/16 21:00:01  tom
