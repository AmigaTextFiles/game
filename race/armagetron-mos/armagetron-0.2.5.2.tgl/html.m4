...
define(PROGNAME,  armagetron) 
dnl define(PROGNAMEBASE,  armagetron) 
define(PROGNAMEBASE,  armagetron) 
...
define(LINUX,ifelse(DOCSTYLE,unix,,Linux))
define(WINDOWS,ifelse(DOCSTYLE,windows,,Windows))
