Bloboats 1.0.1-2 by Markus "MakeGho" Kettunen <makegho@mbnet.fi>, http://bloboats.dy.fi/
...
public scoreboard (http://bloboats.dy.fi/), it is most probably because your computer and
...
server at http://bloboats.dy.fi/. If options->upload scores button doesn't work or you can't
...
under the Sampling Plus 1.0 license (http://creativecommons.org/licenses/sampling+/1.0/):
