...
struct type_etre 
{
  ...
  /* Déplacement à ajouter lors du mouvement entre la position i et la i + 1 */
  int * deplacement [nbre_de_directions];
...
cree_joueur (SDL_Surface * screen, SDL_Surface * fondImg,
	     SDLKey mes_touches [nbre_de_actions], int deplacements [nbre_de_directions][NBRE_MOUVEMENTS], 
